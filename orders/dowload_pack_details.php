...
<head>
    ...
    <link rel="icon" type="image/x-icon" sizes="20x20" href="https://testca.uniqbizz.com/assets/images/icon/fav.png">
    <!-- Bootstrap -->
    <link rel="stylesheet" type="text/css" href="https://testca.uniqbizz.com/assets/css/bootstrap-5.3.0.min.css">
    <!-- Fonts & icon -->
    <link rel="stylesheet" type="text/css" href="https://testca.uniqbizz.com/assets/css/remixicon.css">
    <!-- Plugin -->
    <link rel="stylesheet" type="text/css" href="https://testca.uniqbizz.com/assets/css/plugin.css">
    <!-- Main CSS -->
    <link rel="stylesheet" type="text/css" href="https://testca.uniqbizz.com/assets/css/main-style.css">
</head>
...
<body>
                            ...
                            if ($data->rowCount() > 0) {
                                ...
                                foreach (($data->fetchAll()) as $key_1 => $image) {
                                    echo '<div class="swiper-slide">
                                            <img src="https://testca.uniqbizz.com/' . $image['image'] . '" alt="BizzMirth" >
                                          </div>';
                                }
                            }
                            ?>
    ...
    <script src="https://testca.uniqbizz.com/assets/libs/jquery/jquery.min.js"></script>
    <script src="https://testca.uniqbizz.com/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
    <!-- <script>
        window.print();
