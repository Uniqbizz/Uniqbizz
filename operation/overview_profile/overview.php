<?php
    ...
    }else if($DBtable == 'employees'){
        $sql = "SELECT * FROM employees WHERE employee_id = '".$id."' AND status = '1'";
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md">
                                                <div class="row align-items-center g-3">
                                                    ...
                                                    <div class="col-md">
                                                        <div class="row">
                                                            <?php if($DBtable == 'employees'){ ?>
                                                                <h4 class="fw-bol mt-2 me-0"><?php echo $name.' '.$id ; ?></h4>
                                                            <?php }else{ ?>
                            ...
                            <div class="tab-content">
													...
													<div class="row m-4">
														...
														<div class="col-sm-6">
															<div class="input-block mb-3">
																...
																<input class="form-control" type="date" id="birth_date" value="<?php echo $date_of_birth; ?>">
															</div>
														</div>
														...
														<div class="col-md-6">
															<div class="input-block mb-3">
																...
																<select class="form-select" id="designation">
																	<option value="<?php echo $design;?>"><?php echo $designation.' (Already Selected)' ; ?></option>
																	<?php
																		require '../connect.php';
                                                ...
                                                <form>
                                                    ...
                                                    if($reference_no){
                                                        ...
                                                        echo'<div class="row">
                                                            <div class="col-md-6 col-sm-12">
                                                                <div class="form-floating mb-3">
                                                                    <input type="text" class="form-control" id="reference_name" placeholder="Enter User NAme and Id" value=" '.$row['ta_reference_no'].' " readonly>
                                                                    <label for="user_id_name">User Id & Name </label>   
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6 col-sm-12">
                                                                <div class="form-floating mb-3">
                                                                    <input type="text" class="form-control" id="reference_name" placeholder="No Referance selected for the user" value=" '.$row['ta_reference_name'].' " readonly>
                                                                    <label for="reference_name">Reference Name </label>
                                                                </div>
                                                            </div>
                                                        </div>';
                                                    ...
                                                    <?php if($DBtable == 'corporate_agency' ||$DBtable == 'ca_travelagency' || $DBtable == 'ca_customer'){ ?>
                                                        <div class="row py-3">
                                                            <div class="col-lg-12" id="paymentMode">
                                                                <p>Payment Mode</p>
                                                                <input type="radio" id="cashPayment" class="form-check-input payment" name="payment" value="cash" <?php if($payment_mode == "cash") {echo 'checked';} ?> disabled>
                                                                <label for="cashPayment">Cash</label>
                                                                <input type="radio" id="chequePayment"  class="form-check-input payment ms-2" name="payment" value="cheque" <?php if($payment_mode == "cheque") {echo 'checked';} ?> disabled>
                                                                <label for="chequePayment">Cheque</label>
                                                                <input type="radio" id="onlinePayment"  class="form-check-input payment ms-2" name="payment" value="online" <?php if($payment_mode == "online") {echo 'checked';} ?> disabled>
                                ...
                                <div class="tab-pane fade" id="project-payout" role="tabpanel">   
                                    <div class="team-list list-view-filter">
                                        <div class="statement">
                                            <h2 class="statement-of-transection mb-3"> Payout For <?php echo $designation; ?></h2>
                                        </div>
                                        ...
                                        <?php
                                            ...
                                            }else if($DBtable == 'business_operation_executive'){
                                                $sqlUnion = '';
                                            }
