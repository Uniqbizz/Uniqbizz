                            ...
                            <div class="col-lg-12">
                                <div class="top-menu-wrapper d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="top-header-left d-flex align-items-center">
                                        <!-- Logo-->
                                        <!-- <div class="logo">
                                            <a href="index-three.php"><img src="assets/images/logo/logo1.png" alt="logo" class="changeLogo"></a>
                                        </div> -->
                                        <div class="logo">
                                            ...
                                            <ul class="listing" id="navigation">
                                                ...
                                                <!-- <li class="single-list">
                                                    ...
                                                    <ul class="submenu">
                                                        ...
                                                        <li class="single-list">
                                                            <a href="destination-details.html"  class="single">Destination Details</a>
                                                        </li>
                                                        <li class="single-list">
                                                            <a href="payment.html"
                                                                class="single">payment</a>
                                                        </li>
                                                        <li class="single-list">
                                                ...
                                                <li>
                                                    <div class="sign-btn d-none">
                                                        <?php 
                                                            if(isset($_SESSION['username2']) && isset($_SESSION['user_type_id_value']) && $_SESSION['user_type_id_value'] == "10"){
                                                            ...
                                                            }else if(isset($_SESSION['username2']) && isset($_SESSION['user_type_id_value']) && $_SESSION['user_type_id_value'] == "33"){
                                                                echo '<a href="dashboard/customer_dashboard/customer_dashboard.php" class="btn-secondary-sm fw-bolder d-flex justify-content-center align-items-center" style="width:100px; height:40px;">Dashboard</a>
                                                                <a href="login.php" class="btn-secondary-sm my2logout fw-bolder d-flex justify-content-center align-items-center" style="width:100px; height:40px;">Logout</a>';
                                                                ...
                                                                <a href="login.php" class="btn-secondary-sm my2logout fw-bolder d-flex justify-content-center align-items-center" style="width:100px; height:40px;">Logout</a>';
                                                            }else if(isset($_SESSION['username2']) && isset($_SESSION['user_type_id_value']) && $_SESSION['user_type_id_value'] == "16"){
                                                                ...
                                                                <a href="login.php" class="btn-secondary-sm my2logout fw-bolder d-flex justify-content-center align-items-center" style="width:100px; height:40px;">Logout</a>';
                                                            }else if(isset($_SESSION['username2']) && isset($_SESSION['user_type_id_value']) && $_SESSION['user_type_id_value'] == "26"){
                                                                ...
                                                                <a href="login.php" class="btn-secondary-sm my2logout fw-bolder d-flex justify-content-center align-items-center" style="width:100px; height:40px;">Logout</a>';
                                                            }else if(isset($_SESSION['username2']) && isset($_SESSION['user_type_id_value']) && $_SESSION['user_type_id_value'] == "30"){
                                                                ...
                                                                <a href="login.php" class="btn-secondary-sm my2logout fw-bolder d-flex justify-content-center align-items-center" style="width:100px; height:40px;">Logout</a>';
                                                            }else if(isset($_SESSION['username2']) && isset($_SESSION['user_type_id_value']) && $_SESSION['user_type_id_value'] == "28"){
                                                                ...
                                                                <a href="login.php" class="btn-secondary-sm my2logout fw-bolder d-flex justify-content-center align-items-center" style="width:100px; height:40px;">Logout</a>';
                                                            }else if(isset($_SESSION['username2']) && isset($_SESSION['user_type_id_value']) && $_SESSION['user_type_id_value'] == "25"){
                                                ...
                                                <!-- <li class="d-block d-lg-none">
                                                    <div class="header-right pl-15">
                                                        ...
                                                        <div class="sign-btn">
                                                            <a href="login.html" class="btn-secondary-sm">Log
                                                                In</a>
                                                        </div>
                                                    </div>
                                                </li> --> 
                                                ...
                                                <div class="sign-btn">
                                                    <?php 
                                                        if(isset($_SESSION['username2']) && isset($_SESSION['user_type_id_value']) && $_SESSION['user_type_id_value'] == "10"){
                                                            ...
                                                            echo '<a href="dashboard/institute_branch_manager/index.php" class="btn-secondary-sm">Dashboard</a>
                                                            <a href="login.php" class="btn-secondary-sm my2logout">Logout</a>';
                                                        }else if(isset($_SESSION['username2']) && isset($_SESSION['user_type_id_value']) && $_SESSION['user_type_id_value'] == "35"){
                                                            ...
                                                            echo '<a href="dashboard/techno_enterprise/techno_dashboard.php" class="btn-secondary-sm">Dashboard</a>
                                                            <a href="login.php" class="btn-secondary-sm my2logout">Logout</a>';
                                                        }else if(isset($_SESSION['username2']) && isset($_SESSION['user_type_id_value']) && $_SESSION['user_type_id_value'] == "36"){
                                                            ...
                                                            echo '<a href="dashboard/business_mentor/business_mentor_dashboard.php" class="btn-secondary-sm">Dashboard</a>
                                                            <a href="login.php" class="btn-secondary-sm my2logout">Logout</a>';
                                                        }else if(isset($_SESSION['username2']) && isset($_SESSION['user_type_id_value']) && $_SESSION['user_type_id_value'] == "30"){
                                                            echo '<a href="dashboard/sponsor_franchisee/sponsor_franchisee_dashboard.php" class="btn-secondary-sm">Dashboard</a>
                                                            <a href="login.php" class="btn-secondary-sm my2logout">Logout</a>';
                                                        }else if(isset($_SESSION['username2']) && isset($_SESSION['user_type_id_value']) && $_SESSION['user_type_id_value'] == "28"){
                                                            echo '<a href="dashboard/master_franchisee/master_franchisee_dashboard.php" class="btn-secondary-sm">Dashboard</a>
                                                            <a href="login.php" class="btn-secondary-sm my2logout">Logout</a>';
                                                        }else if(isset($_SESSION['username2']) && isset($_SESSION['user_type_id_value']) && $_SESSION['user_type_id_value'] == "25"){
                                                            echo '<a href="dashboard/business_development_manager/business_development_manager_dashboard.php" class="btn-secondary-sm">Dashboard</a>
                                                            <a href="login.php" class="btn-secondary-sm my2logout">Logout</a>';
                                                        }else if(isset($_SESSION['username2'])){
