...
<!-- Mirrored from travelloo.vercel.app/template/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jul 2024 06:53:10 GMT -->
...
<head>
    ...
    <meta property="og:image" content="../../inittheme.com/images/selfie.jpg">
    ...
    <main>
                        ...
                        <div class="col-xl-7 col-lg-9">
                            <div class="contact-card">
                                ...
                                <form method="post" class="contact-form">
                                    <div class="row g-4">
                                        <div class="col-sm-12">
                                            <input class="custom-form" id="name" type="text" placeholder="Enter your name">
                                        </div>
                                        <div class="col-sm-6">
                                            <input class="custom-form" id="email" type="text" placeholder="Enter your email">
                                        </div>
                                        <div class="col-sm-6">
                                            <input class="custom-form" id="phnumber" type="text" placeholder="Your Phone">
                                        </div>
                                       
                                        <div class="col-sm-12">
                                            <textarea class="custom-form-textarea" id="comments" 
                                                rows="3" placeholder="Enter your message..." required></textarea>
                                        </div>
                                    </div>
                                    <div class="mt-40">
                                        <button  id="submit" class="send-btn">Send Message</button>
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <iframe class="map-frame"
            src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d571.5307134706843!2d73.83420951778066!3d15.495991326836652!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bbfc084f30e01d1%3A0x237904926b20c34e!2sDEMPO%20Tower!5e0!3m2!1sen!2sin!4v1721645560886!5m2!1sen!2sin"
