...
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
    ...
    <body>
        ...
        <main>
                        ...
                        <div class="login-card loginBackground w-75">
                            <form id="loginForm">
                                ...
                                <div id="step2" style="display:none">
                                    ...
                                    <div class="profile-card activeProfile" onclick="selectProfile(this,'Techno Enterprise','TE25001')">
                                        <div>
                                ...
                                <div id="step3" style="display:none">
                                    ...
                                    <button id="loginBtn" class="continueBtn mt-4">
                                        Login
                                        <i class="ri-arrow-right-line"></i>
                                    </button>
                                    <div class="d-flex w-100 gap-2">
            ...
            <!-- <div class="">
                <img src="assets/images/loginImage.png" alt="" class="loginImage">
                <div class="row d-flex justify-content-center loginCard">
                    <div class="col-xl-5 col-lg-5 align-content-center">
                        <div class="w-50">
                            <h1 class="text-normal text-white">Explore</h1>
                            <h1 class="text-bolder text-white">The world with us</h1>
                            <p class="text-normal text-white fs-5">Amazing Destination, Exclusive Deals and Unforgettable Experiences</p>
                        </div>
                    </div>
                            ...
                            <form action="#" method="POST">
                                <div class="position-relative contact-form mb-24">
                                    ...
                                    <select id="user_type" class="contact-input">
                                        ...
                                        <?php 
                                            $sql = "SELECT * FROM `user_type` WHERE status = '1' AND id IN (24, 25, 26, 16, 11, 10, 28, 29, 30, 32, 33) ";
