...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Training Manager View | Admin Dashboard </title>
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Training Manager</h4>
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-6">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Registered Training Manager List</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-8">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap dt-responsive nowrap w-100" id="registeredCustomerList-table">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql = "SELECT * FROM `training_manager` WHERE status = '1' OR status = '3' ORDER BY training_manager_id ASC ";
                                                        $stmt = $conn -> prepare($sql);
                                                        $stmt -> execute();
                                                        $stmt -> setFetchMode(PDO::FETCH_ASSOC);
                                                        if($stmt->rowCount()>0){
                                                                    ...
                                                                    if($row['status']== '1'){
                                                                        echo'<td>
                                                                            <div class="dropdown">
                                                                                ...
                                                                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-end-2">
                                                                                    <li><a href="#" onclick=\'overviewPage("'.$row["training_manager_id"]. '","' .$row["reference_no"]. '","' .$row["country"]. '","' .$row["state"]. '","' .$row["city"]. '","training_manager")\' class="dropdown-item" data-bs-toggle="modal" ><i class="mdi mdi-eye font-size-16 text-info me-1"></i> View</a></li>
                                                                                    <li><a href="#" onclick=\'editfuncCust("'.$row["training_manager_id"]. '","' .$row["reference_no"]. '","' .$row["register_by"]. '","' .$row["country"]. '","' .$row["state"]. '","' .$row["city"]. '","registered")\' class="dropdown-item" data-bs-toggle="modal" ><i class="mdi mdi-pencil font-size-16 text-primary me-1"></i> Edit</a></li>
                                                                                    <li><a href="#" onclick=\'deletefunc("' .$row["id"]. '","'.$row["training_manager_id"]. '","registered")\' class="dropdown-item" data-bs-toggle="modal" ><i class="mdi mdi-trash-can font-size-16 text-danger me-1"></i> Delete</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </td>';
                                                                    }else{
                                                                        echo'<td>
                                                                            <div class="dropdown">
                                                                                ...
                                                                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-end-2">
                                                                                    <li><a href="#" onclick=\'deletefunc("' .$row["id"]. '","'.$row["training_manager_id"]. '","deactivate")\' class="dropdown-item" data-bs-toggle="modal" ><i class="mdi mdi-file-restore font-size-16 text-success me-1"></i> Restore</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </td>';
                                                                    }
        ...
        <!-- Add button icon -->
        <div class="btn" data-bs-toggle="modal" data-bs-target="#newTrainingManagerModal" style="width: 25px; height: 25px; padding: 0px; position: fixed; bottom: 120px; right: 43px; border-radius: 50%;">
        ...
        <!-- Modal -->
        <div class="modal fade" id="newTrainingManagerModal" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-content">
                    <div class="modal-body px-4 py-5 text-center">
                        ...
                        <div class="hstack gap-2 justify-content-center mb-0">
                            <button type="button" class="btn btn-success" id="add-item"><a href="add_training_manager.php"><span style="color: white;">Add Now</span></a></button>
                            <button type="button" class="btn btn-secondary" id="close-newTrainingManagerModal" data-bs-dismiss="modal">Close</button>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <!-- end newTrainingManagerModal -->
        ...
        <script>
            ...
            function editfuncCust(id,refno,regby,cut,st,ct,editfor){ 
                window.location.href='edit_training_manager.php?vkvbvjfgfikix='+id+'&nohbref='+refno+'&fyfyfregby='+regby+'&ncy='+cut+'&mst='+st+'&hct='+ct+'&editfor='+editfor;
            };
            ...
            function deletefunc(id,fid,action){ 
                ...
                $.ajax({
                type: "POST",
                url: "training_manager/delete_training_manager.php",
                data: dataString,
                cache: false,
            ...
            function overviewPage(id,ref,cut,st,ct,message){
                var designation = 'Training Manager';
