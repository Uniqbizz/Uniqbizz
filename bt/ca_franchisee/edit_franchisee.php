...
<?php
        ...
        $stmt = $conn->prepare("SELECT * FROM `ca_franchisee` where ca_franchisee_id='".$id."' OR id = '".$id."'");
        $stmt->execute();
...
<head>
        ...
        <meta charset="utf-8" />
        <title>Franchisee Edit | Admin Dashboard </title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Edit Franchisee</h4>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="editFranchisee">Submit</button>
                                                    </div>
