...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Franchisee Add | Admin Dashboard </title>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                        ...
                                                        <!-- <div class="col-md-6 col-sm-12">
                                                            <div class="form-floating mb-3">
                                                                <select id="user_id_name" class="form-select">
                                                                    ...
                                                                    <?php 
                                                                        $sql = "SELECT * FROM travel_agent WHERE status = '1' ORDER BY travel_agent_id ASC";
                                                    ...
                                                    <input type="hidden" id="testValue" name="testValue" value="19"> <!-- CA Franchisee -->

                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="addFranchisee">Submit</button>
                                                    </div>
