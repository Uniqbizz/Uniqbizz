...
<?php
        ...
        $stmt = $conn->prepare("SELECT * FROM `training_manager` where training_manager_id='".$id."' OR id = '".$id."'");
        $stmt->execute();
        ...
        if($stmt->rowCount()>0){
            foreach (($stmt->fetchAll()) as $key => $row) {
                ...
                // business_operation_executive ref name
                $business_operation_executives = $conn->prepare("SELECT firstname, lastname, reference_no FROM business_operation_executive where business_operation_executive_id='".$reference_no."'");
                $business_operation_executives ->execute();
                $business_operation_executives ->setFetchMode(PDO::FETCH_ASSOC);
                if(  $business_operation_executives->rowCount()>0 ){
                    $business_operation_executive = $business_operation_executives->fetch();
                    $reference_no_fname = $business_operation_executive['firstname'];
                    $reference_no_lname = $business_operation_executive['lastname'];
...
<head>
        ...
        <meta charset="utf-8" />
        <title>Training Manager Edit | Admin Dashboard </title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Edit Training Manager</h4>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Edit Training Manager Form</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-8">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                    ...
                                                    <!-- for edit data page -->
                                                    <input type="hidden" id="testValue" name="testValue" value="21"> <!-- Training Manager -->
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="editTrainingManager">Submit</button>
                                                    </div>
