...
<div class="vertical-menu">
    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu" class="card mt-4 ms-2 rounded-4 pb-5">
            <!-- Left Menu Start -->
            <!-- <div class="card sidebar-card 100h m-2 rounded-3 shadow" style="padding-bottom: 25%;"> -->
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <!--<li>
                        ...
                        <ul class="sub-menu" aria-expanded="true">
                            <li><a href="../employee/view_head_office.php" key="t-level-1-1"><i class="bx bxs-user-detail"></i>Head Office</a></li>
                            <li><a href="../employee/view_zonal_manager.php" key="t-level-1-1"><i class="bx bxs-user-detail"></i>Zonal Manager</a></li>
                            <li><a href="../employee/view_regional_manager.php" key="t-level-1-1"><i class="bx bxs-user-detail"></i>Regional Manager</a></li>
                            <li><a href="../employee/view_franchisee_manager.php" key="t-level-1-2"><i class="bx bxs-user-detail"></i>Branch Manager</a></li>
                            <li><a href="../employee/view_floor_manager.php" key="t-level-1-3"><i class="bx bxs-user-detail"></i>Sales Manager</a></li>

                            <li><a href="../employee/view_trainee_manager.php" key="t-level-1-1"><i class="bx bxs-user-detail"></i>Trainee Manager</a></li>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="true">
                            <li><a href="../employee/employee.php" key="t-level-1-1"><i class="bx bxs-user-detail"></i>All Employee</a></li>
                            <li><a href="../departments/departments.php" key="t-level-1-1"><i class="bx bxs-user-detail"></i>Dept / Desig</a></li>
                            <!-- <li><a href="../designations/designations.php" key="t-level-1-1"><i class="bx bxs-user-detail"></i>Designation</a></li> -->
                        </ul>
                    </li>
                    <!-- <li>
                        <a href="javascript: void(0);" class="has-arrow waves-effect">
                            <i class="bx bxs-user-detail"></i>
                            <span key="t-multi-level">CA Franchisee</span>
                        </a>
                        <ul class="sub-menu" aria-expanded="true">
                            <li><a href="../ca_franchisee/view_franchisee.php" key="t-level-1-1"><i class="bx bxs-user-detail"></i>Franchisee</a></li>
                            <li><a href="../ca_franchisee/view_business_operation_executive.php" key="t-level-1-1"><i class="bx bxs-user-detail"></i>Business Operation Executive</a></li>
                            <li><a href="../ca_franchisee/view_training_manager.php" key="t-level-1-1"><i class="bx bxs-user-detail"></i>Training Manager</a></li>
                            <li><a href="../ca_franchisee/view_sales_manager_executive.php" key="t-level-1-2"><i class="bx bxs-user-detail"></i>Sales Manager / Executive</a></li>
                        </ul>
                    </li> -->
                    
                    <!-- <li>
                        <a href="../business_trainee/view_business_trainee.php" class=" waves-effect">
                            <i class="bx bxs-user-detail"></i>
                            <span key="t-contacts">Business Trainee</span>
                        </a>
                    </li> -->
                    <!-- <li>
                        <a href="../channel_business_director/view_cbd.php" class=" waves-effect">
                            <i class="bx bxs-user-detail"></i>
                            <span key="t-contacts">Channel Business Director</span>
                        </a>
                    </li> -->
                    <!-- <li>
                        <a href="../business_consultant/view_business_consultant.php" class=" waves-effect">
                            <i class="bx bxs-user-detail"></i>
                    ...
                    <!-- <li>
                        ...
                        <ul class="sub-menu" aria-expanded="true">
                            ...
                            <li><a href="../payout/business_mentor_payout.php" key="t-level-1-1"><i class="bx bxs-detail"></i>Business Mentor Payout</a></li> -->
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="true">
                            ...
                            <li><a href="../category/manage_categories.php" class=" waves-effect"><i class="bx bxs-user-detail"></i><span key="t-contacts">Category</span></a></li>
                            <li><a href="../quotations.php" class=" waves-effect"><i class="bx bxs-user-detail"></i><span key="t-contacts">Quotations</span></a></li> -->
                            <!-- topup wallent for TA by sv on 28-01-2025-->
                                <!-- <li><a class="waves-effect" href="../ta-top-up/ta_top_up.php"><i class="bx bx-wallet font-size-16 align-middle me-1"></i> <span key="ta-topup-wallet">TA Top-up Wallet</span></a></li> -->
                            <!-- <li>
                                <a href="javascript: void(0);" class="has-arrow" key="t-level-1-2">Level 1.2</a>
                                <ul class="sub-menu" aria-expanded="true">
                                    <li><a href="javascript: void(0);" key="t-level-2-1">Level 2.1</a></li>
