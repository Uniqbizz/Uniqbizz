...
$('#user_id_name').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'forms/cbd_payout/cbd_payout_filter.php',
...
$('#user_id_namePrevious').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'forms/cbd_payout/cbd_payout_filter_amt_user.php',
        data: dataString,
        cache: false,
        success: function(data){
            $('#prevDiv').html(data);
...
$('#month_year').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'forms/cbd_payout/cbd_payout_month.php',
        data: dataString,
        cache: false,
        success: function(data){
            console.log(data);
...
function paymentId(id, userID, message, amt, status, col_update){
    ...
    $('#submitPayment').click(function(e){
        ...
        $.ajax({
            type: 'POST',
            url: 'forms/cbd_payout/cbd_payout_paid.php',
            data: dataString,
            cache: false,
            success: function(data){
                console.log(data);
...
function totalPayoutExel(){
    ...
    if(totalPayoutDate){
        ...
        //     }
        // });
        window.location.href='forms/cbd_payout/download_exel_cbd?payoutYear='+payoutYear+'&payoutMonth='+payoutMonth+'&payoutmessage='+payoutmessage;
    }else{
...
function allPayoutExel(){
    ...
    window.location.href='forms/cbd_payout/download_exel_cbd?payoutYear='+payoutYear+'&payoutMonth='+payoutMonth+'&payoutmessage='+payoutmessage+'&designation='+designation+'&user_id='+user_id;
}

// **** cbd_payout Javascript End ****