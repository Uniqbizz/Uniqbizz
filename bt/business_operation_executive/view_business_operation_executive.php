...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Business Operation Executive View | Admin Dashboard </title>
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Business Operation Executive</h4>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Pending Business Operation Executive List</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-6">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap dt-responsive nowrap w-100" id="pendingCustomerList-table">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql = "SELECT * FROM `business_operation_executive` WHERE status = '2' OR status = '0' ORDER BY business_operation_executive_id ASC ";
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-6">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Registered Business Operation Executive List</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-8">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap dt-responsive nowrap w-100" id="registeredCustomerList-table">
                                                <thead class="table-light">
                                                    <tr>
                                                        <th>Business Operation Executive Id</th>
                                                        <th>Full Name</th>
                                                        <th>Reference ID / Name</th>
                                                        <th>Phone / Email</th>
                                                        <!-- <th>Address</th> -->
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql = "SELECT * FROM `business_operation_executive` WHERE status = '1' OR status = '3' ORDER BY business_operation_executive_id ASC ";
                                                        $stmt = $conn -> prepare($sql);
                                                        $stmt -> execute();
                                                        $stmt -> setFetchMode(PDO::FETCH_ASSOC);
                                                        if($stmt->rowCount()>0){
                                                            foreach(($stmt->fetchAll()) as $key => $row) {
                                                                ...
                                                                echo'<tr>
                                                                    <td>'.$row['business_operation_executive_id'].'</td>
                                                                    <td>'.$row['firstname'].' '.$row['lastname'].'</td>
                                                                    ...
                                                                    if($row['status']== '1'){
                                                                        echo'<td>
                                                                            <div class="dropdown">
                                                                                ...
                                                                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-end-2">
                                                                                    <li><a href="#" onclick=\'overviewPage("'.$row["business_operation_executive_id"]. '","' .$row["reference_no"]. '","' .$row["country"]. '","' .$row["state"]. '","' .$row["city"]. '","business_operation_executive")\' class="dropdown-item" data-bs-toggle="modal" ><i class="mdi mdi-eye font-size-16 text-info me-1"></i> View</a></li>
                                                                                    <li><a href="#" onclick=\'editfuncCust("'.$row["business_operation_executive_id"]. '","' .$row["reference_no"]. '","' .$row["register_by"]. '","' .$row["country"]. '","' .$row["state"]. '","' .$row["city"]. '","registered")\' class="dropdown-item" data-bs-toggle="modal" ><i class="mdi mdi-pencil font-size-16 text-primary me-1"></i> Edit</a></li>
                                                                                    <li><a href="#" onclick=\'deletefunc("' .$row["id"]. '","'.$row["business_operation_executive_id"]. '","registered")\' class="dropdown-item" data-bs-toggle="modal" ><i class="mdi mdi-trash-can font-size-16 text-danger me-1"></i> Delete</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </td>';
                                                                    }else{
                                                                        echo'<td>
                                                                            <div class="dropdown">
                                                                                ...
                                                                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-end-2">
                                                                                    <li><a href="#" onclick=\'deletefunc("' .$row["id"]. '","'.$row["business_operation_executive_id"]. '","deactivate")\' class="dropdown-item" data-bs-toggle="modal" ><i class="mdi mdi-file-restore font-size-16 text-success me-1"></i> Restore</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </td>';
                                                                    }
                ...
                <div class="modal-content">
                    <div class="modal-body px-4 py-5 text-center">
                        ...
                        <div class="hstack gap-2 justify-content-center mb-0">
                            <button type="button" class="btn btn-success" id="add-item"><a href="add_business_operation_executive.php"><span style="color: white;">Add Now</span></a></button>
        ...
        <script>
            ...
            function editfuncCust(id,refno,regby,cut,st,ct,editfor){ 
                window.location.href='edit_business_operation_executive.php?vkvbvjfgfikix='+id+'&nohbref='+refno+'&fyfyfregby='+regby+'&ncy='+cut+'&mst='+st+'&hct='+ct+'&editfor='+editfor;
            };
            ...
            function deletefunc(id,fid,action){ 
                ...
                $.ajax({
                type: "POST",
                url: "delete_business_operation_executive.php",
                data: dataString,
                cache: false,
            ...
            function confirmfunc(id,email){ 
                ...
                $.ajax({
                    type: "POST",
                    url: "confirm_business_operation_executive.php",
                    data: dataString,
                    cache: false,
                    success:function(data){
                        if(data == 1){
            ...
            function overviewPage(id,ref,cut,st,ct,message){
                var designation = 'Business Operation Executive';
