...
if($editfor == 'pending'){
	...
	$identifier_name = 'id=';
	$message="Updated Business Operation Executive details from ".$editfor. " list";
	$message2="Updated Business Operation Executive details from ".$editfor. " list";
