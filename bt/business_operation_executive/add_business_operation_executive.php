                                            ...
                                            <div class="col-md-6 col-sm-4">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Add Business Operation Executive Form</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-8">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                        ...
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-floating mb-3">
                                                                <select id="user_id_name" class="form-select">
                                                                    ...
                                                                    <?php 
                                                                        $sql = "SELECT * FROM ca_franchisee WHERE status = '1' ORDER BY ca_franchisee_id ASC";
                                                                        $stmt = $conn -> prepare($sql);
                                                                        $stmt -> execute();
                                                                        $stmt -> setFetchMode(PDO::FETCH_ASSOC);
                                                                        if( $stmt -> rowCount() > 0 ){
                                                                            foreach( ($stmt -> fetchAll()) as $key => $row){
                                                                                echo'<option value="'.$row['ca_franchisee_id'].'">'.$row['ca_franchisee_id'].' '.$row['firstname'].' '.$row['lastname'].'</option> ';
                                                                            }
                                                                        }
                                                                    ?>
                                                                </select>
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="addBusinessOperationExecutive">Submit</button>
                                                    </div>
