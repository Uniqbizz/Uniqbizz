...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Sales Manager Add | Admin Dashboard </title>
    ...
    <body data-sidebar="dark">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                        ...
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-floating mb-3">
                                                                <select id="user_id_name" class="form-select">
                                                                    ...
                                                                    <?php
                                                                        $sql = "SELECT * FROM `branch_manager` WHERE status ='1' ORDER BY branch_manager_id ASC ";
                                                    ...
                                                    <input type="hidden" id="testValue" name="testValue" value="5"> <!-- Floor Manager -->
                                                                    
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="addFloorManager">Submit</button>
                                                    </div>
        ...
        <script>
            ...
            $('#user_id_name').on('change', function(){
                ...
                var designation = 'branch_manager';
                // console.log(designation);
