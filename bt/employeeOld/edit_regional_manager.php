...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Regional Manager Edit | Admin Dashboard </title>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <div class="form">
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="editReginalManager">Submit</button>
                                                    </div>
