...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Trainee Manager View | Admin Dashboard </title>
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Trainee Manager</h4>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Pending Trainee Manager List</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="text-sm-end">
                                                    <button type="button" data-bs-toggle="modal" data-bs-target="#newTraineeManagerModal" class="btn btn-success btn-rounded waves-effect waves-light mb-2 me-2 addBTraineeManagermodal"><i class="mdi mdi-plus me-1"></i> New Trainee Manager</button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap dt-responsive nowrap w-100" id="pendingCustomerList-table">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql = "SELECT * FROM `trainee_manager` WHERE status = '2' OR status = '0' ORDER BY id ASC ";
                                                                        ...
                                                                        echo'<td>
                                                                            <div class="dropdown">
                                                                                ...
                                                                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-end-1">
                                                                                    <li><a href="#" onclick=\'editfunc("' .$row["id"]. '","' .$row["country"]. '","' .$row["state"]. '","' .$row["city"]. '", "pending","' .$row["zone"]. '","' .$row["region"]. '","' .$row["branch"]. '")\' class="dropdown-item" data-bs-toggle="modal" ><i class="mdi mdi-pencil font-size-16 text-primary me-1"></i> Edit</a></li>
                                                                                    ...
                                                                                    <li><a href="#" onclick=\'confirmfunc("' .$row["id"]. '","' .$row["email"]. '","' .$row["state"]. '")\' class="dropdown-item" data-bs-toggle="modal" ><i class="fas fa-check-circle font-size-16 text-success me-1"></i> Confirm</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </td>';
                                                                    }else{
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-6">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Registered Trainee Manager List</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-8">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table align-middle table-nowrap dt-responsive nowrap w-100" id="registeredCustomerList-table">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql = "SELECT * FROM `trainee_manager` WHERE status = '1' OR status = '3' ORDER BY trainee_manager_id ASC ";
                                                        $stmt = $conn -> prepare($sql);
                                                        $stmt -> execute();
                                                        $stmt -> setFetchMode(PDO::FETCH_ASSOC);
                                                        if($stmt->rowCount()>0){
                                                                    ...
                                                                    if($row['status']== '1'){
                                                                        echo'<td>
                                                                            <div class="dropdown">
                                                                                ...
                                                                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-end-2">
                                                                                    <li><a href="#" onclick=\'editfunc("' .$row["trainee_manager_id"]. '","' .$row["country"]. '","' .$row["state"]. '","' .$row["city"]. '", "registered","' .$row["zone"]. '","' .$row["region"]. '","' .$row["branch"]. '")\' class="dropdown-item" data-bs-toggle="modal" ><i class="mdi mdi-pencil font-size-16 text-primary me-1"></i> Edit</a></li>
                                                                                    <li><a href="#" onclick=\'deletefunc("' .$row["id"]. '","'.$row["trainee_manager_id"]. '","registered")\' class="dropdown-item" data-bs-toggle="modal" ><i class="mdi mdi-trash-can font-size-16 text-danger me-1"></i> Delete</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </td>';
                                                                    }else{
                                                                        echo'<td>
                                                                            <div class="dropdown">
                                                                                ...
                                                                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-end-2">
                                                                                    <li><a href="#" onclick=\'deletefunc("' .$row["id"]. '","'.$row["trainee_manager_id"]. '","deactivate")\' class="dropdown-item" data-bs-toggle="modal" ><i class="mdi mdi-file-restore font-size-16 text-success me-1"></i> Restore</a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </td>';
                                                                    }
        ...
        <!-- Add button icon -->
        <div class="btn" data-bs-toggle="modal" data-bs-target="#newTraineeManagerModal" style="width: 25px; height: 25px; padding: 0px; position: fixed; bottom: 120px; right: 43px; border-radius: 50%;">
        ...
        <!-- Modal -->
        <div class="modal fade" id="newTraineeManagerModal" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-content">
                    <div class="modal-body px-4 py-5 text-center">
                        ...
                        <div class="hstack gap-2 justify-content-center mb-0">
                            <button type="button" class="btn btn-success" id="add-item"><a href="add_trainee_manager.php"><span style="color: white;">Add Now</span></a></button>
                            <button type="button" class="btn btn-secondary" id="close-newTraineeManagerModal" data-bs-dismiss="modal">Close</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            ...
            { 
                window.location.href='edit_trainee_manager.php?vkvbvjfgfikix='+id+'&ncy='+cut+'&mst='+st+'&hct='+ct+'&editfor='+editfor+'&zdfds='+z+'&rdsfdsf='+r+'&bdfdsf='+b;  
            };

            function deletefunc(id,fid,action){ 
                var dataString = 'id='+id+'&rmid='+fid+'&action='+action;

                $.ajax({
                type: "POST",
                url: "trainee_manager/delete_trainee_manager.php",
                data: dataString,
                cache: false,
            ...
            function confirmfunc(id,email,st){ 
                ...
                $.ajax({
                    type: "POST",
                    url: "trainee_manager/confirm_trainee_manager.php",
                    data: dataString,
                    cache: false,
                    success:function(data){
                        console.log(data);
