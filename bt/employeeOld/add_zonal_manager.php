...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Zonal Manager Add | Admin Dashboard </title>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                        ...
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-floating mb-3">
                                                                <select id="user_id_name" class="form-select">
                                                                    ...
                                                                    <?php
                                                                        $sql = "SELECT * FROM `head_office` WHERE status ='1' ORDER BY head_office_id ASC ";
                                                                        $stmt = $conn -> prepare($sql);
                                                                        $stmt -> execute();
                                                                        $stmt->setFetchMode(PDO::FETCH_ASSOC);
                                                                        if($stmt -> rowCount()>0){
                                                                            foreach (($stmt->fetchAll()) as $key => $row) {
                                                                                echo '<option value="'.$row['head_office_id'].'">'.$row['head_office_id'].' ('.$row['firstname'].' '.$row['lastname'].')</option>';
                                                                            }
                                                                        }
                                                                    ?>
                                                                </select>
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="addZonalManager">Submit</button>
                                                    </div>
