...
if($editfor == 'pending'){
	...
	$identifier_name = 'id=';
	$message="Updated Zonal Manager Details from ".$editfor. " list";
$message2="Updated Zonal Manager Details from ".$editfor. " list";
