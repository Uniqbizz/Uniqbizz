...
if($editfor == 'pending'){
	...
	$identifier_name = 'id=';
	$message="Updated Head Office Details from ".$editfor. " list";
$message2="Updated Head Office Details from ".$editfor. " list";
