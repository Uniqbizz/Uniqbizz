...
$sql9= $conn->prepare("SELECT * from channel_business_director where id='".$id."' and status='2'");
$sql9->execute();
...
$sql1 = "UPDATE channel_business_director SET status=:status,channel_business_director_id=:channel_business_director_id WHERE id=:id";
