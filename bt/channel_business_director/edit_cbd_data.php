...
if($editfor == 'pending'){
	...
	$identifier_name = 'id=';
	$message="Updated Channel Business Director details from ".$editfor. " list";
	$message2="Updated Channel Business Director details from ".$editfor. " list";
