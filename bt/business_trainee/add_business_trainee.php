...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Business Trainee Add | Admin Dashboard </title>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Add Business Trainee Form</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-8">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="addBusinessTrainee">Submit</button>
                                                    </div>
