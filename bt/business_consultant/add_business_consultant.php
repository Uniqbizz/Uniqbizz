...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Business Consultant Add | Admin Dashboard </title>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Add Business Consultant Form</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-8">
                                            ...
                                            <div class="col-12">
                                                <form>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 col-sm-12">
                                                            <div class="form-floating mb-3">
                                                                ...
                                                                <label for="user_id_name"> Designation</label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4 col-sm-12">
                                                            <div class="form-floating mb-3">
                                                                <input type="text" class="form-control" id="reference_name" placeholder="No Referance selected for the user" readonly>
                                                                <label for="reference_name"> Referance Name </label>
                                                            </div>    
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-floating mb-3">
                                                                <input type="date" class="form-control" id="dob" placeholder="Enter DOB address">
