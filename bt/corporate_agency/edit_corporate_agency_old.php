                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <div class="input-block mb-3">
                                                    ...
                                                    <div class="d-flex flex-column gap-2 mb-2" id="tcallotment">
                                                        <label class="form-label">TC Allotment: <span class="text-danger">*</span></label>
                                                    ...
                                                    <div id="availableTCs" class="mt-3">
                                                        ...
                                                        <div id="tcListContainer" style="max-height: 250px; overflow-y: auto; border: 1px solid #ccc; border-radius: 5px; padding: 10px;">
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <div class="input-block mb-3">
                                                    ...
                                                    <!-- Tax After Deduction -->
                                                    <div class="mb-3">
                                                        <label for="taxAfterDeduction" class="form-label">Tax After Deduction:</label>
                                                        <input type="number" step="0.01" class="form-control" id="taxAfterDeduction" name="taxAfterDeduction" placeholder="Enter tax amount">
                                                    </div>

                                                    <!-- Repay Amount -->
                                                    <div class="mb-3">
                                                        <label for="repayAmount" class="form-label">Repay Amount:</label>
                                                        <input type="number" step="0.01" class="form-control" id="repayAmount" name="repayAmount" placeholder="Enter repay amount">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
