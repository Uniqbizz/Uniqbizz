<?php
    ...
    $title="Business Operation Executive";
    $message="Added new Business Operation Executive by Admin";
    $message2="Added new Business Operation Executive by Admin";
    $fromWhom="1";
    ...
    if ($result) {
		...
		$sql4= "INSERT INTO logs (title,message,message2, reference_no,register_by, from_whom) VALUES (:title ,:message, :message2, :reference_no,:register_by, :from_whom)";
