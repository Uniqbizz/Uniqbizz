        ...
        foreach( ($stmt -> fetchALL()) as $key => $row ){
            ...
            echo '<tr>
                    ...
                    <td class="text-end">'.$totalAmt.'
                        <a href="../../controllers/payout/forms/sub_franchisee/download_ca_payout.php?vkvbvjfgfikix='.urlencode($row['id']).'&userId='.urlencode($row['userId']).'&te='.urlencode($row['sub_franchisee']).'&date='.urlencode($dt).'
