...
if($userType = "sub_franchisee"){

    $stmt2 = $conn->prepare("SELECT * FROM sub_franchisee WHERE sub_franchisee_id = '$user_id' AND user_type = '29' AND status = 1");
    $stmt2->execute();                                                                                   
    $stmt2->setFetchMode(PDO::FETCH_ASSOC);
...
if($userType = "sponsor_franchisee"){

    $stmt2 = $conn->prepare("SELECT * FROM sponsor_franchisee WHERE sponsor_franchisee_id = '$user_id' AND user_type = '30' AND status = 1");
    $stmt2->execute();                                                                                   
    $stmt2->setFetchMode(PDO::FETCH_ASSOC);
