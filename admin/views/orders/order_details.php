...
<head>
    ...
    <style>
        ...
        .order-details-cusutom{
            font-size: 10px; 
            list-style:none;
        }
        .order-details-custom-color{
            color: #ffffff; 
            width: 30px; 
            height: 30px;
        }
                                    ...
                                    <div class="row px-2 pb-2 mb-3 rounded-5 border border-dark" style="width:700px;">
                                        ...
                                        <footer>
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 p-3">
                                                <ol>
                                                    <li class="text-center text-dark fw-bolder order-details-cusutom">This invoice is computer-generated.</li>
                                                </ol>
                                                <ol class="d-flex justify-content-between contDetails">
                                                    <li class="text-dark fw-bolder" >www.uniqbizz.com</li>
                                                    <li class="text-dark fw-bolder" >support@uniqbizz.com</li>
                                                    <li class="text-dark fw-bolder" >8080785714 / 8010892265</li>
                                                </ol>
                                            </div>
                                        </footer>
                                    </div>
                                ...
                                <div class="col-md-8">
                                    <div class="d-flex align-items-center p-3 position">
                                        ...
                                        <p class="rounded-circle ms-2 bg-primary p-1 mb-0">
                                            <i class="fa-regular fa-calendar-check fa-xl d-flex align-items-center justify-content-center order-details-custom-color"></i>
                                        </p>
                                        <hr>
                                ...
                                <?php if ($total_direct['pay_type'] == 1) { ?>
                                    <div class="col-md-8">
                                        <div class="d-flex align-items-center p-3 pt-0 position">
                                            ...
                                            <p class="rounded-circle ms-2 bg-primary p-1 mb-0">
                                                <i class="fa-solid fa-money-bill fa-xl d-flex align-items-center justify-content-center order-details-custom-color"></i>
                                            </p>
                                            <hr>
                                ...
                                if ($book_status == 'Completed') { ?>
                                    ...
                                    <div class="col-md-8">
                                        <div class="d-flex align-items-center p-3 pt-0 position">
                                            ...
                                            <p class="rounded-circle ms-2 bg-primary p-1 mb-0">
                                                <i class="fa-brands fa-fly fa-xl d-flex align-items-center justify-content-center order-details-custom-color"></i>
                                            </p>
                                            <hr>
                                ...
                                if ($booking['status'] == '2' || $booking['cancel_date'] !=NULL) { ?>
                                    <div class="col-md-8">
                                        <div class="d-flex align-items-center p-3 pt-0 position">
                                            ...
                                            <p class="rounded-circle ms-2 bg-primary p-1 mb-0">
                                                <i class="fa-solid fa-trash-can fa-xl d-flex align-items-center justify-content-center order-details-custom-color"></i>
                                            </p>
                                            <hr>
                                ...
                                if ($booking['status'] == '3' || $booking['refund_date']) {?>
                                    <div class="col-md-8">
                                        <div class="d-flex align-items-center p-3 pt-0 position">
                                            ...
                                            <p class="rounded-circle ms-2 bg-primary p-1 mb-0">
                                                <i class="fa-solid fa-money-bill-transfer fa-xl d-flex align-items-center justify-content-center order-details-custom-color" ></i>
                                            </p>
                                            <hr>
