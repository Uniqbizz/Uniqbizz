...
<html lang="en">
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
                                            ...
                                            <div class="col-lg-12 d-flex justify-content-between pb-3 pt-3 ps-3 mb-4" style="border-bottom: 1px solid #DDDDDD">
                                                ...
                                                <div class="dropdown mt-">
                                                    ...
                                                    <div class="dropdown-menu" id="dr-users" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="../../views/amenities/add_new_stay_types.php">Add Stay Types</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="table-responsive table-desi">
                                                    <table class="table table-hover" id="user_table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php include '../../models/amenities/hotels/show_hotel_type.php' ?>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="col-lg-12 d-flex justify-content-between pb-3 pt-3 ps-3 mb-4" style="border-bottom: 1px solid #DDDDDD">
                                                ...
                                                <div class="dropdown mt-">
                                                    <a class="" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false"><i class="mdi mdi-dots-vertical-circle-outline mdi-36px pe-3" style="color: grey;"></i></a>
                                                    <div class="dropdown-menu" id="dr-users" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="../../views/amenities/add_new_meals.php">Add Meals</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="table-responsive table-desi">
                                                    <table class="table table-hover" id="user_table">
                                                        ...
                                                        <tbody>
                                                            <!-- data load from models file -->
                                                             <?php include '../../models/amenities/meals/show_meal_type.php' ?>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="col-lg-12 d-flex justify-content-between pb-3 pt-3 ps-3 mb-4" style="border-bottom: 1px solid #DDDDDD">
                                                ...
                                                <div class="dropdown mt-">
                                                    <a class="" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false"><i class="mdi mdi-dots-vertical-circle-outline mdi-36px pe-3" style="color: grey;"></i></a>
                                                    <div class="dropdown-menu" id="dr-users" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="../../views/amenities/add_new_vehicle.php">Add Vehicles</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="table-responsive table-desi">
                                                    <table class="table table-hover" id="user_table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php include '../../models/amenities/vehicles/show_vehicle_type.php' ?>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="col-lg-12 d-flex justify-content-between pb-3 pt-3 ps-3 mb-4" style="border-bottom: 1px solid #DDDDDD">
                                                ...
                                                <div class="dropdown mt-">
                                                    <a class="" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false"><i class="mdi mdi-dots-vertical-circle-outline mdi-36px pe-3" style="color: grey;"></i></a>
                                                    <div class="dropdown-menu" id="dr-users" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="../../views/amenities/add_new_occupancy.php">Add Occupancy</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="table-responsive table-desi">
                                                    <table class="table table-hover" id="user_table">
                                                        ...
                                                        <tbody>
                                                            <!-- data laod from models file -->
                                                            <?php include '../../models/amenities/occupancy/show_occupancy_type.php' ?>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
        ...
        <script src="../../resources/amenities/amenities_custom.js"></script>
    </body>
