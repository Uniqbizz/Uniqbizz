                            ...
                            <div class="col-12 card">
                                ...
                                <div class="col-lg-12 col-md-12 col-12">
                                    <form>
                                        ...
                                        <div class="row">
                                            <div class="btn bg-primary col-sm-1 m-4 ms-3" id="addMeals">
        ...
        <script type="text/javascript">
            ...
            $('#addMeals').click(function(e){
                ...
                if (name ==='' || !name.match(characterLetters) || name.length <= 2){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../../models/amenites/meals/create.php",
                        data: dataString,
                        cache: false,
