...
<html lang="en">
    ...
    <body data-sidebar="dark">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-sm-6 col-6  border-4 border-end border-end-dashed">
                                                <div class="page-title-box p-3">
                                                    ...
                                                    <a href="../../controllers/payout/forms/recruitment_payout/download_exel_ca?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout">
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-6 ">
                                                <div class="page-title-box p-3">
                                                    ...
                                                    <a href="../../controllers/payout/forms/recruitment_payout/download_exel_ca?payoutYear=<?php echo $nextDateYear; ?>&payoutMonth=<?php echo $nextDateMonth; ?>&payoutmessage=NextPayout">
                                                        <i class="bx bx-download download-icon1" style="font-size: 20px; color: black; margin-left: 20%;"></i>
                                                    </a>
                                                </div>
                                            </div>
                        ...
                        <div class="row d-flex justify-content-evenly">   
                            <div class="col-lg-4 col-md-4 col-sm-7 card" style="border: 2px solid black; border-radius: 10px;">
                                <div class="page-title-box p-3">
                                    ...
                                    <div class="d-flex">
                                        <!-- data table load from models file -->
        ...
        <!-- custom js  -->
        <script src="../../resources/payout/payout_recruitment.js"></script>
