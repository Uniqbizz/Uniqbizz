...
<html lang="en">
    ...
    <body data-sidebar="dark">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-sm-6 col-6  border-4 border-end border-end-dashed">
                                                <div class="page-title-box p-3">
                                                    ...
                                                    <a href="../../controllers/payout/forms/customer_reference/download_exel_cu?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout">
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-6 ">
                                                <div class="page-title-box p-3">
                                                    ...
                                                    <a href="../../controllers/payout/forms/customer_reference/download_exel_cu?payoutYear=<?php echo $nextDateYear; ?>&payoutMonth=<?php echo $nextDateMonth; ?>&payoutmessage=NextPayout">
                                                        <i class="bx bx-download download-icon1" style="font-size: 20px; color: black; margin-left: 20%;"></i>
                                                    </a>
                                                </div>
                                            </div>
        ...
        <!-- custom js  -->
        <script src="../../resources/payout/payout_customer_reference.js"></script>
