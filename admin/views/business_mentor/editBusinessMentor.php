...
<!doctype html>
<html lang="en">
    <?php include '../../models/business_mentor/edit_bm.php' ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="input-block mb-3">
                                                        ...
                                                        <input class="form-control" type="text" id="nominee_name" name="nominee_name" value=" <?php echo $nominee_name; ?>">
                                                        <?php
                                                            $column = 'nominee_name';
                                                            include '../common_views/edit_log_tooltip.php';
                                                        ?>
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="input-block mb-3">
                                                        ...
                                                        <input class="form-control" type="text" id="nominee_relation" name="nominee_relation" value=" <?php echo $nominee_relation; ?>">
                                                        <?php
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="input-block mb-3">
                                                        ...
                                                        <input class="form-control" type="date" id="dob" name="dob" value="<?php echo $date_of_birth ;?>">
                                                        <?php
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 col-sm-4 col-3">
                                                            <div class="input-block">
                                                                ...
                                                                <select class="form-control" id="country_cd" name="country_cd">
                                                                    <?php 
                                                                        if($stmt->rowCount()>0){
                                                        ...
                                                        <div class="col-md-8 col-sm-8 col-9">
                                                            <div class="input-block">
                                                                ...
                                                                <input class="form-control" type="text" id="phone" name="phone" value=" <?php echo $contact_no; ?>">
                                                                <?php
                                                                    $column = 'contact_no';
                                                                    include '../common_views/edit_log_tooltip.php';
                                                                ?>
                                                        ...
                                                        <div class="row d-flex justify-content-center">
                                                            <div class="col-md-4 py-1">
                                                                <div class="input-block">
                                                                    ...
                                                                    <input type="text" class="form-control" id="chequeNo" placeholder="Enter Cheque Number" value="<?= isset($cheque_no) && !empty($cheque_no) ? $cheque_no : ''; ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4 py-1">
                                                                <div class="input-block">
                                                                    ...
                                                                    <input type="text" class="form-control" id="chequeDate" placeholder="Enter Date On Cheque" value="<?= isset($cheque_date) && !empty($cheque_date) ? $cheque_date : ''; ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4 py-1">
                                                                <div class="input-block">
                                                                    ...
                                                                    <input type="text" class="form-control" id="bankName" placeholder="Enter your Bank Name" value="<?= isset($bank_name) && !empty($bank_name) ? $bank_name : ''; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row d-flex justify-content-center">
                                                            <div class="col-md-8">
                                                                <div class="input-block">
                                                                    ...
                                                                    <input type="text" class="form-control" id="transactionNo" placeholder="Enter your Transaction No." value="<?= isset($transaction_no) && !empty($transaction_no) ? $transaction_no : ''; ?>">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
