                                    ...
                                    <div class="card-body">
                                        <form>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="input-block mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="franchiseeID" placeholder="Enter Franchisee ID" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="input-block mb-3">
                                                ...
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="input-block mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="prev_amount" placeholder="Enter Previous Amount" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-sm-6">
                                                    <div class="input-block mb-3">
                                            ...
                                            <div class="d-flex justify-content-evenly mb-4">
                                                ...
                                                <button type="reset" class="btn btn-primary px-5 py-2" id="addCorporateAgency">Cancel</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
