                                                                    ...
                                                                    <td>
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-menu-right dropdown-menu-end-2">
                                                                                <li><a href="#" onclick=\'overviewPage("' . $row["user_id"] . '","' .$row["reference_no"] . '","' .$row["country"] . '","' .$row["state"] . '","' .$row["city"] . '","' .($row['user_type'] == 'MF' ? 'master_franchisee' : ($row['user_type'] == 'BM' ? 'business_mentor' : ($row['user_type'] == 'SF' ? 'sponsor_franchisee' :  ''))) .'")\' class="dropdown-item" data-bs-toggle="modal" ><i class="mdi mdi-eye font-size-16 text-info me-1"></i> View</a></li>
