...
// **** business_mentor_payout Javascript Start ****
...
$('#user_id_name').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'forms/business_mentor_payout/business_mentor_payout_filter.php',
...
$('#user_id_namePrevious').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'forms/business_mentor_payout/business_mentor_payout_filter_amt_user.php',
        data: dataString,
        cache: false,
        success: function(data){
            $('#prevDiv').html(data);
...
$('#month_year').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'forms/business_mentor_payout/business_mentor_payout_month.php',
        data: dataString,
        cache: false,
        success: function(data){
            console.log(data);
...
function paymentId(id, userID, message, amt, status, col_update){
    ...
    $('#submitPayment').click(function(e){
        ...
        if(paymentMessage.length>0){
            $.ajax({
                type: 'POST',
                url: 'forms/business_mentor_payout/business_mentor_payout_paid.php',
                data: dataString,
                cache: false,
                success: function(data){
                    console.log(data);
