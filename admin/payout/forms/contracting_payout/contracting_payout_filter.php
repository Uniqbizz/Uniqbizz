...
if ($TotalPayoutFilter) {
    ...
    if ($designation == 'business_development_manager') {
        if ($cap_id) {
            ...
            $sqlId = "SELECT id, bdm_id as userId, message, message_details, comm_amt, techno_enterprise, created_date, status, 'goaBdm' as identity FROM goa_bdm_payout WHERE status = '1' order by created_date DESC";
        }
        ...
        if ($cap_id) {
            ...
            $sqlId = "SELECT id, bm_id as userId, message, message_details, comm_amt, techno_enterprise, created_date, status, 'goaBm' as identity FROM `goa_bm_payout` WHERE status = '1' UNION ALL
        ...
        if ($cap_id) {
            ...
            $sqlId = "SELECT id, bdm_id as userId, message, message_details, comm_amt, techno_enterprise, created_date, status, 'goaBdm' as identity FROM `goa_bdm_payout` WHERE status = '1' UNION ALL
    ...
    if (!empty($designation)) {
        ...
        $sqlId = "SELECT id, bdm_id as userId, message, comm_amt, techno_enterprise, created_date, status, 'goaBdm' as identity 
                  FROM goa_bdm_payout
                  UNION ALL
                  SELECT id, bm_id as userId, message, comm_amt, techno_enterprise, created_date, status, 'goaBm' as identity 
                  FROM goa_bm_payout
                  UNION ALL
                  SELECT id, business_mentor as userId, message, comm_amt, techno_enterprise, created_date, status, 'caPayout' as identity 
                  FROM ca_payout
                  UNION ALL
                  SELECT id, bm_user_id as userId, message_bm as message, payout_amount as comm_amt, ca_user_id as techno_enterprise, payout_date as created_date, payout_status as status, 'bmPayoutHistory' as identity 
    ...
    if (!empty($designation)) {
        if ($designation == 'business_development_manager') {
            ...
            if ($cap_id) {
                ...
                $sqlId = "SELECT id, bm_id as userId, message, comm_amt, techno_enterprise, created_date, status, 'goaBm' as identity FROM `goa_bm_payout` WHERE  YEAR(created_date) = '" . $cap_year . "' AND MONTH(created_date) = '" . $cap_month . "' UNION ALL
                            ...
                            SELECT id, bm_user_id as userId, message_bm as message, payout_amount as comm_amt, ca_user_id as techno_enterprise, payout_date as created_date, payout_status as status, 'bmPayoutHistory' as identity FROM `bm_payout_history` WHERE YEAR(payout_date) = '" . $cap_year . "' AND MONTH(payout_date) = '" . $cap_month . "'
                            order by created_date desc";
            }
        } else if ($designation == 'corporate_agency') {
            if ($cap_id) {
                ...
                $sqlId = "SELECT id, bdm_id as userId, message, comm_amt, techno_enterprise, created_date, status, 'goaBdm' as identity FROM `goa_bdm_payout` WHERE YEAR(created_date) = '" . $cap_year . "' AND MONTH(created_date) = '" . $cap_month . "' UNION ALL
                            ...
                            SELECT id, business_mentor as userId, message, comm_amt, techno_enterprise, created_date, status, 'caPayout' as identity FROM `ca_payout` WHERE AND YEAR(created_date) = '" . $cap_year . "' AND MONTH(created_date) = '" . $cap_month . "' UNION ALL
                            SELECT id, bm_user_id as userId, message_bm as message, payout_amount as comm_amt, ca_user_id as techno_enterprise, payout_date as created_date, payout_status as status, 'bmPayoutHistory' as identity FROM `bm_payout_history` WHERE YEAR(payout_date) = '" . $cap_year . "' AND MONTH(payout_date) = '" . $cap_month . "'
                            order by created_date desc ";
            }
        }
        ...
        $sqlId = "SELECT id, bdm_id as userId, message, comm_amt, techno_enterprise, created_date, status, 'goaBdm' as identity 
                  FROM goa_bdm_payout 
                  WHERE YEAR(created_date) = '" . $cap_year . "' AND MONTH(created_date) = '" . $cap_month . "'
                  UNION ALL
                  SELECT id, bm_id as userId, message, comm_amt, techno_enterprise, created_date, status, 'goaBm' as identity 
                  FROM goa_bm_payout 
                  WHERE YEAR(created_date) = '" . $cap_year . "' AND MONTH(created_date) = '" . $cap_month . "'
                  ...
                  SELECT id, bm_user_id as userId, message_bm as message, payout_amount as comm_amt, ca_user_id as techno_enterprise, payout_date as created_date, payout_status as status, 'bmPayoutHistory' as identity 
                  FROM bm_payout_history 
                  WHERE YEAR(payout_date) = '" . $cap_year . "' AND MONTH(payout_date) = '" . $cap_month . "'
                  ORDER BY created_date DESC";
    }
