                                        ...
                                        <div class="row filter-options">
                                            <div class="designation-filter no-space col-md-2 col-sm-12">
                                                ...
                                                <select id="designation" class="selectdesign filter-opt-1 fw-bolder">
                                                    ...
                                                    <option value="travel_agent">Travel Consultant</option>
                                                </select>
                                            </div>
                                                                ...
                                                                foreach( ($stmt -> fetchALL()) as $key => $row ){
                                                                    ...
                                                                    echo '<tr>
                                                                            ...
                                                                            <td class="text-end">'.$totalAmtBm.'
                                                                                <a href="forms/recruitment_payout/download_cu_payout.php?vkvbvjfgfikix='.$row['id'].'&bm='.$row['business_mentor'].'&te='.$row['techno_enterprise'].'&tc='.$row['travel_consultant'].'&cu='.$row['customer'].'&date='.$dt.'&message='.$message2.'&message_status='.$row['status_bm'].'&commission='.$row['commision_bm'].'">
                                                                    ...
                                                                    echo '<tr>
                                                                            ...
                                                                            <td class="text-end">'.$totalAmtTe.'
                                                                                <a href="forms/recruitment_payout/download_cu_payout.php?vkvbvjfgfikix='.$row['id'].'&bm='.$row['business_mentor'].'&te='.$row['techno_enterprise'].'&tc='.$row['travel_consultant'].'&date='.$dt.'&message='.$message2.'&message_status='.$row['status_te'].'&commission='.$row['commision_te'].'">
                                                                                    <i class="bx bx-download" style="font-size: 18px; color: black; padding-left: 5px;"></i>
                                                                                </a>
                                                                            </td>';
                                                                            if($row['status_te'] == '1'){
                                ...
                                <div class="row filter-options filter">
                                    <div class="designation-filter no-space1 col-lg-5 col-md-5 col-sm-12">
                                        ...
                                        <select id="designationPrevious" class="selectdesign filter-opt-1 fw-bolder">
                                            ...
                                            <option value='business_mentor'>Business Consultant</option>
                        ...
                        <div class="row d-flex justify-content-evenly">   
                            <div class="col-lg-4 col-md-4 col-sm-7 card" style="border: 2px solid black; border-radius: 10px;">
                                <div class="page-title-box p-3">
                                    ...
                                    <div class="d-flex">
                                        <?php 
                                            $nextPayout = $conn -> prepare("SELECT SUM(commision_bm + commision_te) as nextPayout FROM ca_ta_payout WHERE YEAR(created_date) = '".$nextDateYear."' AND MONTH(created_date) = '".$nextDateMonth."' ");
                                            $nextPayout -> execute();
                                            $nextPayout -> setFetchMode(PDO::FETCH_ASSOC);
                                            if($nextPayout -> rowCount()>0){
                                                foreach(($nextPayout -> fetchAll()) as $key => $row2){
