...
<body data-sidebar="dark">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-6 col-6  border-4 border-end border-end-dashed">
                                            <div class="page-title-box p-3">
                                                ...
                                                <a href="forms/customer_recruitment_payout/download_exel_cu.php?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout">
                                        ...
                                        <div class="col-lg-6 col-sm-6 col-6 ">
                                            <div class="page-title-box p-3">
                                                ...
                                                <a href="forms/customer_recruitment_payout/download_exel_cu.php?payoutYear=<?php echo $nextDateYear; ?>&payoutMonth=<?php echo $nextDateMonth; ?>&payoutmessage=NextPayout">
                                                    <i class="bx bx-download download-icon1" style="font-size: 20px; color: black; margin-left: 20%;"></i>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 card border-2 border-dark rounded-4">
                                    <div class="col-sm-12">
                                        <div class="page-title-box container p-3">
                                            ...
                                            <?php
                                            $totalPayout = "SELECT SUM(total_payable) as total_payable FROM ca_cu_payout_paid";
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive table-desi" id="filterTablePrev">
                                    ...
                                    <table class="table table-hover w-100" id="previous_payout_table">
                                        ...
                                        <tbody>
                                            <?php
                                            $stmt2 = "SELECT * FROM ca_cu_payout WHERE YEAR(created_date) = '" . $prevDateYear . "' AND MONTH(created_date) = '" . $prevDateMonth . "' ";
                                                ...
                                                foreach ($stmt2->fetchAll() as $key2 => $row) {
                                                    ...
                                                    if (!$row['travel_consultant'] == "") {
                                                        ...
                                                        if ($row['status_tc'] == '1') {
                                                            ...
                                                            echo '<td><span class="badge badge-pill badge-soft-warning font-size-10 fw-bold ms-4" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" onclick=\'paymentId("' . $row["id"] . '","' . $row["techno_enterprise"] . '","' . $row["message_tc"] . '","' . $CommAmtTc . '","' . $row["status_tc"] . '","messageTC")\'>Pending</span></td>';
                                                        }
                                                        echo '</tr>';
                                                    }
                                                }
    ...
    <!-- custom js  -->
    <script src="payout_customer_recruitment.js"></script>
