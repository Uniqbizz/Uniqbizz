...
<html lang="en">
    ...
    <body data-sidebar="dark">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-sm-6 col-6  border-4 border-end border-end-dashed">
                                                <div class="page-title-box p-3">
                                                    ...
                                                    <a href="forms/customer_reference/download_exel_cu?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout">
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-6 ">
                                                <div class="page-title-box p-3">
                                                    ...
                                                    <a href="forms/customer_reference/download_exel_cu?payoutYear=<?php echo $nextDateYear; ?>&payoutMonth=<?php echo $nextDateMonth; ?>&payoutmessage=NextPayout">
                                                        <i class="bx bx-download download-icon1" style="font-size: 20px; color: black; margin-left: 20%;"></i>
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12"> 
                                            ...
                                            <div class="table-responsive table-desi" id="filterTable">
                                                ...
                                                <table class="table table-hover" id="payoutDetailsTable">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                            $sql = "SELECT id, customer_id as userId, referral_message as message1,booking_message as message2, referral_amount as comm_amt1,booking_points as comm_amt2, created_date, status FROM `customer_reference_payout`
                                                            ...
                                                            if( $stmt -> rowCount()>0 ){
                                                                foreach( ($stmt -> fetchALL()) as $key => $row ){
                                                                    ...
                                                                    echo '<tr>
                                                                            ...
                                                                            if($row['status'] != '3'){
                                                                                echo '<a href="forms/customer_reference/download_cu_payout.php?vkvbvjfgfikix='.$row['id'].'&userId='.$row['userId'].'&date='.$dt.'&message='.$message1.'&message_status='.$row['status'].'&commission='.$row['comm_amt1'].'">
                                                                            ...
                                                                            if($row['status'] == '1'){
                                                                                ...
                                                                                echo'<td><span class="badge badge-pill badge-soft-warning font-size-10 fw-bold ms-4" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" onclick=\'paymentId("' .$row['id']. '","'.$row['userId'].'","'.$message1.'","'.$row['comm_amt1'].'","'.$row['status'].'")\'>Pending</span></td>';
                                                                            }
                                                                    echo'</tr>';
                        ...
                        <div class="row d-flex justify-content-evenly">   
                            <div class="col-lg-4 col-md-4 col-sm-7 card" style="border: 2px solid black; border-radius: 10px;">
                                <div class="page-title-box p-3">
                                    ...
                                    <div class="d-flex">
                                        <!-- <?php 
                                            $previousPayout = $conn -> prepare("SELECT SUM(referral_amount) as previousPayout FROM customer_reference_payout WHERE YEAR(created_date) = '".$prevDateYear."' AND MONTH(created_date) = '".$prevDateMonth."' ");
                                        ...
                                        <table class="table table-hover" id="previous_payout_table">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                    ...
                                                    $sql = "SELECT id, customer_id as userId, referral_message as message1,booking_message as msssage2, referral_amount as comm_amt1,booking_points as comm_amt2, created_date, status FROM `customer_reference_payout` WHERE YEAR(created_date) = '".$prevDateYear."' AND MONTH(created_date) = '".$prevDateMonth."'
                                                            order by created_date desc ";
                                                    $stmt = $conn -> prepare($sql);
                                                    $stmt -> execute();
                                                    $stmt -> setFetchMode(PDO::FETCH_ASSOC);
                                                        ...
                                                        foreach( ($stmt -> fetchALL()) as $key => $row ){
                                                            ...
                                                            echo '<tr>
                                                                    ...
                                                                    if ($row['status'] !='3') {
                                                                        ...
                                                                        echo'
                                                                            <a href="forms/customer_reference_payout/download_cr_payout.php?vkvbvjfgfikix='.$row['id'].'&userId='.$row['userId'].'&date='.$dt.'&message='.$message1.'&message_status='.$row['status'].'&commission='.$CommAmt.'">
                                                                                <i class="bx bx-download" style="font-size: 18px; color: black; padding-left: 5px;"></i>
                                                                            </a>
                                                                    </td>';
                                                                    }
                        ...
                        <div class="row d-flex justify-content-evenly">   
                            <div class="col-lg-4 col-md-4 col-sm-7 card" style="border: 2px solid black; border-radius: 10px;">
                                <div class="page-title-box p-3">
                                    ...
                                    <div class="d-flex">
                                        <!-- <?php 
                                            $nextPayout = $conn -> prepare("SELECT SUM(referral_amount) as nextPayout FROM customer_reference_payout WHERE YEAR(created_date) = '".$nextDateYear."' AND MONTH(created_date) = '".$nextDateMonth."' ");
                                            $nextPayout -> execute();
                                        ...
                                        ?>
                                        <a href="forms/customer_reference/download_cu_payout?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout">
                                            <i class="bx bx-download download-icon status1" style="font-size: 20px; color: black; margin-left: 20%;"></i>
                                        </a>
                                    </div>
                                        ...
                                        <table class="table table-hover" id="next_payout_table">
                                           ...
                                           <tbody>
                                                ...
                                                <?php
                                                    ...
                                                    $sql = "SELECT id, customer_id as userId, referral_message as message1,booking_message as message2, referral_amount as comm_amt1,booking_points as comm_amt2, created_date, status FROM `customer_reference_payout` WHERE YEAR(created_date) = '".$nextDateYear."' AND MONTH(created_date) = '".$nextDateMonth."'
                                                            order by created_date desc ";
                                                    $stmt = $conn -> prepare($sql);
                                                    $stmt -> execute();
                                                    $stmt -> setFetchMode(PDO::FETCH_ASSOC);
        ...
        <!-- custom js  -->
        <script src="payout_customer_reference.js"></script>
