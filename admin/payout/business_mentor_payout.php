...
<html lang="en">
    ...
    <body data-sidebar="dark">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 col-sm-6 col-6  border-4 border-end border-end-dashed">
                                                <div class="page-title-box p-3">
                                                    ...
                                                    <a href="forms/business_mentor_payout/download_exel_ca?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout">
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-6 ">
                                                <div class="page-title-box p-3">
                                                    ...
                                                    <a href="forms/business_mentor_payout/download_exel_ca?payoutYear=<?php echo $nextDateYear; ?>&payoutMonth=<?php echo $nextDateMonth; ?>&payoutmessage=NextPayout">
                                                        <i class="bx bx-download download-icon1" style="font-size: 20px; color: black; margin-left: 20%;"></i>
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-4 card border-2 border-dark rounded-4">
                                        <div class="col-sm-12">
                                            <div class="page-title-box container p-3">
                                                ...
                                                <?php 
                                                    $totalPayout = "SELECT SUM(comm_amt) as total_payable FROM ca_payout WHERE status = '1' ";
                                ...
                                <div class="col-md-12"> 
                                    ...
                                    <div class="table-responsive table-desi" id="filterTablePrev">
                                        ...
                                        <table class="table table-hover" id="previous_payout_table">
                                            ...
                                            <tbody>
                                                <?php
                                                    $sql2 = "SELECT * FROM ca_payout WHERE YEAR(created_date) = '".$prevDateYear."' AND MONTH(created_date) = '".$prevDateMonth."' ";
                                                        ...
                                                        foreach( ($stmt -> fetchALL()) as $key => $row ){
                                                            ...
                                                            echo '<tr>
                                                                    ...
                                                                    if($row['status'] == '1'){
                                                                        ...
                                                                        echo'<td><span class="badge badge-pill badge-soft-warning font-size-10 fw-bold ms-4" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" onclick=\'paymentId("' .$row['id']. '","'.$row['business_consultant'].'","'.$row['message'].'","'.$row['comm_amt'].'","'.$row['status'].'","PrevPayout")\'>Pending</span></td>';
                                                                    }
                                                            echo'</tr>';
                                ...
                                <div class="col-md-12"> 
                                    ...
                                    <div class="table-responsive table-desi" id="filterTableNext">
                                        ...
                                        <table class="table table-hover" id="next_payout_table">
                                           ...
                                           <tbody>
                                                <?php
                                                    $sql3 = "SELECT * FROM ca_payout WHERE YEAR(created_date) = '".$nextDateYear."' AND MONTH(created_date) = '".$nextDateMonth."' ";
                                                        ...
                                                        foreach( ($stmt -> fetchALL()) as $key => $row ){
                                                            ...
                                                            echo '<tr>
                                                                    ...
                                                                    if($row['status'] == '1'){
                                                                        ...
                                                                        echo'<td><span class="badge badge-pill badge-soft-warning font-size-10 fw-bold ms-4" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" onclick=\'paymentId("' .$row['id']. '","'.$row['business_consultant'].'","'.$row['message'].'","'.$row['comm_amt'].'","'.$row['status'].'","NextPayout")\'>Pending</span></td>';
                                                                    }
                                                            echo'</tr>';
                                ...
                                <div class="col-md-12"> 
                                    ...
                                    <div class="table-responsive table-desi" id="filteredTotalTable">
                                        ...
                                        <table class="table table-hover" id="previous_payout_table">
                                            ...
                                            <tbody>
                                                <?php
                                                    $sql4 = "SELECT * FROM ca_payout WHERE status = '1' ";
                                                        ...
                                                        foreach( ($stmt -> fetchALL()) as $key => $row ){
                                                            ...
                                                            echo '<tr>
                                                                    ...
                                                                    if($row['status'] == '1'){
                                                                        ...
                                                                        echo'<td><span class="badge badge-pill badge-soft-warning font-size-10 fw-bold ms-4" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" onclick=\'paymentId("' .$row['id']. '","'.$row['business_consultant'].'","'.$row['message'].'","'.$row['comm_amt'].'","'.$row['status'].'","TotalPayout")\'>Pending</span></td>';
                                                                    }
                                                            echo'</tr>';
        ...
        <!-- custom js  -->
        <script src="payout_business_mentor.js"></script>
    </body>
</html>