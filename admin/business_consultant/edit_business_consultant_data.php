...
if($editfor == 'pending'){
	...
	$identifier_name = 'id=';
	$message="Updated Business Consultant details from ".$editfor. " list";
	$message2="Updated Business Consultant details from ".$editfor. " list";
