...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Visa View | Admin Dashboard </title>
    ...
    <body data-sidebar="dark">
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-right dropdown-menu-right-2">
                                                                    ...
                                                                    <li><a href="#" onclick=\'editfuncVisa("'.$row["ca_travelagency_id"]. '","' .$row["reference_no"]. '","' .$row["register_by"]. '","' .$row["country"]. '","' .$row["state"]. '","' .$row["city"]. '","registered")\' class="dropdown-item" data-bs-toggle="modal" ><i class="mdi mdi-pencil font-size-16 text-primary me-1"></i> Edit</a></li>
        ...
        <!-- Add button icon -->
        <div class="btn" data-bs-toggle="modal" data-bs-target="#newVisaModal" style="width: 25px; height: 25px; padding: 0px; position: fixed; bottom: 120px; right: 43px; border-radius: 50%;">
        ...
        <!-- Modal -->
        <div class="modal fade" id="newVisaModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content">
                    <div class="modal-body px-4 py-5 text-center">
                        ...
                        <p class="text-muted font-size-16 mb-4">Are you Sure You want to Add Visa?</p>
                        
                        <div class="hstack gap-2 justify-content-center mb-0">
                            <button type="button" class="btn btn-success" id="add-item"><a href="add_visa.php"><span style="color: white;">Add Now</span></a></button>
        ...
        <script>
            ...
            function editfuncVisa(id,refno,regby,cut,st,ct,editfor){ 
                window.location.href='edit_visa.php?vkvbvjfgfikix='+id+'&nohbref='+refno+'&fyfyfregby='+regby+'&ncy='+cut+'&mst='+st+'&hct='+ct+'&editfor='+editfor;
            };
