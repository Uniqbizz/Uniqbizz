<div class="card rounded-4">
    <div class="card-body">
        ...
        <?php } else if ($DBtable == 'institution') {  ?>
            <form>
                <div class="row">
                    <!-- Personal Details -->
                    <div class="col-sm-6">
                        <div class="input-block mb-3">
                            <label class="col-form-label">Full Name: <span class="ms-2"><?php echo $firstname; ?></span></label>
                            <!-- <input class="form-control" type="text" id="fullName" value="<?php echo $name; ?>" readonly> -->
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="input-block mb-3">
                            <label class="col-form-label">Incorporation Date: <span class="ms-2"><?php echo $incorporation_date; ?></span></label>
                            <!-- <input class="form-control" type="date" id="birth_date" value="<?php echo $date_of_birth; ?>" readonly> -->
                        </div>
                    </div>
                    <div class="col-sm-6 " style="display: flex; justify-content: space-between; ">
                        <div class="input-block mb-3 col-sm-9">
                            <label class="col-form-label">Contact Number: <span class="ms-2"><?='+'. $ins_phone ?></span></label>
                        </div>

                    </div>
                    <div class="col-sm-6">
                        <div class="input-block mb-3">
                            <label class="col-form-label">Email: <span class="ms-2"><?php echo $ins_email; ?></span></label>
                            
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label class="col-form-label">Type of Institution:
                                <span class="ms-2">
                                    <?= ucfirst(strtolower($ins_type)); ?>
                                </span>
                            </label>
                        </div>
                    </div>
                    ...
                    <!-- <div class="row"> -->
                        <!-- Employment Details -->
                        <!-- <h4 class="my-2">Registered Office Address</h4> -->
                        <div class="col-sm-6">
                            <div class="input-block mb-3">
                                <label class="col-form-label">Contry: <span class="ms-2"><?php echo $countryname; ?></span></label>
                                
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-block mb-3">
                                <label class="col-form-label">State: <span class="ms-2"><?= $statename?></span></label>
                                
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-block mb-3">
                                <label class="col-form-label">City: <span class="ms-2"><?= $cityname ?></span></label>
                        ...
                        <div class="col-md-6">
                            <div class="input-block mb-3">
                                <label class="col-form-label">Pincode: <span class="ms-2"><?= $pincode ?></span></label>
                                
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-block mb-3">
                                <label class="col-form-label">Branch and Bank Name: <span class="ms-2"><?= $ins_bank_and_branch_name?></span></label>
                                
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="input-block mb-3">
                                <label class="col-form-label">Address: <span class="ms-2"><?php echo $ins_address; ?></span></label>
                        ...
                        <div class="col-sm-6">
                            <div class="input-block mt-1">
                                <label class="col-form-label">
                                    ...
                                    <a href="<?php echo '../../uploading/' . $ins_incop; ?>" download class="ms-3" title="Download">
                                            <i class="fa fa-download fa-1x" aria-hidden="true"></i>
                                    </a>
                                </label>
                            </div>
                            <input type="hidden" id="img_path1" value="<?php echo $ins_incop; ?>">
                            <div id="preview1">
                                <div id="image_preview1">
                                    <?php
                                    if ($ins_incop == '') {
                                        ...
                                        echo '<img src="../../uploading/' . $ins_incop . '" alt="Preview" id="img_pre1" class="imgSize">';
                                    }
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="input-block mt-1">
                                <label class="col-form-label">
                                    GSTIN
                                    <a href="<?php echo '../../uploading/' . $ins_gstin; ?>" download class="ms-3" title="Download">
                                            <i class="fa fa-download fa-1x" aria-hidden="true"></i>
                                    </a>
                                </label>
                            </div>
                            <input type="hidden" id="img_path2" value="<?php echo $ins_gstin; ?>">
                            <div id="preview2">
                                <div id="image_preview2">
                                    <?php
                                    if ($ins_gstin == '') {
                                        ...
                                        echo '<img src="../../uploading/' . $ins_gstin . '" alt="Preview" id="img_pre2" class="imgSize">';
                                    }
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="input-block mt-3">
                                <label class="col-form-label">
                                    Board Resolution
                                    <a href="<?php echo '../../uploading/' . $ins_board_resolution; ?>" download class="ms-3" title="Download">
                                            <i class="fa fa-download fa-1x" aria-hidden="true"></i>
                                    </a>
                                </label>
                            </div>
                            <input type="hidden" id="img_path3" value="<?php echo $ins_board_resolution; ?>">
                            <div id="preview3">
                                <div id="image_preview3">
                                    <?php
                                    if ($ins_board_resolution == '') {
                                        echo '<img src="../../uploading/not_uploaded.png" alt="Preview" id="img_pre3" class="imgSize">';
                                    } else {
                                        echo '<img src="../../uploading/' . $ins_board_resolution . '" alt="Preview" id="img_pre3" class="imgSize">';
                                    }
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="input-block mt-1">
                                <label class="col-form-label">
                                    Bank Passbook
                                    <a href="<?php echo '../../uploading/' . $ins_bank_passbook; ?>" download class="ms-3" title="Download">
                                            <i class="fa fa-download fa-1x" aria-hidden="true"></i>
                                    </a>
                                </label>
                            </div>
                            <input type="hidden" id="img_path1" value="<?php echo $ins_bank_passbook; ?>">
                            <div id="preview1">
                                <div id="image_preview1">
                                    <?php
                                    if ($ins_bank_passbook == '') {
                                        echo '<img src="../../uploading/not_uploaded.png" alt="Preview" id="img_pre1" class="imgSize">';
                                    } else {
                                        echo '<img src="../../uploading/' . $ins_bank_passbook . '" alt="Preview" id="img_pre1" class="imgSize">';
                                    }
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="input-block mt-1">
                                <label class="col-form-label">
                                    PAN Card
                                    <a href="<?php echo '../../uploading/' . $ins_pan_card; ?>" download class="ms-3" title="Download">
                                            <i class="fa fa-download fa-1x" aria-hidden="true"></i>
                                    </a>
                                </label>
                            </div>
                            <input type="hidden" id="img_path2" value="<?php echo $ins_pan_card; ?>">
                            <div id="preview2">
                                <div id="image_preview2">
                                    <?php
                                    if ($ins_pan_card == '') {
                                        ...
                                        echo '<img src="../../uploading/' . $ins_pan_card . '" alt="Preview" id="img_pre2" class="imgSize">';
                                    }
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="input-block mt-3">
                                <label class="col-form-label">
                                    Address Proof
                                    <a href="<?php echo '../../uploading/' . $ins_address_proof; ?>" download class="ms-3" title="Download">
                                            <i class="fa fa-download fa-1x" aria-hidden="true"></i>
                                    </a>
                                </label>
                            </div>
                            <input type="hidden" id="img_path3" value="<?php echo $ins_address_proof; ?>">
                            <div id="preview3">
                                <div id="image_preview3">
                                    <?php
                                    if ($ins_address_proof == '') {
                                        echo '<img src="../../uploading/not_uploaded.png" alt="Preview" id="img_pre3" class="imgSize">';
                                    } else {
                                        echo '<img src="../../uploading/' . $ins_address_proof . '" alt="Preview" id="img_pre3" class="imgSize">';
                                    }
                                    ?>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="input-block mt-3">
                                <label class="col-form-label">
                                    Payment Proof
                                    <a href="<?php echo '../../uploading/' . $ins_payment_proof; ?>" download class="ms-3" title="Download">
                                            <i class="fa fa-download fa-1x" aria-hidden="true"></i>
                                    </a>
                                </label>
                            </div>
                            <input type="hidden" id="img_path3" value="<?php echo $ins_payment_proof; ?>">
                            <div id="preview3">
                                <div id="image_preview3">
                                    <?php
                                    if ($ins_payment_proof == '') {
                                        echo '<img src="../../uploading/not_uploaded.png" alt="Preview" id="img_pre3" class="imgSize">';
                                    } else {
                                        echo '<img src="../../uploading/' . $ins_payment_proof . '" alt="Preview" id="img_pre3" class="imgSize">';
                                    }
                                    ?>
                                </div>
                            </div>
        ...
        <?php } else { ?>
            <form>
                ...
                <div class="row mt-3">
                    ...
                    <?php if (!in_array($user_type, ['34', '35', '36'])) { ?>
                    <div class="col-md-6 col-sm-12 ">
                        <div class="mb-0">
                            <label for="file2">
                                <b>AADHAR CARD</b>
