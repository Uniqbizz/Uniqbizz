...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Branch Manager Add | Admin Dashboard </title>
    ...
    <body data-sidebar="dark">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                        ...
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-floating mb-3">
                                                                <select id="user_id_name" class="form-select">
                                                                    ...
                                                                    <?php
                                                                        $sql = "SELECT * FROM `regional_manager` WHERE status ='1' ORDER BY regional_manager_id ASC ";
                                                    ...
                                                    <input type="hidden" id="testValue" name="testValue" value="6"> <!-- Franchisee Manager -->
                                                                    
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="addFranchiseeManager">Submit</button>
                                                    </div>
        ...
        <script>
            ...
            $('#user_id_name').on('change', function(){
                ...
                var designation = 'regional_manager';
                // console.log(designation);
