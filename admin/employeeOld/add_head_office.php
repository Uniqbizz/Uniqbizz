...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Head Office Add | Admin Dashboard </title>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="addHeadOffice">Submit</button>
                                                    </div>
