...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Regional Manager Add | Admin Dashboard </title>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Add Regional Manager Form</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-8">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <div class="form">
                                                        ...
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-floating mb-3">
                                                                <select id="user_id_name" class="form-select">
                                                                    <option value="">--Select Zonal Manager Name First--</option> 
                                                                    <?php
                                                                        $sql = "SELECT * FROM `zonal_manager` WHERE status ='1' ORDER BY zonal_manager_id ASC ";
                                                                        $stmt = $conn -> prepare($sql);
                                                                        $stmt -> execute();
                                                                        $stmt->setFetchMode(PDO::FETCH_ASSOC);
                                                                        if($stmt -> rowCount()>0){
                                                                            foreach (($stmt->fetchAll()) as $key => $row) {
                                                                                echo '<option value="'.$row['zonal_manager_id'].'">'.$row['zonal_manager_id'].' ('.$row['firstname'].' '.$row['lastname'].')</option>';
                                                                            }
                                                                        }
                                                                    ?>
                                                                </select>
                                                    ...
                                                    <input type="hidden" id="testValue" name="testValue" value="7"> <!-- Regional Manager -->
                                                                    
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="addReginalManager">Submit</button>
                                                    </div>
