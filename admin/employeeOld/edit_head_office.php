...
if($editfor == 'pending'){
    ...
    // $identifier_id= $_POST["vkvbvjfgfikix"];
    $identifier_name = 'head_office_id=';
}
    ...
    foreach (($stmt->fetchAll()) as $key => $row) {
        ...
        $head_office_id=$row['head_office_id'];
...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Head Office Edit | Admin Dashboard </title>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                    ...
                                                    <!-- for edit data page -->
                                                    <input type="hidden" id="testValue" name="testValue" value="12"> <!-- Head Office -->
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="editHeadOffice">Submit</button>
                                                    </div>
