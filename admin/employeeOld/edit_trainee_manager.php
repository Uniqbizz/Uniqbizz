...
$reference_no = $_GET['vkvbvjfgfikix'];
$country = $_GET['ncy'];
$state = $_GET['mst'];
$city = $_GET['hct'];
...
if($editfor == 'pending'){
    ...
    // $identifier_id= $_POST["vkvbvjfgfikix"];
    $identifier_name = 'trainee_manager_id=';
}
    ...
    foreach (($stmt->fetchAll()) as $key => $row) {
        ...
        $trainee_manager_id=$row['trainee_manager_id'];
...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Trainee Manager Edit | Admin Dashboard </title>
                                            ...
                                            <div class="col-sm-4">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Edit Trainee Manager Form</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-8">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                    ...
                                                    <!-- for edit data page -->
                                                     <input type="hidden" id="testValue" name="testValue" value="13"> <!-- Trainee Manager -->
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="editTraineeManager">Submit</button>
                                                    </div>
