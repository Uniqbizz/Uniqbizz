...
$sql9= $conn->prepare("SELECT * from zonal_manager where id='".$id."' and status='2'");
$sql9->execute();
...
$sql1 = "UPDATE zonal_manager SET status=:status,zonal_manager_id=:zonal_manager_id WHERE id=:id";
