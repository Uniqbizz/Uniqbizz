...
$sql9= $conn->prepare("SELECT * from trainee_manager where id='".$id."' and status='2'");
$sql9->execute();
...
//log file
$title="Confirm Trainee Manager";
$message=$uid." has been approved";
$message2=$uid." has been approved";
$fromWhom="1";


$sql1 = "UPDATE trainee_manager SET status=:status,trainee_manager_id=:trainee_manager_id WHERE id=:id";
