...
<body data-sidebar="dark">
                                                    ...
                                                    if (!empty($ta_list)) {
                                                        ...
                                                        $sql = "
                                                                SELECT b.id,
                                                                    ...
                                                                    FROM bookings b
                                                                JOIN package p ON b.package_id = p.id
                                                                WHERE b.ta_id IN ($ta_ids_str) AND b.status='2'"; // Use IN clause to match multiple IDs
                                                    }
                                                    ...
                                                    if (!empty($ta_list)) {
                                                        ...
                                                        $sql = "
                                                                SELECT b.id,
                                                                    ...
                                                                    FROM bookings b
                                                                JOIN package p ON b.package_id = p.id
                                                                WHERE b.ta_id IN ($ta_ids_str) AND b.status='3'"; // Use IN clause to match multiple IDs
                                                    }
    ...
    <script>
        ...
        function reloadTable(selectedDate) {
            ...
            $.ajax({
                url: "fetch_bookings.php", // Create a PHP script to fetch filtered data
                type: "POST",
                data: {
                    date: selectedDate
                },
