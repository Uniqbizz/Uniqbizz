                ...
                <table class="table table-hover" id="user_table2">
                    ...
                    <tbody>
                        ...
                        $sql = "
                                    ...
                                    FROM bookings b
                                    JOIN package p ON b.package_id = p.id
                                    WHERE b.ta_id IN ($ta_ids_str) AND b.date between $start_date_formatted AND $end_date_formatted AND b.status != '2' AND b.status != '3'
                                    ";
                    ...
                    <tbody>
                        ...
                        if (!empty($ta_list)) {
                            ...
                            $sql = "
                                            ...
                                            FROM bookings b
                                            JOIN package p ON b.package_id = p.id
                                            WHERE b.ta_id IN ($ta_ids_str) AND b.date between $start_date_formatted AND $end_date_formatted AND b.status='1'"; // Use IN clause to match multiple IDs
                        }
