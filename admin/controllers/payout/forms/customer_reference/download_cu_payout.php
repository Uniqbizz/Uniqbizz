...
//reference payout is only for customers
if($user_id == "CU"){
    ...
    <body>
        <div class="background" >
            <div class="container cont-btn d-flex justify-content-around pt-3 pb-4">
                <a href="../../../../views/payout/customer_referance_payout.php" class="go-back"> Go Back</a>
                    ...
                    <div class="col-md-12 col-sm-12 col-12 ps-3 pe-3" style=" ">
                        <div class="row">
                                ...
                                <tbody>
                                    <tr class="row">
                                        ...
                                        <td class="col-md-5 col-sm-5 pt-3">
                                            ...
                                            <h6 style="padding:2px 0; font-weight: 700;">Designation : Customer</h6>
                            ...
                            <div class="col-md-12 col-sm-12" >
                                <h5  style="padding: 10px 5px;  margin:0px; font-weight: 700; ">Customer Reference Payout</h5>
