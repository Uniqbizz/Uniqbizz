            ...
            if ($id) {
                ...
                echo '<tr>
                            ...
                            <td class="text-end">' . $total . '
                                <a href="../../../../controllers/payout/forms/customer_recruitment_payout/download_cu_payout.php?vkvbvjfgfikix=' . $row['id'] . '&bm=' . $row['business_mentor'] . '&te=' . $row['techno_enterprise'] . '&tc=' . $row['travel_consultant'] . '&cu=' . $row['customer'] . '&date=' . $dt . '&message=' . $message . '&message_status=' . $status . '&commission=' . $amount . '&user_desig='.$user_desig.'">
            ...
            if (!$row['business_mentor'] == "") {
                ...
                echo '<tr>
                                    ...
                                    <td class="text-end">' . $totalAmtBc . '
                                        <a href="../../../../controllers/payout/forms/customer_recruitment_payout/download_cu_payout.php?vkvbvjfgfikix=' . $row['id'] . '&bm=' . $row['business_mentor'] . '&te=' . $row['techno_enterprise'] . '&tc=' . $row['travel_consultant'] . '&cu=' . $row['customer'] . '&date=' . $dt . '&message=' . $message1 . '&message_status=' . $row['status_bm'] . '&commission=' . $row['commision_bm'] . '&user_desig='.$user_desig.'">
                                            <i class="bx bx-download" style="font-size: 18px; color: black; padding-left: 5px;"></i>
                                        </a>
                                    </td>';
                if ($row['status_bm'] == '1') {
            ...
            if (!$row['techno_enterprise'] == "") {
                ...
                echo '<tr>
                                    ...
                                    <td class="text-end">' . $totalAmtCa . '
                                        <a href="../../../../controllers/payout/forms/customer_recruitment_payout/download_cu_payout.php?vkvbvjfgfikix=' . $row['id'] . '&bm=' . $row['business_mentor'] . '&te=' . $row['techno_enterprise'] . '&tc=' . $row['travel_consultant'] . '&cu=' . $row['customer'] . '&date=' . $dt . '&message=' . $message2 . '&message_status=' . $row['status_te'] . '&commission=' . $row['commision_te'] . '&user_desig='.$user_desig.'">
                                            <i class="bx bx-download" style="font-size: 18px; color: black; padding-left: 5px;"></i>
                                        </a>
                                    </td>';
                if ($row['status_te'] == '1') {
            ...
            if (!$row['travel_consultant'] == "") {
                ...
                echo '<tr>
                                    ...
                                    <td class="text-end">' . $totalAmtTc . '
                                        <a href="../../../../controllers/payout/forms/customer_recruitment_payout/download_cu_payout.php?vkvbvjfgfikix=' . $row['id'] . '&bm=' . $row['business_mentor'] . '&te=' . $row['techno_enterprise'] . '&tc=' . $row['travel_consultant'] . '&cu=' . $row['customer'] . '&date=' . $dt . '&message=' . $message3 . '&message_status=' . $row['status_tc'] . '&commission=' . $row['commision_tc'] . '&user_desig='.$user_desig.'">
                                            <i class="bx bx-download" style="font-size: 18px; color: black; padding-left: 5px;"></i>
                                        </a>
                                    </td>';
                if ($row['status_te'] == '1') {
