                ...
                if($user_id == "BM"){
                    ...
                    if($sql1->rowCount()>0){
                        foreach (($sql1->fetchAll()) as $key => $row1) {
                            ...
                            $designation_bm='Business Mentor';
                        }
                    } 
                }else if($user_id == "BH"){
                    ...
                    if($sql1->rowCount()>0){
                        foreach (($sql1->fetchAll()) as $key => $row1) {
                            $bm_name = $row1['name'];
                            $designation_bm='Business Development Manager';
                        }
                    } 
                } else if($user_id == "MF"){
                    ...
                    if($sql1->rowCount()>0){
                        foreach (($sql1->fetchAll()) as $key => $row1) {
                            $bm_name = $row1['firstname']. ' ' .$row1['lastname'];
                            $designation_bm='Master Franchisee';
                        }
                    } 
                }else if($user_id == "SF"){
                    ...
                    if($sql1->rowCount()>0){
                        foreach (($sql1->fetchAll()) as $key => $row1) {
                            $bm_name = $row1['firstname']. ' ' .$row1['lastname'];
                            $designation_bm='Sponsor Franchisee';
                        }
                    } 
                }
                ...
                if($TE_id_str == 'TE' || $TE_id_str == 'CA'){
                    ...
                    if($sql2->rowCount()>0){
                        foreach (($sql2->fetchAll()) as $key => $row3) {
                            ...
                            $designation_te='Techno Enterprise';
                        }
                    } 
                }else if($TE_id_str == 'F'){
