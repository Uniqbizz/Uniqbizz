                                ...
                                <tbody>
                                    <tr class="row">
                                        <td class="col-md-7 col-sm-7 left pt-3">
                                            <h6 style="padding:2px 10px; font-weight: 700;">Name : <?= $user_desig=='BM' || $user_desig=='BDM' || $user_desig=='MF' || $user_desig=='SF'?$bm_name:($user_desig=='TE' || $user_desig=='F'?$te_name:($user_desig == 'TC'? $tc_name :'NA'))?></h6>
                                        ...
                                        <td class="col-md-5 col-sm-5 pt-3">
                                            ...
                                            <h6 style="padding:2px 0; font-weight: 700;">Designation : <?= $user_desig=='BM' || $user_desig=='BDM' || $user_desig=='MF' || $user_desig=='SF'?$bmdesignation:($user_desig=='TE' || $user_desig=='F'?$tedesignation:($user_desig == 'TC'?$tcdesignation :'NA'))?></h6>
