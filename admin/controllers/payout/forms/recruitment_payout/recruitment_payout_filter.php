            ...
            foreach ($stmt->fetchAll() as $row) {
                ...
                echo '<tr>
                        ...
                        <td class="text-end">'.$total.'
                            <a href="../../../../controllers/payout/forms/recruitment_payout/download_cu_payout.php?vkvbvjfgfikix='.$row['id'].'&bm='.$row['business_mentor'].'&te='.$row['techno_enterprise'].'&tc='.$row['travel_consultant'].'&date='.$dt.'&message='.$message.'&message_status='.$status.'&commission='.$amount.'">
