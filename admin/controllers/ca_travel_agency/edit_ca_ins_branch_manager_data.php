<?php
	...
	if($editfor == 'pending'){
		...
		$identifier_name = 'id=';
		$message="Updated Institution Branch Manager details from ".$editfor. " list";
		$message2="Updated Institution Branch Manager details from ".$editfor. " list";
	...
	$usertype=$user_type=$user_type_id = '33';
	...
	if($firstname !='' ||$lastname !='' ||$phone !='' ||$email !='' ||$gender !='' ||$dob !='' ||$address !='' ||$profile_pic !=''){
		...
		$sql1 = "UPDATE institution_branch_manager SET 
			firstname=:firstname,
			lastname=:lastname,
