<?php
    ...
    if ($editfor == 'pending') {
        ...
        $identifier_column = 'business_mentor_id';
    ...
    $stmt = $conn->prepare("SELECT * FROM business_mentor WHERE $identifier_column = :id");
    ...
    $sql = "UPDATE business_mentor SET 
