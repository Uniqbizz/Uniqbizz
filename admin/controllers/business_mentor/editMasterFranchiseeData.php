<?php
    ...
    if ($editfor == 'pending') {
        ...
        $message = "Updated Master Franchisee details from pending list";
    } else {
        $identifier_column = 'master_franchisee_id';
    ...
    $stmt = $conn->prepare("SELECT * FROM master_franchisee WHERE $identifier_column = :id");
    ...
    /* -------------------------
    UPDATE MASTER FRANCHISEE
    ------------------------- */

    $sql = "UPDATE master_franchisee SET
