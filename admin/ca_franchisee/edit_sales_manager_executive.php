...
<?php
        ...
        if($editfor == 'pending'){
            ...
            // $identifier_id= $_POST["vkvbvjfgfikix"];
            $identifier_name = 'sales_executive_id=';
        }
        ...
        if($stmt->rowCount()>0){
            foreach (($stmt->fetchAll()) as $key => $row) {
                ...
                // training_manager ref name
                $training_managers = $conn->prepare("SELECT firstname, lastname, reference_no FROM training_manager where training_manager_id='".$reference_no."'");
                $training_managers ->execute();
                $training_managers ->setFetchMode(PDO::FETCH_ASSOC);
                if(  $training_managers->rowCount()>0 ){
                    $training_manager = $training_managers->fetch();
                    $reference_no_fname = $training_manager['firstname'];
                    $reference_no_lname = $training_manager['lastname'];
...
<head>
        ...
        <meta charset="utf-8" />
        <title>Sales Manager / Executive Edit | Admin Dashboard </title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Edit Sales Manager / Executive</h4>
                                            ...
                                            <div class="col-md-6 col-sm-4">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Edit Sales Manager / Executive Form</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-8">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                    ...
                                                    <!-- for edit data page -->
                                                     <input type="hidden" id="testValue" name="testValue" value="22"> <!-- Sales Executive -->
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="editSalesManagerExecutive">Submit</button>
                                                    </div>
