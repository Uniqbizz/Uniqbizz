...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Training Manager Add | Admin Dashboard </title>
    ...
    <body data-sidebar="dark">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Add Training Manager Form</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-8">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                        ...
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-floating mb-3">
                                                                <select id="user_id_name" class="form-select">
                                                                    <option value="">--Select ID and Name First--</option> 
                                                                    <?php 
                                                                        $sql = "SELECT * FROM business_operation_executive WHERE status = '1' ORDER BY business_operation_executive_id ASC";
                                                                        $stmt = $conn -> prepare($sql);
                                                                        $stmt -> execute();
                                                                        $stmt -> setFetchMode(PDO::FETCH_ASSOC);
                                                                        if( $stmt -> rowCount() > 0 ){
                                                                            foreach( ($stmt -> fetchAll()) as $key => $row){
                                                                                echo'<option value="'.$row['business_operation_executive_id'].'">'.$row['business_operation_executive_id'].' '.$row['firstname'].' '.$row['lastname'].'</option> ';
                                                                            }
                                                                        }
                                                                    ?>
                                                                </select>
                                                    ...
                                                    <div class="row py-3">
                                                        <div class="col-md-12 col-sm-12 d-none" id="chequeOpt" style="display:flex; justify-content: space-evenly;">
                                                            <div class="col-md-3 ">
                                                    ...
                                                    <!-- <div class="row">
                                                        <div class="col-md-12 col-sm-12 mt-3">
                                                            <p style="font-weight:800; font-size:16px;">New Franchisee will pay 10,00,000/-</p>
                                                        </div>
                                                    </div>                 -->
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="addTrainingManager">Submit</button>
                                                    </div>
        ...
        <script>
            ...
            $('#user_id_name').on('change', function(){
                ...
                var designation = 'business_operation_executive';
