...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Sales Manager / Executive Add | Admin Dashboard </title>
    ...
    <body data-sidebar="dark">
                                            ...
                                            <div class="col-md-6 col-sm-4">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Add Sales Manager / Executive Form</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-8">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                        ...
                                                        <div class="col-md-6 col-sm-12">
                                                            <div class="form-floating mb-3">
                                                                <select id="user_id_name" class="form-select">
                                                                    ...
                                                                    <?php 
                                                                        $sql = "SELECT * FROM training_manager WHERE status = '1' ORDER BY training_manager_id ASC";
                                                                        $stmt = $conn -> prepare($sql);
                                                                        $stmt -> execute();
                                                                        $stmt -> setFetchMode(PDO::FETCH_ASSOC);
                                                                        if( $stmt -> rowCount() > 0 ){
                                                                            foreach( ($stmt -> fetchAll()) as $key => $row){
                                                                                echo'<option value="'.$row['training_manager_id'].'">'.$row['training_manager_id'].' '.$row['firstname'].' '.$row['lastname'].'</option> ';
                                                                            }
                                                                        }
                                                                    ?>
                                                                </select>
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="addSalesManagerExecutive">Submit</button>
                                                    </div>
        ...
        <script>
            ...
            $('#user_id_name').on('change', function(){
                ...
                var designation = 'training_manager';
