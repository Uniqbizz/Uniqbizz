...
if($editfor == 'pending'){
	...
	$identifier_name = 'id=';
	$message="Updated CA Franchisee details from ".$editfor. " list";
	$message2="Updated CA Franchisee details from ".$editfor. " list";
