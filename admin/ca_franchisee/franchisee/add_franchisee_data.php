<?php
    ...
    $title="CA Franchisee";
    $message="Added new CA Franchisee by Admin";
    $message2="Added new CA Franchisee by Admin";
    $fromWhom="1";

    $sql= "INSERT INTO `ca_franchisee` ( firstname, lastname, nominee_name, nominee_relation, email, country_code, contact_no , date_of_birth, age, gender, country, state, city, pincode, address, profile_pic, gst_no, amount, amtGST, pan_card, aadhar_card, voting_card, bank_passbook, payment_proof, user_type,  payment_mode, cheque_no, cheque_date, bank_name, transaction_no, register_by, status) VALUES (:firstname ,:lastname, :nominee_name, :nominee_relation, :email, :country_code, :contact_no, :bdate, :age, :gender , :country, :state, :city, :pincode,:address,:profile_pic, :gst_no, :amount, :amtGST, :pan_card,:aadhar_card,:voting_card,:bank_passbook, :payment_proof, :user_type, :payment_mode, :cheque_no, :cheque_date, :bank_name, :transaction_no, :register_by, :status)";
    ...
    if ($result) {
		...
		$sql4= "INSERT INTO logs (title,message,message2, register_by, from_whom) VALUES (:title ,:message, :message2, :register_by, :from_whom)";
