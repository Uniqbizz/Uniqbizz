...
$("#user_id_name").on('change', function () {
    ...
    if (selectedUserid && selectedUserid !== '--Select Designation First--' && selectedUserid !== '--Select User ID & Name First--') {
        ...
        if (designation === 'bdm' || designation === 'bcm') {
            $.ajax({
                url: "../../controllers/slab_payout/form/getbmdetails.php",
                type: "POST",
...
function getUsers(designation, month_year) {
    ...
    $.ajax({
        url: "../../controllers/slab_payout/form/getUser.php",
        type: "POST",
...
function getActiveCount(designation, month_year, user_id) {
    ...
    $.ajax({
        url: "../../controllers/slab_payout/form/getActiveUserCount.php",
        type: "POST",
...
function getUserTableDetails(designation, month_year, user_id, payout_type) {
    ...
    $.ajax({
        url: "../../controllers/slab_payout/form/getpayoutdetails.php",
        type: "POST",
...
$("#userTable tbody").on("click", ".view-payment", function () {
    ...
    if (rowData) {
        ...
        if (existingUser) {
            ...
            $.ajax({
                type: "POST",
                url: "../../controllers/slab_payout/form/get_user_details.php",
        ...
        $.ajax({
            type: "POST",
            url: "../../controllers/slab_payout/form/getpayoutdetail.php",
...
function makePayment(payType) {
    ...
    $.ajax({
        type: "POST",
        url: "../../controllers/slab_payout/form/make_payment.php",
        data: data,
        success: function (res) {
...
// $.ajax({
//     type:'POST',
//     url:'../../controllers/slab_payout/forms/get_users',
...
//         $.ajax({
//             type:'POST',
//             url:'../../controllers/slab_payout/forms/get_all_levels',
...
$("#generate_payout_button").on('click', function () {
    ...
    $.ajax({
        type: 'POST',
        url: '../../controllers/slab_payout/forms/generate_franchisee_payout',
        data: JSON.stringify(data),
        success: function (e) {
            // console.log(e);
            if (e == "success") {
...
function getCustomers_TA() {
    ...
    if (designation == "customer" || designation == "travel_agent") {
        ...
        $.ajax({
            type: 'POST',
            url: '../../controllers/slab_payout/forms/get_customer_chain',
            data: JSON.stringify(data),
            success: function (e) {
                // console.log(e);
        ...
        $.ajax({
            type: 'POST',
            url: '../../controllers/slab_payout/forms/get_customer_chain_total_payout',
            data: JSON.stringify(data),
            success: function (e) {
...
function showPayoutDetailsForm(id, level, table, clubPriceDistribution_booking_Id) {
    ...
    $.ajax({
        type: 'POST',
        url: '../../controllers/slab_payout/forms/get_club_payout_details',
        data: data,
        success: function (e) {
