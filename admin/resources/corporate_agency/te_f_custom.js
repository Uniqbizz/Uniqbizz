...
function editfuncCust(id,refno,regby,cut,st,ct,editfor,usertype){ 
    // alert('test');
   window.location.href='../../views/corporate_agency/view_corporate_agency.php';//?vkvbvjfgfikix='+id+'&nohbref='+refno+'&fyfyfregby='+regby+'&ncy='+cut+'&mst='+st+'&hct='+ct+'&editfor='+editfor+'&usertype='+usertype;
};
