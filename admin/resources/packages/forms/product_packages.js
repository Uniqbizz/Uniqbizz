...
$.ajax({
    url: '../../models/packages/forms/payout_data.php', // fixed file name
...
function getSubCategories() {
	...
	$.ajax({
		type: 'POST',
		url: '../../models/packages/forms/get_sub_categories.php',
		data: 'cat_id=' + cat_id,
		success: function (e) {
			// console.log(e);
...
$('#occupancy_id').on('change', function () {
	...
	if (ocup_id == '0') { } else {
		$.ajax({
			type: 'POST',
			url: '../../models/packages/forms/get_occupancy_categories.php',
...
$('#vehicle_id').on('change', function () {
	...
	if (vehicle_id == '0') { } else {
		$.ajax({
			type: 'POST',
			url: '../../models/packages/forms/get_vehicles_categories.php',
...
function submit_form_data(e) {
	...
	if (image_data == "") {
		...
		$.ajax({
			type: "POST",
			url: '../../models/packages/forms/create.php',
			data: data,
			headers: {
...
function update_form_data(e) {
	...
	$.ajax({
		type: "POST",
		url: '../../models/packages/forms/update.php',
		data: data,
		headers: {
			"Content-Type": "application/json",
			'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
...
function validateIdenticalRecord(type, elementID, errorMessage) {
	$.ajax({
		type: "POST",
		url: '../../models/packages/forms/validate_records.php',
