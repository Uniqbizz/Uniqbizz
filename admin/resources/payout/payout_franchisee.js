...
$('#designation').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url:  '../../controllers/payout/forms/sub_franchisee/sub_franchisee_payout_filter.php',
        data: 'designation='+designation,
        success:function(data){
            // console.log(data);
...
$('#user_id_namePrevious').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: '../../controllers/payout/forms/sub_franchisee/sub_franchisee_payout_filter_amt_user.php',
        data: dataString,
        cache: false,
        success: function(data){
            $('#prevDiv').html(data);
...
$('#month_year').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: '../../controllers/payout/forms/sub_franchisee/sub_franchisee_payout_month.php',
        data: dataString,
        cache: false,
        success: function(data){
            console.log(data);
...
function paymentId(id, userID,sub_franchisee, message, amt, status, user_desig){
    ...
    $('#submitPayment').click(function(e){
        ...
        if(paymentMessage.length>0){
            $.ajax({
                type: 'POST',
                url: '../../controllers/payout/forms/sub_franchisee/sub_franchisee_payout_paid.php',
                data: dataString,
                cache: false,
                success: function(data){
                    console.log(data);
...
function totalPayoutExel(){
    ...
    if(totalPayoutDate){
        ...
        //     }
        // });
        window.location.href='../../controllers/payout/forms/sub_franchisee/download_exel_ca.php?payoutYear='+payoutYear+'&payoutMonth='+payoutMonth+'&payoutmessage='+payoutmessage;
    }else{
...
function allPayoutExel(){
    ...
    window.location.href='../../controllers/payout/forms/sub_franchisee/download_exel_ca.php?payoutYear='+payoutYear+'&payoutMonth='+payoutMonth+'&payoutmessage='+payoutmessage+'&designation='+designation+'&user_id='+user_id;
}
