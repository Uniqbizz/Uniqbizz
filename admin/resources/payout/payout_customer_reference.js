...
// **** customer_reference_payout Javascript Start ****
...
$('#user_id_name').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: '../../controllers/payout/forms/customer_reference/customer_reference_payout_filter.php',
...
$('#user_id_namePrevious').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: '../../controllers/payout/forms/customer_reference/customer_reference_payout_filter_amt_user.php',
        data: dataString,
        cache: false,
        success: function(data){
            $('#prevDiv').html(data);
...
//display username for filter purpose for Total Payout
...
$('#month_year').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: '../../controllers/payout/forms/customer_reference/customer_reference_payout_month.php',
        data: dataString,
        cache: false,
        success: function(data){
            console.log(data);
...
function paymentId(id, userID, message, amt, status, identity){
    ...
    $('#submitPayment').click(function(e){
        ...
        dataString = {
            id, paymentMessage, amt, status, userID
        }
        // console.log(dataString);
        ...
        if(paymentMessage.length>0){
            $.ajax({
                type: 'POST',
                url: '../../controllers/payout/forms/customer_reference/customer_reference_payout_paid.php',
                data: dataString,
                cache: false,
                success: function(data){
                    console.log(data);
...
function totalPayoutExel(){
    ...
    if(totalPayoutDate){
        ...
        //     }
        // });
        window.location.href='../../controllers/payout/forms/customer_reference/download_exel_cu.php?payoutYear='+payoutYear+'&payoutMonth='+payoutMonth+'&payoutmessage='+payoutmessage;
    }else{
...
function allPayoutExel(){
    ...
    window.location.href='../../controllers/payout/forms/customer_reference/download_exel_cu.php?payoutYear='+payoutYear+'&payoutMonth='+payoutMonth+'&payoutmessage='+payoutmessage+'&designation='+designation+'&user_id='+user_id;
}

// **** customer_reference_payout Javascript End ****