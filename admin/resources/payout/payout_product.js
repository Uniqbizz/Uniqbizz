...
// **** product_payout Javascript Start ****
...
$('#user_id_name').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'forms/product_payout/product_payout_filter.php',
...
$('#user_id_namePrevious').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'forms/product_payout/product_payout_filter_amt_user.php',
        data: dataString,
        cache: false,
        success: function(data){
            $('#prevDiv').html(data);
...
$('#month_year').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'forms/product_payout/product_payout_month.php',
        data: dataString,
        cache: false,
        success: function(data){
            console.log(data);
...
function paymentId(id, userID, message, amt, status, col_update){
    ...
    //appending values from all this fields to model text feild
    ...
    $('#submitPayment').click(function(e){
        ...
        dataString = {
            id, userID, message, amt, status, col_update
        }
        // console.log(dataString);

        $.ajax({
            type: 'POST',
            url: 'forms/product_payout/product_payout_paid.php',
            data: dataString,
            cache: false,
            success: function(data){
                console.log(data);
...
// Total payout Download in Exel will be accessing same table product payout
function totalPayoutExel(){
    ...
    if(totalPayoutDate){
        ...
        //     }
        // });
        window.location.href='forms/product_payout/download_exel_product_payout.php?payoutYear='+payoutYear+'&payoutMonth='+payoutMonth+'&payoutmessage='+payoutmessage;
    }else{
...
function allPayoutExel(){
    ...
    window.location.href='forms/product_payout/download_exel_product_payout.php?payoutYear='+payoutYear+'&payoutMonth='+payoutMonth+'&payoutmessage='+payoutmessage+'&designation='+designation+'&user_id='+user_id;
}

// **** product_payout Javascript End ****