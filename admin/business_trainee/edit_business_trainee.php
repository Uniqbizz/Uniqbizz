...
<?php
        ...
        $stmt = $conn->prepare("SELECT * FROM `business_trainee` where business_trainee_id='".$id."' OR id = '".$id."'");
        $stmt->execute();
...
<head>
        ...
        <meta charset="utf-8" />
        <title>Business Trainee Edit | Admin Dashboard </title>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="editBusinessTrainee">Submit</button>
                                                    </div>
