...
<?php
        ...
        $stmt = $conn->prepare("SELECT * FROM `channel_business_director` where channel_business_director_id='".$id."' OR id = '".$id."'");
        $stmt->execute();
...
<head>
        ...
        <meta charset="utf-8" />
        <title>Channel Business Director Edit | Admin Dashboard </title>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4 class="head text-uppercase fw-bold">Edit Channel Business Director Form</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-8">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-12">
                                                <form>
                                                        ...
                                                        <div class="col-md-4 col-sm-12">
                                                            <div class="form-floating mb-3">
                                                                <select class="form-select" id="designation">
                                                                    ...
                                                                    <option value="travel_agent">Channel Business Director</option>
                                                    ...
                                                    <div>
                                                        <button type="submit" class="btn btn-primary w-md mt-3" id="editChannelBusinessDirector">Submit</button>
                                                    </div>
