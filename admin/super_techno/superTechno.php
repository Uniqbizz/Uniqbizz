...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Super Techno Enterprise | Admin Dashboard </title>
                                            ...
                                            <div class="col-sm-12">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Pending Super Techno Enterprise List</h4>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-6">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Registered Super Techno Enterprise List</h4>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- end col-->
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-sm-6">
                                                <div class="search-box me-2 mb-2 d-inline-block">
                                                    <div class="position-relative">
                                                        <h4>Deleted Super Techno Enterprise List</h4>
                                                    </div>
                                                </div>
                                            </div>
                                                                            ...
                                                                            <ul class="dropdown-menu dropdown-menu-right dropdown-menu-end-2">
                                                                                <li>
                                                                                    <a href="#" 
                                                                                        onclick=\'deletefunc(
                                                                                                                "' . $row["id"] . '",
                                                                                                                "' . $row["super_techno_enterprise_id"] . '",
