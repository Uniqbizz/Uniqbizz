...
if($stmt->rowCount()>0){
	foreach (($stmt->fetchAll()) as $key => $row) 
		...
		$stmt = $conn->prepare("SELECT * FROM customer where email='".$username."'  AND (status='1' || status='2')");
		...
		}else if($_SESSION["user_type_id_value"] =='31'){
			$stmt = $conn->prepare("SELECT * FROM employees where email='".$username."' AND user_type = '31' AND status='1' ");
			$stmt->execute();
			...
			$stmt = $conn->prepare("SELECT * FROM executive_techno_enterprise where email='".$username."' AND user_type = '33' AND status='1' ");
			$stmt->execute();
	...
	if ($_SESSION["user_type_id_value"] =='2' || $_SESSION["user_type_id_value"]== '3' 
		|| $_SESSION["user_type_id_value"]== '4' || $_SESSION["user_type_id_value"]== '5' 
		|| $_SESSION["user_type_id_value"]== '6' || $_SESSION["user_type_id_value"]== '7' 
		|| $_SESSION["user_type_id_value"]== '8' || $_SESSION["user_type_id_value"]== '9' 
		|| $_SESSION["user_type_id_value"]== '10' || $_SESSION["user_type_id_value"]== '11' 
		|| $_SESSION["user_type_id_value"]== '12' || $_SESSION["user_type_id_value"]== '13' 
		|| $_SESSION["user_type_id_value"]== '14' || $_SESSION["user_type_id_value"]== '15' 
		|| $_SESSION["user_type_id_value"]== '16' || $_SESSION["user_type_id_value"]== '17' 
		|| $_SESSION["user_type_id_value"]== '18' || $_SESSION["user_type_id_value"]== '19' 
