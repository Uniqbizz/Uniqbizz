...
require '../../../connect.php'; // must be PDO instance: $conn
...
try {
    ...
    if (!empty($fromDate) && !empty($toDate)) {
        $sql .= " AND DATE(register_date) BETWEEN :from_date AND :to_date";
    } elseif (!empty($fromDate)) {
        $sql .= " AND DATE(register_date) >= :from_date";
    } elseif (!empty($toDate)) {
        $sql .= " AND DATE(register_date) <= :to_date";
    }
