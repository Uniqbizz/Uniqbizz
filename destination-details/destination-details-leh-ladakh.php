                    ...
                    <div class="row g-4">
                            ...
                            <div class="swiper destinationSwiper-active" style="height: 500px !important;">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="../assets/images/destination/LehLadakh1.jpg" alt="Leh Ladakh" style="height: 550px !important; object-fit: cover;">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="../assets/images/destination/LehLadakh2.jpg" alt="Leh Ladakh" style="height: 550px !important; object-fit: cover;">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="../assets/images/destination/LehLadakh3.jpg" alt="Leh Ladakh" style="height: 550px !important; object-fit: cover;">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <div class="destination-details-content">
                                <h4 class="title">Leh Ladakh – A Journey to the Land of Timeless Tranquillity”</h4>
                                <p class="pera">
                                    Ladakh is a mountainous cold desert on the northern side of India, with Leh, its capital located 
                                    at an altitude of about 3,500 metres above sea level. Ladakh has breathtaking landscapes, ancient 
                                    Buddhist monasteries and adventurous mountain activities to offer tourists.
                                </p>
                                <p class="pera">
                                    Pangong Lake is a crystal-clear high altitude lake situated at an altitude of 4350meters above sea level. 
                                    The Pangong Tso Lake is one of the world’s hightest salt-water lake. It mesmerizes tourists as it changes 
                                    colors, shifting between shades of blue, green and red at different times of a day.
                                </p>
                                <p class="pera"> 
                                    The Nubra Valley also known, as the “valley of the flowers” is a region's of vast plains, sweeping valleys, 
                                    and striking dunes of Hunder. The rare species of the double-humped Bactrian Camelsare found in the Nubra 
                                    Valley. The patches of lush greenery make up, an Oasis in the desert, of the Nubra Valley a much sought-after 
                                    tourist destination.
                                </p>
                                <p class="pera">
                                    Leh Palace, a historical structure of Tibetian architecture built in the 17th Century by King Sengge 
                                    Namgyal, also attracts tourists.
                                </p>
                                <p class="pera">
                                   Magnetic Hill is a fascinating natural wonder near Leh, which defies the law of gravity as vehicles 
                                   can roll uphill without any assistance. Tourists around the world visit the place to witness this 
                                   incredible phenomenon.
                                </p>
                                <p class="pera">
                                    Hemis National Park is a high-altitude national Park is home to the rarest of species of leopards, 
                                    Tibetan Wolf, Eurasian Brown Bear, Red fox, Himalayan blue sheep (bharal), and a variety of high 
                                    altitude birds.
                                </p>
                                <p class="pera">
                                    Lamayuru Town, the Moonland of Ladakh, is a nature’s marvel. Its landscape strikingly resembles 
                                    the surface of the moon. The Lamayuru monastery in the region is one of the oldest. The interior 
                                    of the monastery features intricate paintings, ancient statues, prayer halls, and Buddha scriptures, 
                                    offering a glimpse into the rich heritage of Ladakh.
                                </p>
                                <p class="pera">
                                    The Losar festival of Ladakh is an event where family and friends come together wearing new clothes 
                                    celebrate with traditional rituals to mark a new beginning. Other festivals like the Hemis Tse Chu 
                                    festival, celebrated at Hemis Monastery by the monks, and the Yuru Kabgyat, which attracts the 
                                    Buddhist crowd from all over the world.
                                </p>
                                <p class="pera">
                                    Ladakhi cuisine is a rich blend of Tibetan, central Asian, and Indian influences. The staple foods 
                                    of Ladakh are Thukpa, momos, skyu, chutagi, Butter tea known as  (Gur Gur Chai),(salty tea made of butter 
                                    and Yak milk), Khambir, Chhurpi, and Apricot products like juices, jams, and dried fruits.
                                </p>
                                <p class="pera">
                                    The people of Ladakh are skilled artisans. They make lovely handwoven Pashmina shawls from the wool 
                                    of the Changthangi goats, intricate woodcarvings, and handwoven rugs. Perak is a traditional dress, 
                                    made of leather or cotton strap, studded meticulously with large turquoise stones. It is worn by 
                                    the married women of the region.The Women of Ladakh also adorn themselves with intricate jewellery 
                                    made of silver, coral and other precious stones. The Tipi is a hat worn by both men and women.
                                </p>
                                <p class="pera">
                                    A trip to Ladakh is like an immersion into a world of timeless tranquillity and natural majesty. 
                                    It gives tourists a chance to connect with the Himalayas and experience its spiritual culture.
                                </p>
                            </div>
                            <!--/ details-content -->
                                        ...
                                        <div class="info-table">
                                            <table class="table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>Language</th>
                                                        <td>Ladakhi. Hindi. Urdu. English.</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Currency</th>
                                                        <td>INR (Rupees)</td>
