                    ...
                    <div class="row g-4">
                            ...
                            <div class="swiper destinationSwiper-active" style="height: 500px !important;">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <img src="../assets/images/destination/Gujarat1.jpg" alt="Gujarat" style="height: 550px !important; object-fit: cover;">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="../assets/images/destination/Gujarat2.jpg" alt="Gujarat" style="height: 550px !important; object-fit: cover;">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="../assets/images/destination/Gujarat3.jpg" alt="Gujarat" style="height: 550px !important; object-fit: cover;">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            ...
                            <div class="destination-details-content">
                                <h4 class="title">Explore the vibrant culture and heritage of Gujarat.</h4>
                                <p class="pera">
                                    GUJARAT is the fifth largest state in western India, often recognised as the Green Capital of the world 
                                    due to its advancement in the agricultural sector using modern techniques in cultivation. Its rich history 
                                    spans from the Ancient, Medieval, and Modern Ages, which symbolise its progress and integrity.
                                </p>
                                <p class="pera">
                                    Rich in culture and heritage, Gujarat highlights world UNESCO heritage sites, religious places, like the 
                                    holy temples of Somnath and Dwarka. The Gir National Park, which has the Asian lions, the great white desert, 
                                    Rann of Kutch, and various museums.
                                </p>
                                <p class="pera">
                                    The statue of Unity, honouring, one of India’s Great leaders of Independence, Sardar Vallabhai Patel is 
                                    located on a river Island known as “Sadhu’s Bet”. 
                                </p>
                                <p class="pera">
                                    Gujarat is also the birthplace of Mahatma Gandhi, a leader of India’s non-violent movement, who rose to be 
                                    a leading personality in India’s struggle to gain independence against the British rule. 
                                </p>
                                <p class="pera">
                                    The Rann of Kutch an enchanting destination of the state is a vast white desert of the region. This desert 
                                    comes alive during the Rann Utsav Festival that celebrates the region's rich local art, music, and 
                                    cultural traditions. 
                                </p>
                                <p class="pera">
                                    The city of Surat in Gujarat, known, as the Diamond capital of India, is a famous Diamond trading hub. 
                                    The city boasts of the Surat Diamond Bourse, which surpasses the Pentagon in the United States to become 
                                    the world’s largest office building by floor area.  
                                </p>
                                <p class="pera">
                                    Gujarat Navratri festival, dedicated to the goddess Durga is a nine-night-long celebration. People from 
                                    different walks-of- life come together to dance the traditional Garba and Dandya Raas dance. The streets 
                                    are, filled with music, colour, and lights, creating a festive atmosphere of pomp and gaiety. Another 
                                    famous festival is the International Kite Festival (Uttarayan), where people engage in Kite flying 
                                    competitions.  
                                </p>
                                <p class="pera">
                                    Gujarat is rich in intricate and beautiful handicraft items such as, the Patola silk sarees made from 
                                    an intricate double-ikat weaving technique. It is also famous for its popular crafts like Bandhani 
                                    tie-dye, Kutch embroidery, and wooden toys. 
                                </p>
                                <p class="pera">
                                    Gujarati cuisine has its own unique flavour. Some of the popular dishes are the Dokla, a savoury 
                                    steamed cake made from fermented batter, and Undhiyu, a mixed vegetable dish cooked in a clay pot. 
                                </p>
                                <p class="pera">
                                    The state has an influence of a variety of people from different religions and communities. 
                                    It has numerous Jain temples and pilgrimage sites. The Parses and the Zoroastrian community have made 
                                    a significant contribution to Gujarat’s culture and economy 
                                </p>
                                <p class="pera">
                                    Gujarat plays a vital role in India’s economic growth, as it propels India’s economic growth with its 
                                    huge investment opportunities in various sectors like manufacturing, agriculture, textiles, and diamond 
                                    processing.  Its rich cultural diversity, historical grandeur, and natural wonders make it a unique 
                                        ...
                                        <div class="info-table">
                                            <table class="table">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>Language</th>
                                                        <td>Gujarati. Hindi. Sindhi. English</td>
                                                    </tr>
                                                    <tr>
                                                        <th>Currency</th>
                                                        <td> INR (Rupees)</td>
