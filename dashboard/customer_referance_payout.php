                                                                    ...
                                                                    <div class="m-0 mt-2 p-2 ms-n2">
                                                                        ...
                                                                        <?php 
                                                                            ...
                                                                            if ($totalPayout > 0) {
                                                                                ...
                                                                                echo '<p class="fs-5 fw-bolder mt-n2">Rs. ' . round($netPayout) . '/- <span class="badge bg-success fw-bold ms-4">Paid</span> </p>';
                                                                            }else{
                                                                                echo '<p class="fs-5 fw-bolder mt-n2">Rs. 0/- <span class="badge bg-success fw-bold ms-4">Paid</span> </p>';
                                                                            }
                                                                        ?>
                                                                    ...
                                                                    <div class="m-0 mt-2 p-2">
                                                                        ...
                                                                        <?php 
                                                                            ...
                                                                            if ($totalPayout > 0) {
                                                                                ...
                                                                                $netPayout = $totalPayout - $tds;
                                                                                echo '<p class="fs-5 fw-bolder mt-n2">Rs. ' . round($netPayout) . '/- <span class="badge bg-warning fw-bold ms-4">Paid</span> </p>';
                                                                            }else{
                                                                                echo '<p class="fs-5 fw-bolder mt-n2">Rs. 0/- <span class="badge bg-warning fw-bold ms-4">Paid</span> </p>';
                                                                            }
                                                                        ?>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 card border-2 border-dark rounded-4">
                                                            <div class="col-sm-12">
                                                                <div class="m-0 mt-2 p-2 ms-n2">
                                                                    ...
                                                                    <?php 
                                                                         $query = "
                                                                            SELECT SUM(referral_amount) as payout FROM customer_reference_payout WHERE customer_id='".$userId."' AND status = :status
                                                                        ";
                                                                                ...
                                                                                if( $stmt -> rowCount()>0 ){
                                                                                    foreach( ($stmt -> fetchALL()) as $key => $row ){
                                                                                        ...
                                                                                        echo '<tr>
                                                                                                ...
                                                                                                if($row['status'] != '3'){
                                                                                                    echo '<a href="payout/forms/customer_reference/download_cu_payout.php?vkvbvjfgfikix='.$row['id'].'&userId='.$row['userId'].'&date='.$dt.'&message='.$message1.'&message_status='.$row['status'].'&commission='.$row['comm_amt1'].'">
                                    ...
                                    <div class="d-flex">
                                         ...
                                         <?php
                                            ...
                                            if ($totalPayout > 0) {
                                                ...
                                                echo'<p class="fs-5 font fw-bolder mt-n2 icon">Rs.' .number_format($truncatedAmount,2). '/- </p><span class="badge bg-success fw-bold status1 paystatus" style="height: 15px !important; margin-top: 16px;" readonly>Paid</span>';
                                            }else{
                                                echo'<p class="fs-5 font fw-bolder mt-n2 icon">Rs.0/- </p><span class="badge bg-success fw-bold status1 paystatus" style="height: 15px !important; margin-top: 16px;" readonly>Paid</span>';
                                            }
                                        ?>
                                        <a href="payout/forms/customer_reference/download_exel_cu?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout">
                                ...
                                <div class="row filter-options filter">
                                    ...
                                    <span id="prevDiv" class="col-md-10 card border-2 border-black" style="border-radius: 10px; padding: 10px">
                                        <div  id="download_icon " >
                                            ...
                                            <p class="fs-5 fw-bolder mt-n2 icon">Rs. <?php echo number_format($truncatedAmount,2); ?>/- </p>
                                            <!-- <a href="">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive table-desi" id="filterTablePrev">
                                        ...
                                        <table class="table table-hover" id="previous_payout_table">
                                            ...
                                            <tbody>
                                                <?php
                                                    $sql = "SELECT id, customer_id as userId, referral_message as message1,booking_message as msssage2, referral_amount as comm_amt1,booking_points as comm_amt2, created_date, status FROM `customer_reference_payout` WHERE customer_id='".$userId."' AND YEAR(created_date) = '".$prevDateYear."' AND MONTH(created_date) = '".$prevDateMonth."' 
                                                            order by created_date desc ";
                                                    $stmt = $conn -> prepare($sql);
                                                    $stmt -> execute();
                                                    $stmt -> setFetchMode(PDO::FETCH_ASSOC);
                                                        ...
                                                        foreach( ($stmt -> fetchALL()) as $key => $row ){
                                                            ...
                                                            echo '<tr>
                                                                    ...
                                                                    if ($row['status'] !='3') {
                                                                        ...
                                                                        echo'
                                                                            <a href="payout/forms/customer_reference_payout/download_cr_payout.php?vkvbvjfgfikix='.$row['id'].'&userId='.$row['userId'].'&date='.$dt.'&message='.$message1.'&message_status='.$row['status'].'&commission='.$CommAmt.'">
                                                                                <i class="bx bx-download" style="font-size: 18px; color: black; padding-left: 5px;"></i>
                                                                            </a>
                                                                    </td>';
                                                                    }
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-7 card" style="border: 2px solid black; border-radius: 10px;">
                                <div class="mt-3">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        ?>
                                        <a href="payout/forms/customer_reference/download_cu_payout?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout">
                                            <i class="bx bx-download download-icon status1" style="font-size: 20px; color: black; margin-left: 20%;"></i>
                                        </a>
                                        ...
                                        <table class="table table-hover" id="next_payout_table">
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $sql = "SELECT id, customer_id as userId, referral_message as message1,booking_message as message2, referral_amount as comm_amt1,booking_points as comm_amt2, created_date, status FROM `customer_reference_payout` WHERE customer_id='".$userId."' AND YEAR(created_date) = '".$nextDateYear."' AND MONTH(created_date) = '".$nextDateMonth."'
                                                            order by created_date desc ";
                                                    $stmt = $conn -> prepare($sql);
                                                    $stmt -> execute();
                                                    $stmt -> setFetchMode(PDO::FETCH_ASSOC);
                                                    if( $stmt -> rowCount()>0 ){
                                                        foreach( ($stmt -> fetchALL()) as $key => $row ){
                                                            ...
                                                            echo '<tr>
                                                                    ...
                                                                    if ($row['status'] != '3') {
                                                                        echo'
                                                                            <a href="payout/forms/customer_reference/download_cu_payout.php?vkvbvjfgfikix='.$row['id'].'&userId='.$row['userId'].'&date='.$dt.'&message='.$message1.'&message_status='.$row['status'].'&commission='.$CommAmt.'">
                                                                                <i class="bx bx-download" style="font-size: 18px; color: black; padding-left: 5px;"></i>
                                                                            </a>
                                                                    </td>';
                                                                    }
                                    ...
                                    <div class="d-flex">
                                        <?php
                                            ...
                                            if ($totalPayout > 0) {
                                                ...
                                                $truncatedAmount = truncateToTwoDecimals($netTotalPayout);
                                    ...
                                    <div class="table-responsive table-desi" id="filteredTotalTable">
                                        ...
                                        <table class="table table-hover" id="total_payout_table">
                                            <thead>
                                                <tr>
                                                    <th class="ceterText fw-bolder sub-title">Date</th>
                                                    <th class="ceterText fw-bolder sub-title">Payout Message</th>
                                                    <th class="ceterText fw-bolder sub-title">Payout Details</th>
                                                    <th class="ceterText fw-bolder sub-title">Amount</th>
                                                    <th class="ceterText fw-bolder sub-title">TDS</th>
                                                    <th class="ceterText fw-bolder sub-title">Total Payable</th>
                                            ...
                                            <tbody>
                                                <?php
                                                    ...
                                                    $sql = "SELECT id, customer_id as userId, referral_message as message1,booking_message as message2, referral_amount as comm_amt1,booking_points as comm_amt2, created_date, status FROM `customer_reference_payout` WHERE customer_id='".$userId."' AND status = '1'
                                                            order by created_date desc ";
                                                    $stmt = $conn -> prepare($sql);
                                                    $stmt -> execute();
                                                    $stmt -> setFetchMode(PDO::FETCH_ASSOC);
