    ...
    <div id="scrollbar" >
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav" >
                ...
                <li class="nav-item <?php echo ($current_page == 'travel_consultant_dashboard.php') ? 'active' : ''; ?>">
                    <a class="nav-link menu-link" href="travel_consultant_dashboard.php">
                        <i class="fa-regular fa-house d-flex"></i><span>Dashboards</span>
                    </a>
                </li>
                <li class="nav-item <?php echo ($current_page == '../../tour-list.php') ? 'active' : ''; ?>">
                    <a class="nav-link menu-link" href="../../tour-list.php">
                        <i class="ri-user-shared-2-line"></i> <span>Explore Packages</span>
                    </a>
                </li>
