    ...
    <body>
                                ...
                                <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb-3">
                                    <div class="document-card">
                                        ...
                                        <label for="file4" class="upload-area">
                                            <span class="document-status verified" data-document="cancelled_cheque_passbook">Verified</span>
        ...
        <script>
            ...
            $(document).ready(function () {
                //title card
                $.ajax({
                    url: 'ajax/profile/title_card.php',
                    type: 'GET',
                    dataType: 'json',
                    data: {
                        user_id: '<?= $userId ?>'
                ...
                //status card
                $.ajax({
                    url: 'ajax/profile/sub_title_card.php',
                    type: 'GET',
                    dataType: 'json',
                    data: {
                        user_id: '<?= $userId ?>'
            ...
            function loadPersonalInfo(userId) {
                ...
                $.ajax({
                    url: 'ajax/profile/personal_info_card.php',
                    type: 'GET',
                    dataType: 'json',
                    data: {
                        user_id: userId
            ...
            function loadResidentialInfo(userId){
                $.ajax({
                    url: 'ajax/profile/residential_address.php',
                    type: 'GET',
                    dataType: 'json',
                    data: {
                        user_id: userId
            ...
            //     $.ajax({
            //         url: 'ajax/profile/professional_details.php',
            //         type: 'GET',
            //         dataType: 'json',
            //         data: {
            //             user_id: userId
            ...
            //     $.ajax({
            //         url: 'ajax/profile/nominee_details.php',
            //         type: 'GET',
            //         dataType: 'json',
            //         data: {
            //             user_id: userId
            ...
            //     $.ajax({
            //         url: 'ajax/profile/bank_info_card.php',
            //         type: 'GET',
            //         dataType: 'json',
            //         data: {
            //             user_id: userId
            ...
            function loadDocuments(userId){
                ...
                $.ajax({
                    url: 'ajax/profile/document_details.php',
                    type: 'GET',
                    dataType: 'json',
                    data: {
                        user_id: userId
