<?php
    ...
    $stmt = $conn->prepare("SELECT * FROM `sales_executive` WHERE sales_executive_id='".$id."' OR id = '".$id."' ");
    $stmt->execute();
...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Dashboard | Sales Manager / Executive</title>
                            ...
                            <div class="col-lg-12">
                                <div class="col-12"> <!-- Page title -->
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">Edit Sales Manager / Executive</h4>
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                <li class="breadcrumb-item">
                                                    <a href="view_travel_agent.php">View Sales Manager / Executive</a>
                                                </li>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="text-start">
                                                            <button type="submit" class="btn btn-primary" id="edit-sales-manager-executive">Submit</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
