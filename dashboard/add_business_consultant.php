                            ...
                            <div class="col-lg-12">
                                <div class="col-12"> <!-- Page title -->
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">Add Business Consultant</h4>
                                        ...
                                        <div class="h-100">
                                            <form>
                                                <div class="row g-3">
                                                    ...
                                                    <input type="hidden" id="testValue" name="testValue" value="3"> <!-- business Consultant-->
                                                    
                                                    <div class="col-lg-12">
                                                        <div class="text-start">
                                                            <button type="submit" class="btn btn-primary" id="add-business-consultant">Submit</button>
                                                        </div>
                                                    </div>
