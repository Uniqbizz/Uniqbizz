<?php
    ...
    $stmt = $conn->prepare("SELECT * FROM `business_consultant` WHERE business_consultant_id='".$id."' ");
    $stmt->execute();
    ...
    if($stmt->rowCount()>0){
        foreach (($stmt->fetchAll()) as $key => $row) {
            ...
            $city=$row['city'];
            $address=$row['address'];
            // $id_proof=$row['id_proof'];// $kyc=$row['kyc'];
                            ...
                            <div class="col-lg-12">
                                <div class="col-12"> <!-- Page title -->
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">Edit Business Consultant</h4>
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                <li class="breadcrumb-item">
                                                    <a href="view_business_consultant.php">View Business Consultant</a>
                                                </li>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="text-start">
                                                            <button type="submit" class="btn btn-primary" id="edit-business-consultant">Submit</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
