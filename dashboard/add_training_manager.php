...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Admin Dashboard | Training Manager</title>
                            ...
                            <div class="col-lg-12">
                                <div class="col-12"> <!-- Page title -->
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">Add Training Manager</h4>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-floating">
                                                            <?php
                                                                $stmt = $conn->prepare("SELECT * FROM business_operation_executive WHERE reference_no = '$userId' AND status = 1 ");
                                                                $stmt->execute();                                         
                                                                ...
                                                                <?php 
                                                                    if($stmt->rowCount()>0){
                                                                        foreach (($stmt->fetchAll()) as $key => $row) {  
                                                                            echo '
                                                                            <option value="'.$row['business_operation_executive_id'].'">'.$row['business_operation_executive_id'].' ('.$row['firstname'].' '.$row['lastname'].')</option>';
                                                                        } 
                                                                    }else{ 
                                                            ...
                                                            <label for="country">User Id & Name</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-floating">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="text-start">
                                                            <button type="submit" class="btn btn-primary" id="add-training-manager">Submit</button>
                                                        </div>
                                                    </div>
