            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <!-- end page title -->
                                            ...
                                            <div class="card">
                                                <div class="card-header border-bottom-dashed">
                                                    <div class="row g-4 align-items-center">
                                                        ...
                                                        <!-- <?php if($userType == "16" || $userType == "3"){ ?>
                                                            <div class="col-sm-auto">
                                                                <a href="add_travel_agent.php">
                                                                    <button type="button" class="btn btn-success " data-bs-toggle="modal" id="create-btn" data-bs-target="#showModal">
                                                                        <i class="ri-add-line align-bottom me-1"></i>Add Travel Consultant
                                                                    </button>
                                                                </a>
                                                            </div>
                                                        <?php } ?>     -->
                                                    ...
                                                    <table id="example-dataTable-2" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th data-ordering="false">Joining Date</th>
                                                                <th data-ordering="false">Status</th>
                                                                <?php  if($userType == '16' || $userType == '26'){ ?>
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                ...
                                                                //                     //             <li><a class="dropdown-item remove-item-btn" onclick=\'deletefunc("'.$userCATA["id"].'","'.$userCATA["ca_travelagency_id"].'","registered")\'><i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</a></li>
                                                                //                     //         </ul>
                                                                //                     //     </div>
                                                                //                     // </td>';
                                                                //                 }else{
                                                                ...
                                                                //     }
                                                                // }
                                                                else if($userType == "16" || $userType == "3" || $userType == "26"){
                                                                    ...
                                                                    if($stmt4 -> rowCount()>0){
                                                                        foreach(($stmt4 -> fetchAll()) as $key => $row){
                                                                            ...
                                                                            echo'<tr>
                                                                                ...
                                                                                if($userType == '16' || $userType == "3" || $userType == "26"){ 
                                                                                    if($row['status'] == '1'){
                                                                                        echo'<td>
                                                                                            <div class="dropdown d-inline-block">
                                                                                                <button class="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                                                                ...
                                                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                                                    ...
                                                                                                    <li><a class="dropdown-item remove-item-btn" onclick=\'deletefunc("'.$row["id"].'","'.$row["ca_travelagency_id"].'","'.$row["reference_no"].'","registered")\'><i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</a></li>
                                                                                                </ul>
                                                                                            </div>
                                                                                        </td>';
                                                                                    }else{
                                                                                        echo'<td>
                                                                                            <div class="dropdown d-inline-block">
                                                                                                ...
                                                                                                <ul class="dropdown-menu dropdown-menu-end">
                                                                                                    <li><a class="dropdown-item remove-item-btn" onclick=\'deletefunc("'.$row["id"].'","'.$row["ca_travelagency_id"].'","'.$row["reference_no"].'","deactivate")\'><i class="ri-arrow-go-back-fill align-bottom me-2 text-muted"></i> Restore</a></li>
                                                                                                </ul>
                                                                                            </div>
                                                                                        </td>';
                                                                                    }
                        ...
                        <?php if($userType == "16" || $userType == "3" || $userType == "26"){ ?>
...
<!--  -->
        ...
        <!-- <script src="assets/js/pages/chartjs.init.js"></script>// -->
         ...
         <script>
            ...
            function deletefunc(id,fid,refid,action){
                var dataString = 'id='+id+'&fid='+fid+'&refid='+refid+'&action='+action;

                $.ajax({
                    type: "POST",
                    url: "travel_agent/delete_travel_agent_data.php",
                    data: dataString,
                    cache: false,
