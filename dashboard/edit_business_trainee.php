<?php
    ...
    $stmt = $conn->prepare("SELECT * FROM `business_trainee` WHERE business_trainee_id='".$id."' ");
    $stmt->execute();
                            ...
                            <div class="col-lg-12">
                                <div class="col-12"> <!-- Page title -->
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">Edit Business Trainee</h4>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="text-start">
                                                            <button type="submit" class="btn btn-primary" id="edit-business-trainee">Submit</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
