        ...
        foreach (($stmt->fetchALL()) as $key => $row) {
            ...
            echo '<tr>
                            ...
                            <td class="text-end">' . $totalAmt . '
                                <a href="../controllers/payout/forms/slab_payout_bdm/download_ca_payout.php?vkvbvjfgfikix=' . $row['id'] . '&bc=' . $row['bdm_user_id'] . '&ca=' . urlencode(implode(', ', json_decode($row['bm_user_id'], true))) . '&date=' . $dt . '&message=' . $message1 . '&message_status=' . $row['payout_status'] . '&commission=' . $row['payout_amount'] . '&userType=' . $userType . '">
