...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    <head>
        <meta charset="utf-8" />
        <title>Business Development Manager Dashboard | Uniqbizz</title>
        ...
        <!-- Business Development Manager Dashboard CSS -->
                    ...
                    <div class="container-fluid ps-0">
                        ...
                        <div class="card border rounded-4 shadow-sm overflow-hidden">
                            ...
                            <div class="greetingCard">
                                ...
                                <h1 class="fw-bold text-dark gap-3">Business Development Manager</h1>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                <div class="card rounded-4 p-3 stCard6">
                                    <div class="d-flex gap-3">
                                        ...
                                        <div class="">
                                            <p class="mb-1 fs-6 fw-bold">BM | MF | SF</p>
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        */
                        ...
                        let fData = Array(12).fill(0);

                        $.each(res.data.f_trend, function(i, row) {

                            let monthIndex =
                                parseInt(row.month_no) - 1;

                            fData[monthIndex] =
                                parseInt(row.f_count) || 0;
                        ...
                        */
                        ...
                        enrollmentTrendChart.data.datasets[1].data = fData;
