...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    ...
    <body>
        ...
        <div id="layout-wrapper">
            ...
            <?php 
                include_once(__DIR__ . '/business_development_manager_header.php');
            ?>
            ...
            <?php 
                include_once(__DIR__ . '/business_development_manager_sidebar.php');
            ?>
            <!-- ============================================================== -->
            ...
            <div class="main-content">
                ...
                <?php 
                    include_once(__DIR__ . '/business_development_manager_footer.php');
                ?>
