    ...
    <div id="scrollbar" >
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav" >
                ...
                <li class="nav-item <?php echo ($current_page == 'business_development_manager_dashboard.php') ? 'active' : ''; ?>">
                    <a class="nav-link menu-link" href="business_development_manager_dashboard.php">
