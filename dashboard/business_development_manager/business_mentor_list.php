...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    <head>
        ...
        <meta charset="utf-8" />
        <title> Business Development Manager | Business Mentor List </title>
                                            ...
                                            <div class="card rounded-4 border-1">
                                                <div class="card-header border-bottom-dashed rounded-top-4 d-flex gap-3">
                                                    ...
                                                    <div class="align-content-end">
                                                        <h5 class="card-title text-dark mb-0">Pending Business Mentor List</h5>
                                                        <p class="text-muted fs-6 mb-0">Business Mentor pending for approval</p>
                                                    </div>
                                                </div>    
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-5 col-lg-12 col-md-12 col-sm-12 col-12 mb-2">
                                                            <div class="d-flex gap-3">
                                                                ...
                                                                <div class="align-content-end">
                                                                    <h5 class="card-title text-dark mb-0">Registered Business Mentor List</h5>
                                                                    <p class="text-muted fs-6 mb-0">All approved and active Business Mentors</p>
                                                                </div>
                                                            </div>
                                                        </div>
