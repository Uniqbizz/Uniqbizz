...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    <head>
        <meta charset="utf-8" />
        <title>Business Mentor Dashboard | Uniqbizz</title>
    ...
    <body class="twocolumn-panel">
        ...
        <div id="layout-wrapper">
            ...
            <!-- ============================================================== -->
            <!-- Start of Business Mentor Dashboard here -->
            <!-- ============================================================== -->
            <div class="main-content">
                <div class="page-content">
                    <div class="container-fluid ps-0">
                        <!-- Business Mentor Dashboard Greeting Card -->
                        <div class="card mb-0 border rounded-4 shadow-sm overflow-hidden">
                            ...
                            <div class="greetingCard">
                                ...
                                <h1 class="fw-bold text-dark gap-3">Business Mentor</h1>
