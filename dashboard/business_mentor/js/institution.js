...
function submitAddForm(actionType) {
    ...
    if(activation_plan == "FOC"){
        ...
        payment_proof = getFilePath("#img_path12");
    }
    ...
    // Attachments
    var certificate_of_incorporation   = getFilePath("#img_path14");
    var gstin   = getFilePath("#img_path15");
    var board_resolution      = getFilePath("#img_path16");
    ...
    if (actionType === 'submit') {
        ...
        if (activation_plan !== "FOC") {
            ...
            console.log("payment_proof:"+payment_proof);
