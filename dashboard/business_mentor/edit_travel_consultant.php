    ...
    <body>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="input-block mb-3">
                                        <label class="col-form-label" for="user_id_name">Reference User Id & Name<span class="text-danger">*</span></label>
        ...
        <script>
            ...
            async function loadTravelConsultant() {
                ...
                $('#user_id_name').val(data.reference_no);
                $('#reference_name').val(data.registrant);
