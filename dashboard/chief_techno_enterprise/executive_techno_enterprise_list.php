...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    <head>
        ...
        <meta charset="utf-8" />
        <title> Chief Techno Enterprise | Executive Techno Enterprise List</title>
    ...
    <body>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">View Executive Techno Enterprise</li>
                                        </ol>
                                    </div>
                                            ...
                                            <div class="card rounded-4 border-1">
                                                <div class="card-header border-bottom-dashed rounded-top-4 d-flex gap-3">
                                                    ...
                                                    <div class="align-content-end">
                                                        <h5 class="card-title text-dark mb-0">Pending Executive Techno Enterprise List</h5>
                                                        <p class="text-muted fs-6 mb-0">Executive Techno Enterprise pending for approval</p>
                                                    </div>
                                                </div>    
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-5 col-lg-12 col-md-12 col-sm-12 col-12 mb-2">
                                                            <div class="d-flex gap-3">
                                                                ...
                                                                <div class="align-content-end">
                                                                    <h5 class="card-title text-dark mb-0">Registered Executive Techno Enterprise List</h5>
                                                                    <p class="text-muted fs-6 mb-0">All approved and active Executive Techno Enterprises</p>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    <div class="btn" style="width: 25px; height: 25px; padding: 0px; position: fixed; bottom: 120px; right: 35px; border-radius: 50%;">
                        <a href="add_executive_techno_enterprise.php" style="display: flex; justify-content: center; align-items: center; height: -webkit-fill-available;">
        ...
        <script>
            const teTable = $('#example-dataTable').DataTable({
                ...
                language: {
                    emptyTable: "No Pending Executive Techno Enterprise Found"
                }
            });
            function loadPendingTEList(){

                $.ajax({
                    url: 'models/executive_techno_enterprise/ste_pending_te_table_data.php',
                    type: 'POST',
                    dataType: 'json',
            ...
            const teRegTable = $('#example-dataTable-2').DataTable({
                ...
                language: {
                    emptyTable: 'No Executive Techno Enterprise Found'
                }
            });
            ...
            function loadRegisteredTEList(){
                ...
                $.ajax({
                    ...
                    url: 'models/executive_techno_enterprise/ste_registered_te_list.php',
