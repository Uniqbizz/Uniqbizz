        ...
        if ($type == 'et') {
            ...
            $sql = "
                ...
                FROM (
                    ...
                    SELECT
                        ca.id AS row_id,
                        ca.executive_techno_enterprise_id AS id,
                        ...
                        ste.cheif_techno_enterprise_id AS reference_id,
                    ...
                    FROM executive_techno_enterprise ca

                    LEFT JOIN cheif_techno_enterprise ste
                        ON ca.reference_no = ste.cheif_techno_enterprise_id
            ...
            $fileName = 'Registered_Executive_Techno_Enterprise_List.xlsx';
        }
