<?php
    ...
    switch ($edittype) {
        ...
        case '34':
            ...
            $customField = 'executive_techno_enterprise_id';
            break;
    ...
    $response = [
        ...
        'data' => [
            ...
            'id' => $row['id'],
            'application_id' => $row['application_id'] ?? '',
            'executive_techno_enterprise_id' => $row['executive_techno_enterprise_id'] ?? '',
            ...
            'gst_no' => $row['gst_no'],
            'date_of_birth' => ($row['date_of_birth'] == '0000-00-00') ? '' : $row['date_of_birth'],
            'gender' => $row['gender'],
            'country' => $row['country'],
            ...
            'nominee_date_of_birth' =>($nominee_date_of_birth == '0000-00-00') ? '' :  $nominee_date_of_birth,
