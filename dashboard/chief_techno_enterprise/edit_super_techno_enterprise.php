                                            ...
                                            <div class="input-block mb-3">
                                                ...
                                                <?php //if ($status == 2) { ?>
                                                    <div class="verify-toggle">
                                                        ...
                                                        <input type="radio" name="verification_status[father_spouse_name]" id="father_spouse_name_peding" class="peding_reason" value="pending" <?php // isChecked($verificationPayload, 'father_spouse_name', 'rejected'); ?>>
