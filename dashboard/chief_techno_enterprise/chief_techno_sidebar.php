    ...
    <div id="scrollbar" >
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav" >
                ...
                <li class="nav-item <?php echo ($current_page == 'chief_techno_dashboard.php') ? 'active' : ''; ?>">
                    <a class="nav-link menu-link" href="chief_techno_dashboard.php">
                        <i class="fa-regular fa-house d-flex"></i><span>Dashboards</span>
                    </a>
                </li>
                <li class="nav-item <?php echo ($current_page == 'executive_techno_enterprise_list.php') ? 'active' : ''; ?>">
                    <a class="nav-link menu-link" href="executive_techno_enterprise_list.php">
                        <i class="ri-user-shared-2-line"></i> <span>Executive Techno Enterprisee</span>
                    </a>
                </li>
                <li class="nav-item <?php echo ($current_page == 'super_techno_enterprise_list.php') ? 'active' : ''; ?>">
                    <a class="nav-link menu-link" href="super_techno_enterprise_list.php">
                        <i class="ri-user-shared-2-line"></i> <span>Super Techno Enterprisee</span>
                    </a>
                </li>
