...
<?php
    ...
    $sql3 = "UPDATE ca_cu_payout SET status_cte = :message_status WHERE id = :id ";
    ...
    $sql2 = $conn->prepare("INSERT INTO ca_cu_payout_paid (business_consultant, corporate_agency, ca_travelagency, payout_message, payout_details, amount, tds, total_payable) VALUES (:business_consultant, :corporate_agency, :ca_travelagency, :payout_message, :payout_details, :amount, :tds, :total_payable) ");
