...
$bcNames = $conn -> prepare("SELECT * FROM chief_techno_enterprise WHERE chief_techno_enterprise_id = '".$bc."' AND status = 1");
$bcNames -> execute();
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="col-md-5 col-sm-5 pt-3">
                                            ...
                                            <h6 style="padding:2px 0; font-weight: 700;">Designation : Chief Techno Enterprise</h6>
