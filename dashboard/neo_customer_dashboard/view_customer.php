                                                                        ...
                                                                        if($row['status'] == '1'){
                                                                            echo'<td>
                                                                                <div class="dropdown d-inline-block">
                                                                                    ...
                                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                                        ...
                                                                                        <li><a class="dropdown-item remove-item-btn" onclick=\'deletefunc("'.$row["id"].'","'.$row["reference_no"].'","registered","'.$row["ca_customer_id"].'","'.$userType.'","'.$userId.'")\'><i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                            </td>';
                                                                        }else{
                                                                            echo'<td>
                                                                                <div class="dropdown d-inline-block">
                                                                                    ...
                                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                                        <li><a class="dropdown-item remove-item-btn" onclick=\'deletefunc("'.$row["id"].'","'.$row["reference_no"].'","deactivate","'.$row["ca_customer_id"].'","'.$userType.'","'.$userId.'")\'><i class="ri-arrow-go-back-fill align-bottom me-2 text-muted"></i> Restore</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                            </td>';
                                                                        }
