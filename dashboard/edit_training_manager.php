                            ...
                            <div class="col-lg-12">
                                <div class="col-12"> <!-- Page title -->
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">Edit Training Manager</h4>
                                        <div class="page-title-right">
                                            <ol class="breadcrumb m-0">
                                                <li class="breadcrumb-item">
                                                    <a href="view_travel_agent.php">View Training Manager</a>
                                                </li>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="text-start">
                                                            <button type="submit" class="btn btn-primary" id="edit-training-manager">Submit</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
