...
<?php if($userType == "3"){ ?>
    ...
    <html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
        <head>
            ...
            <meta charset="utf-8" />
            <title>Admin Dashboard | Business Consultant</title>
        ...
        <body>
                                ...
                                <div class="col-lg-12">
                                    <div class="col-12"> <!-- Page title -->
                                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                            <h4 class="mb-sm-0">C.A. Contracting Payout</h4>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6 col-sm-6 col-6  border-4 border-end border-end-dashed">
                                                                        <div class="m-0 mt-2 p-2 ms-n2">
                                                                            ...
                                                                            <?php 
                                                                                $previousPayout = $conn -> prepare("SELECT SUM(comm_amt) as previousPayout FROM ca_payout WHERE business_consultant = '".$userId."' AND YEAR(created_date) = '".$prevDateYear."' AND MONTH(created_date) = '".$prevDateMonth."' ");
                                                                            ...
                                                                            <a href="payout/forms/contracting_payout/download_exel_ca.php?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout&user_id=<?php echo $userId; ?>">
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6 ">
                                                                        <div class="m-0 mt-2 p-2">
                                                                            ...
                                                                            <a href="payout/forms/contracting_payout/download_exel_ca.php?payoutYear=<?php echo $nextDateYear; ?>&payoutMonth=<?php echo $nextDateMonth; ?>&payoutmessage=NextPayout&user_id=<?php echo $userId; ?>">
                                                                                <i class="bx bx-download download-icon1" style="font-size: 20px; color: black; margin-left: 20%;"></i>
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-12"> 
                                                                    ...
                                                                    <div class="table-responsive table-desi" id="filterTable">
                                                                        ...
                                                                        <table class="table table-hover" id="payoutDetailsTable">
                                                                            ...
                                                                            <tbody>
                                                                                <?php
                                                                                    $sql = "SELECT * FROM `ca_payout` WHERE  business_consultant = '".$userId."'  ";
                                                                                        ...
                                                                                        foreach( ($stmt -> fetchALL()) as $key => $row ){
                                                                                            ...
                                                                                            echo '<tr>
                                                                                                    ...
                                                                                                    <td class="text-end">'.$totalAmt.'
                                                                                                        <a href="payout/forms/contracting_payout/download_ca_payout.php?vkvbvjfgfikix='.$row['id'].'&bc='.$row['business_consultant'].'&ca='.$row['corporate_agency'].'&date='.$dt.'&message='.$message1.'&message_status='.$row['status'].'&commission='.$row['comm_amt'].'">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-7 card" style="border: 2px solid black; border-radius: 10px;">
                                    <div class="mt-3">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <a href="payout/forms/contracting_payout/download_exel_ca.php?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout">
                                    ...
                                    <div class="col-md-12"> 
                                        ...
                                        <div class="table-responsive table-desi" id="filterTablePrev">
                                            ...
                                            <table class="table table-hover" id="previous_payout_table">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql2 = "SELECT * FROM ca_payout WHERE business_consultant = '".$userId."' AND YEAR(created_date) = '".$prevDateYear."' AND MONTH(created_date) = '".$prevDateMonth."' ";
                                                            ...
                                                            foreach( ($stmt -> fetchALL()) as $key => $row ){
                                                                ...
                                                                echo '<tr>
                                                                        ...
                                                                        if($row['status'] == '1'){
                                                                            ...
                                                                            echo'<td><span class="badge bg-warning font-size-10 fw-bold ms-4" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" onclick=\'paymentId("' .$row['id']. '","'.$row['business_consultant'].'","'.$row['message'].'","'.$row['comm_amt'].'","'.$row['status'].'","PrevPayout")\'>Pending</span></td>';
                                                                        }
                                                                echo'</tr>';
                                    ...
                                    <div class="col-md-12"> 
                                        ...
                                        <div class="table-responsive table-desi" id="filterTableNext">
                                            ...
                                            <table class="table table-hover" id="next_payout_table">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql3 = "SELECT * FROM ca_payout WHERE business_consultant = '".$userId."' AND YEAR(created_date) = '".$nextDateYear."' AND MONTH(created_date) = '".$nextDateMonth."' ";
                                                            ...
                                                            foreach( ($stmt -> fetchALL()) as $key => $row ){
                                                                ...
                                                                echo '<tr>
                                                                        ...
                                                                        if($row['status'] == '1'){
                                                                            ...
                                                                            echo'<td><span class="badge bg-warning font-size-10 fw-bold ms-4" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" onclick=\'paymentId("' .$row['id']. '","'.$row['business_consultant'].'","'.$row['message'].'","'.$row['comm_amt'].'","'.$row['status'].'","NextPayout")\'>Pending</span></td>';
                                                                        }
                                                                echo'</tr>';
                                    ...
                                    <div class="col-md-12"> 
                                        ...
                                        <div class="table-responsive table-desi" id="filteredTotalTable">
                                            ...
                                            <table class="table table-hover" id="total_payout_table">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql4 = "SELECT * FROM ca_payout WHERE business_consultant = '".$userId."' AND status = '1' ";
                                                            ...
                                                            foreach( ($stmt -> fetchALL()) as $key => $row ){
                                                                ...
                                                                echo '<tr>
                                                                        ...
                                                                        if($row['status'] == '1'){
                                                                            ...
                                                                            echo'<td><span class="badge bg-warning font-size-10 fw-bold ms-4" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" onclick=\'paymentId("' .$row['id']. '","'.$row['business_consultant'].'","'.$row['message'].'","'.$row['comm_amt'].'","'.$row['status'].'","TotalPayout")\'>Pending</span></td>';
                                                                        }
                                                                echo'</tr>';
            ...
            <!-- custom js  -->
            <script src="payout/payout_contracting.js"></script>
            <!-- Chart JS -->
