...
<?php if($userType == "18"){ ?>
    ...
    <html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
        ...
        <body>
                                ...
                                <div class="col-lg-12">
                                    <div class="col-12"> <!-- Page title -->
                                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                            <h4 class="mb-sm-0">Channel Business Director Payout</h4>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6 col-sm-6 col-6  border-4 border-end border-end-dashed">
                                                                        <div class="m-0 mt-2 p-2 ms-n2">
                                                                            ...
                                                                            <?php 
                                                                                $previousPayout = $conn -> prepare("SELECT SUM(amount) as previousPayout FROM cbd_payout WHERE cbd_id = '".$userId."' AND YEAR(created_date) = '".$prevDateYear."' AND MONTH(created_date) = '".$prevDateMonth."' ");
                                                                            ...
                                                                            <a href="payout/forms/cbd_payout/download_exel_cbd.php?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout&user_id=<?php echo $userId; ?>">
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6 ">
                                                                        <div class="m-0 mt-2 p-2">
                                                                            ...
                                                                            <?php 
                                                                                $nextPayout = $conn -> prepare("SELECT SUM(amount) as nextPayout FROM cbd_payout WHERE  cbd_id = '".$userId."' AND YEAR(created_date) = '".$nextDateYear."' AND MONTH(created_date) = '".$nextDateMonth."' ");
                                                                                $nextPayout -> execute();
                                                                            ...
                                                                            <a href="payout/forms/cbd_payout/download_exel_cbd.php?payoutYear=<?php echo $nextDateYear; ?>&payoutMonth=<?php echo $nextDateMonth; ?>&payoutmessage=NextPayout&user_id=<?php echo $userId; ?>">
                                                                                <i class="bx bx-download download-icon1" style="font-size: 20px; color: black; margin-left: 20%;"></i>
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-4 card border-2 border-dark rounded-4">
                                                                <div class="col-sm-12">
                                                                    <div class="m-0 mt-2 p-2 ms-n2">
                                                                        ...
                                                                        <?php 
                                                                            $totalPayout = "SELECT SUM(amount) as total_payable FROM cbd_payout WHERE  cbd_id = '".$userId."' AND status = '1' ";
                                                                        ...
                                                                        <p style="display: none" id="userIdTotalPay"><?php echo $userId;?></p>
                                                                ...
                                                                <div class="col-md-12"> 
                                                                    ...
                                                                    <div class="table-responsive table-desi" id="filterTable">
                                                                        ...
                                                                        <table class="table table-hover" id="payoutDetailsTable">
                                                                            ...
                                                                            <tbody>
                                                                                <?php
                                                                                    $sql = "SELECT * FROM `cbd_payout` WHERE  cbd_id = '".$userId."' AND (status = '1' OR status = '2')  ";
                                                                                        ...
                                                                                        foreach( ($stmt -> fetchALL()) as $key => $row ){
                                                                                            ...
                                                                                            echo '<tr>
                                                                                                    ...
                                                                                                    <td class="text-end">'.$totalAmt.'
                                                                                                        <a href="payout/forms/cbd_payout/download_cbd_payout.php?vkvbvjfgfikix='.$row['id'].'&bc='.$row['cbd_id'].'&date='.$dt.'&message='.$message1.'&message_status='.$row['status'].'&commission='.$row['amount'].'">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-7 card" style="border: 2px solid black; border-radius: 10px;">
                                    <div class="mt-3">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <a href="payout/forms/contracting_payout/download_exel_cbd.php?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout">
                                    ...
                                    <div class="col-md-12"> 
                                        ...
                                        <div class="table-responsive table-desi" id="filterTablePrev">
                                            ...
                                            <table class="table table-hover" id="previous_payout_table">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql2 = "SELECT * FROM cbd_payout WHERE cbd_id = '".$userId."' AND YEAR(created_date) = '".$prevDateYear."' AND MONTH(created_date) = '".$prevDateMonth."' ";
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-7 card" style="border: 2px solid black; border-radius: 10px;">
                                    <div class="mt-3">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <a href="payout/forms/cbd_payout/download_exel_cbd.php?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout">
                                                <i class="bx bx-download download-icon status1 paystatus" style="font-size: 20px; color: black; margin-left: 20%;"></i>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-12"> 
                                        ...
                                        <div class="table-responsive table-desi" id="filterTableNext">
                                            ...
                                            <table class="table table-hover" id="next_payout_table">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql3 = "SELECT * FROM cbd_payout WHERE cbd_id = '".$userId."' AND YEAR(created_date) = '".$nextDateYear."' AND MONTH(created_date) = '".$nextDateMonth."' ";
                                        ...
                                        <div class="d-flex">
                                            <?php 
                                                ...
                                                if($Payout->rowCount()>0){
                                                    foreach(($Payout->fetchAll()) as $key => $row){
                                                        $total_payable = $row["total_payable"] ?? '0';
                                                        $TotalPayoutTDS = $total_payable *5/100;
                                                        $TotalPayable = $total_payable - $TotalPayoutTDS;
                                                        echo'
                                                        <p class="fs-5 font fw-bolder mt-n2 icon">Rs.'.round($TotalPayable).'/- </p>
                                                        <span class="badge bg-success font-size-10 fw-bold status1 paystatus" style="height: 15px !important; margin-top: 16px;" readonly>Paid</span>
                                                        ';
                                                    }
                                                }
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-7">
                                    ...
                                    <div class="row filter-options filter">
                                        ...
                                        <span id="totalDiv" class="col-md-10 card border-2 border-black" style="border-radius: 10px; padding: 10px">
                                            <div  id="download_icon " >
                                                <p class="font-size-14">Name: <span><?php echo $firstname.' '.$lastname; ?></span><span class="fw-bold font-size-10 ms-4 date-layout layout-2 date-align"><?php echo "$date" ?></span></p>
                                                <p class="fs-5 fw-bolder mt-n2 icon">Rs. <?php echo round($TotalPayable); ?>/- </p>
                                                <!-- <a href="">
                                                    <i class="bx bx-download layout-3" style="font-size: 20px; color: black;"></i>
                                                </a> -->
                                            </div>
                                    ...
                                    <div class="col-md-12"> 
                                        ...
                                        <div class="table-responsive table-desi" id="filteredTotalTable">
                                            ...
                                            <table class="table table-hover" id="total_payout_table">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $sql4 = "SELECT * FROM cbd_payout WHERE cbd_id = '".$userId."' AND status = '1' ";
            ...
            <!-- custom js  -->
            <script src="payout/payout_cbd.js"></script>
            <!-- Chart JS -->
