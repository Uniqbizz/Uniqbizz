    ...
    <div id="scrollbar" >
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav" >
                ...
                <li class="nav-item <?php echo ($current_page == 'executive_techno_dashboard.php') ? 'active' : ''; ?>">
                    <a class="nav-link menu-link" href="executive_techno_dashboard.php">
                ...
                <li class="nav-item <?php echo ($current_page == 'super_techno_enterprise_list.php') ? 'active' : ''; ?>">
                    <a class="nav-link menu-link" href="super_techno_enterprise_list.php">
                        <i class="ri-user-shared-2-line"></i> <span>SuperTechno Enterprisee</span>
                    </a>
                </li>
