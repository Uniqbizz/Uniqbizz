...
$('#user_id_name').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'forms/slab_payout_bdm/slab_payout_forms_filter.php',
...
$('#user_id_namePrevious').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'forms/slab_payout_bdm/slab_payout_forms_filter_amt_user.php',
        data: dataString,
        cache: false,
        success: function(data){
            $('#prevDiv').html(data);
...
$('#month_year').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'payout/forms/slab_payout_bdm/slab_payout_forms_month.php',
        data: dataString,
        cache: false,
        success: function(data){
            // console.log(data);
...
function paymentId(id, userID, message, amt, status, col_update){
    ...
    $('#submitPayment').click(function(e){
        ...
        if(paymentMessage.length>0){
            $.ajax({
                type: 'POST',
                url: 'payout/forms/slab_payout_bdm/slab_payout_forms_paid.php',
                data: dataString,
                cache: false,
                success: function(data){
                    console.log(data);
...
function totalPayoutExel(){
    ...
    if(totalPayoutDate){
        ...
        //     }
        // });
        window.location.href='payout/forms/slab_payout_bdm/download_exel_ca.php?payoutYear='+payoutYear+'&payoutMonth='+payoutMonth+'&payoutmessage='+payoutmessage+'&user_id='+userID;
    }else{
...
function allPayoutExel(){
    ...
    window.location.href='payout/forms/slab_payout_bdm/download_exel_ca.php?payoutYear='+payoutYear+'&payoutMonth='+payoutMonth+'&payoutmessage='+payoutmessage+'&designation='+designation+'&user_id='+user_id;
}
