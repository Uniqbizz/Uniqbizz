$(document).ready(function() {
    ...
    function loadBmBdmTables(monthYear) {
        ...
        $.ajax({
            url: "../../controllers/payout/forms/slab_payout_bdm/getbmdetails.php",
            type: "POST",
            data: {
                designation: 'bcm',
                user_id: user_id,
...
function loadRejectionReason(Id) {
    ...
    fetch(`../../controllers/payout/forms/slab_payout_bdm/get_block_reason.php?id=${Id}&userType=<?php echo $userType; ?>`)
