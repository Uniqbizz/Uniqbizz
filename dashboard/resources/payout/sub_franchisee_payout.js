...
$('#month_year').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'payout/forms/sub_franchisee_payout/product_payout_month.php',
        data: dataString,
        cache: false,
...
function totalPayoutExel(){
    ...
    if(totalPayoutDate){
        ...
        //     }
        // });
        window.location.href='payout/forms/sub_franchisee_payout/download_exel_ca.php?payoutYear='+payoutYear+'&payoutMonth='+payoutMonth+'&payoutmessage='+payoutmessage+'&user_id='+userID+'&userType='+userIdTotalPay;
    }else{
