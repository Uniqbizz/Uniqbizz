                            ...
                            <div class="col-lg-12">
                                <div class="col-12"> <!-- Page title -->
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">T.E Recruitment Payout (BDM)</h4>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 card border-2 border-dark rounded-4">
                                                            <div class="col-sm-12">
                                                                <div class="m-0 mt-2 p-2 ms-n2">
                                                                    ...
                                                                    <?php
                                                                    $totalPayout = "SELECT SUM(payout_amount) as total_payable FROM bdm_payout_history WHERE  bdm_user_id = '" . $userId . "'  ";
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="table-responsive table-desi" id="filterTable">
                                                                    ...
                                                                    <table class="table table-hover" id="payoutDetailsTable">
                                                                        ...
                                                                        <tbody>
                                                                            <?php
                                                                            $sql = "SELECT * FROM `bdm_payout_history` WHERE  bdm_user_id = '" . $userId . "'  ";
                                                                            ...
                                                                            if ($stmt->rowCount() > 0) {
                                                                                foreach (($stmt->fetchALL()) as $key => $row) {
                                                                                    ...
                                                                                    // Get Active BMs
                                                                                    $ids = json_decode($row['bm_user_id'], true);
                                                                                    $names = [];

                                                                                    if (!empty($ids)) {
                                                                                        $placeholders = rtrim(str_repeat('?,', count($ids)), ','); // ?,?,?
                                                                                        $query = $conn->prepare("SELECT business_mentor_id, CONCAT(firstname, ' ', lastname) AS name FROM business_mentor WHERE business_mentor_id IN ($placeholders) AND status = 1");
                                                                                        $query->execute($ids);

                                                                                        while ($bmRow = $query->fetch(PDO::FETCH_ASSOC)) {
                                                                                            $names[] = $bmRow['name'] . " (" . $bmRow['business_mentor_id'] . ")";
                                                                                        }
                                                                                    }

                                                                                    // Append Active BMs to message
                                                                                    $message1 = $row['message_bdm'];
                                                                                    if (!empty($names)) {
                                                                                        $message1 .= " Active BMs: " . implode(', ', $names) . ".";
                                                                                    }
                                                                                    ...
                                                                                    echo '<tr>
                                                                                                    ...
                                                                                                    <td class="text-end">' . $totalAmt . '
                                                                                                        <a href="payout/forms/slab_payout_bdm/download_ca_payout.php?vkvbvjfgfikix=' . $row['id'] . '&bc=' . $row['bdm_user_id'] . '&ca=' . urlencode(implode(', ', json_decode($row['bm_user_id'], true))) . '&date=' . $dt . '&message=' . $message1 . '&message_status=' . $row['payout_status'] . '&commission=' . $row['payout_amount'] . '&userType=' . $userType . '">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive table-desi" id="filterTablePrev">
                                        ...
                                        <table class="table table-hover" id="previous_payout_table">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql2 = "SELECT * FROM bdm_payout_history WHERE bdm_user_id = '" . $userId . "' AND YEAR(payout_date) = '" . $prevDateYear . "' AND MONTH(payout_date) = '" . $prevDateMonth . "' ";
                                                ...
                                                if ($stmt->rowCount() > 0) {
                                                    foreach (($stmt->fetchALL()) as $key => $row) {
                                                        ...
                                                        echo '<tr>
                                                                        ...
                                                                        <td class="text-end">' . $tds . '</td>
                                                                        <td class="text-end">' . $totalAmt . '
                                                                            <a href="payout/forms/slab_payout_bdm/download_ca_payout.php?vkvbvjfgfikix=' . $row['id'] . '&bc=' . $row['bdm_user_id'] . '&ca='  . implode(', ', json_decode($row['bm_user_id'], true)) . '&date=' . $dt . '&message=' . $message1 . '&message_status=' . $row['payout_status'] . '&commission=' . $row['payout_amount'] . '&userType=' . $userType . '">
                                                                                <i class="bx bx-download" style="font-size: 18px; color: black; padding-left: 5px;"></i>
                                                                            </a>
                                                                        </td>';
                                                        if ($row['payout_status'] == '2') {
                                                            ...
                                                            echo '<td><span class="badge bg-warning font-size-10 fw-bold ms-4" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" onclick=\'paymentId("' . $row['id'] . '","' . $row['bdm_user_id'] . '","' . $row['message_bdm'] . '","' . $row['payout_amount'] . '","' . $row['payout_status'] . '","PrevPayout")\'>Pending</span></td>';
                                                        }
                                                        echo '</tr>';
                                                    }
                                                }
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive table-desi" id="filterTableNext">
                                        ...
                                        <table class="table table-hover" id="next_payout_table">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql3 = "SELECT * FROM bdm_payout_history WHERE bdm_user_id = '" . $userId . "' AND YEAR(payout_date) = '" . $nextDateYear . "' AND MONTH(payout_date) = '" . $nextDateMonth . "' ";
                                                ...
                                                if ($stmt->rowCount() > 0) {
                                                    foreach (($stmt->fetchALL()) as $key => $row) {
                                                        ...
                                                        if ($row['payout_status'] == '2') {
                                                            ...
                                                            echo '<td><span class="badge bg-warning font-size-10 fw-bold ms-4" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" onclick=\'paymentId("' . $row['id'] . '","' . $row['bdm_user_id'] . '","' . $row['message_bdm'] . '","' . $row['payout_amount'] . '","' . $row['payout_status'] . '","NextPayout")\'>Pending</span></td>';
                                                        }
                                                        echo '</tr>';
                                                    }
                                                }
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive table-desi" id="filteredTotalTable">
                                        ...
                                        <table class="table table-hover" id="total_payout_table">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql4 = "SELECT * FROM bdm_payout_history WHERE bdm_user_id = '" . $userId . "'  ";
                                                ...
                                                if ($stmt->rowCount() > 0) {
                                                    foreach (($stmt->fetchALL()) as $key => $row) {
                                                        ...
                                                        if ($row['payout_status'] == '2') {
                                                            ...
                                                            echo '<td><span class="badge bg-warning font-size-10 fw-bold ms-4" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" onclick=\'paymentId("' . $row['id'] . '","' . $row['bdm_user_id'] . '","' . $row['message_bdm'] . '","' . $row['payout_amount'] . '","' . $row['payout_status'] . '","TotalPayout")\'>Pending</span></td>';
                                                        }
                                                        echo '</tr>';
                                                    }
                                                }
