...
<body>
    <div id="layout-wrapper">
        ...
        include '../models/orders/order_cards.php'
                                ...
                                <div class="col-lg-12 py-3">
                                    <div class="table-responsive table-desi">
                                        <table class="table table-hover" id="user_table2">
                                            ...
                                            <!-- data load from models file -->
                                            <?php include '../models/orders/pending_orders.php' ?>
                                        </table>
                                        <!-- pegination start -->
                                        <div class="center text-center" id="pagination_row"></div>
                                    </div>
                                ...
                                <div class="col-lg-12 py-3">
                                    <div class="table-responsive table-desi">
                                        <table class="table table-hover" id="user_table3">
                                            ...
                                            <!-- data load from models file -->
                                            <?php include '../models/orders/booked_orders.php' ?>
                                        </table>
                                        <!-- pegination start -->
                                        <div class="center text-center" id="pagination_row"></div>
                                    </div>
                                ...
                                <div class="col-lg-12 py-3">
                                    <div class="table-responsive table-desi">
                                        <table class="table table-hover" id="user_table4">
                                            ...
                                            <!-- data load from models file -->
                                            <?php include '../models/orders/canceled_orders.php' ?>
                                        </table>
                                        <!-- pegination start -->
                                        <div class="center text-center" id="pagination_row"></div>
                                    </div>
                                ...
                                <div class="col-lg-12 py-3">
                                    <div class="table-responsive table-desi">
                                        <table class="table table-hover" id="user_table5">
                                            ...
                                            <!-- data load from models file -->
                                            <?php include '../models/orders/refund_orders.php' ?>
                                        </table>
                                        <!-- pegination start -->
                                        <div class="center text-center" id="pagination_row"></div>
                                    </div>
    ...
    <script src="../resources/orders/orders_custom.js"></script>
    <!-- Date Range Script -->
</body>
