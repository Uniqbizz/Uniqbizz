...
<?php if ($userType == "24") { ?>
    ...
    <body>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6 col-sm-6 col-6  border-4 border-end border-end-dashed">
                                                                    <div class="m-0 mt-2 p-2 ms-n2">
                                                                        ...
                                                                        <!-- data load from models file -->
                                                                         <?php include '../models/payout/bcm/previous_payout_card.php' ?>
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-6 ">
                                                                    <div class="m-0 mt-2 p-2">
                                                                        ...
                                                                        <!-- data load from models file -->
                                                                        <?php include '../models/payout/bcm/next_payout_card.php' ?>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 card border-2 border-dark rounded-4">
                                                            <div class="col-sm-12">
                                                                <div class="m-0 mt-2 p-2 ms-n2">
                                                                    ...
                                                                    <!-- data load from models file -->
                                                                    <?php include '../models/payout/bcm/total_payout_card.php' ?>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="table-responsive table-desi" id="filterTable">
                                                                    ...
                                                                    <table class="table table-hover" id="payoutDetailsTable">
                                                                        ...
                                                                        <tbody>
                                                                            <!-- data load from models file -->
                                                                            <?php include '../models/payout/bcm/all_payout_table.php' ?>
                        ...
                        <div class="row d-flex justify-content-evenly">
                            <div class="col-lg-4 col-md-4 col-sm-7 card" style="border: 2px solid black; border-radius: 10px;">
                                <div class="mt-3">
                                    ...
                                    <div class="d-flex">
                                        <!-- data load from models file -->
                                        <?php include '../models/payout/bcm/prev_modal_sub_card.php' ?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive table-desi" id="filterTablePrev">
                                        ...
                                        <table class="table table-hover" id="previous_payout_table">
                                            ...
                                            <tbody>
                                                <!-- data load from models file -->
                                                <?php include '../models/payout/bcm/prev_modal_table.php' ?>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
                        ...
                        <div class="row d-flex justify-content-evenly">
                            <div class="col-lg-4 col-md-4 col-sm-7 card" style="border: 2px solid black; border-radius: 10px;">
                                <div class="mt-3">
                                    ...
                                    <div class="d-flex">
                                        <!-- data load from models file -->
                                        <?php include '../models/payout/bcm/next_modal_sub_card.php' ?>
                                        <a href="../controllers/payout/forms/slab_payout_bdm/download_exel_ca.php?payoutYear=<?php echo $nextDateYear; ?>&payoutMonth=<?php echo $nextDateMonth; ?>&payoutmessage=NextPayout&userType=<?php echo $userType; ?>&user_id=<?php echo $userId ?>">
                                            <i class="bx bx-download download-icon status1 paystatus" style="font-size: 20px; color: black; margin-left: 20%;"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive table-desi" id="filterTableNext">
                                        ...
                                        <table class="table table-hover" id="next_payout_table">
                                            ...
                                            <tbody>
                                                <!-- data load from models file -->
                                                 <?php include '../models/payout/bcm/next_modal_table.php' ?>
                                            </tbody>
                                        </table>
                                        <!-- pegination start -->
                        ...
                        <div class="row d-flex justify-content-evenly">
                            <div class="col-lg-4 col-md-4 col-sm-7 card" style="border: 2px solid black; border-radius: 10px;">
                                <div class="mt-3">
                                    ...
                                    <div class="d-flex">
                                        <!-- data load from models file -->
                                         <?php include '../models/payout/bcm/total_modal_sub_card.php' ?>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-7 col-sm-7">
        ...
        <script src="../resources/payout/bcm/bcm_custom.js"></script>
    </body>
