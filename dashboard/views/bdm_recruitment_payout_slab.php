...
<?php if ($userType == "25") { ?>
    ...
    <body>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6 col-sm-6 col-6  border-4 border-end border-end-dashed">
                                                                    <div class="m-0 mt-2 p-2 ms-n2">
                                                                        ...
                                                                        <?php include '../models/payout/bdm/previous_payout_card.php' ?>
                                                                        ...
                                                                        <a href="../controllers/payout/forms/slab_payout_bdm/download_exel_ca.php?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout&user_id=<?php echo $userId; ?>&userType=<?php echo $userType;?>">
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-6 ">
                                                                    <div class="m-0 mt-2 p-2">
                                                                        ...
                                                                        <!-- data load from models file -->
                                                                        <?php include '../models/payout/bdm/next_payout_card.php' ?>
                                                                        <a type="button" data-bs-toggle="modal" data-bs-target="#nextPayout" style=" cursor: pointer;">
                                                                            <p class="mt-n2 mb-1 fw-bold p1" style="color: #0096FF;">View Payout</p>
                                                                        </a>
                                                                        <a href="../controllers/payout/forms/slab_payout_bdm/download_exel_ca.php?payoutYear=<?php echo $nextDateYear; ?>&payoutMonth=<?php echo $nextDateMonth; ?>&payoutmessage=NextPayout&user_id=<?php echo $userId; ?>&userType=<?php echo $userType;?>">
                                                                            <i class="bx bx-download download-icon1" style="font-size: 20px; color: black; margin-left: 20%;"></i>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 card border-2 border-dark rounded-4">
                                                            <div class="col-sm-12">
                                                                <div class="m-0 mt-2 p-2 ms-n2">
                                                                    ...
                                                                    <!-- data load from models file -->
                                                                    <?php include '../models/payout/bdm/total_payout_card.php' ?>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="table-responsive table-desi" id="filterTable">
                                                                    ...
                                                                    <table class="table table-hover" id="payoutDetailsTable">
                                                                        ...
                                                                        <tbody>
                                                                            <!-- data load from models file -->
                                                                            <?php include '../models/payout/bdm/all_payout_table.php' ?>
                                                                        </tbody>
                                                                    </table>
                                                                </div>
                                                            </div>
                        ...
                        <div class="row d-flex justify-content-evenly">
                            <div class="col-lg-4 col-md-4 col-sm-7 card" style="border: 2px solid black; border-radius: 10px;">
                                <div class="mt-3">
                                    ...
                                    <div class="d-flex">
                                        <!-- data load from models file -->
                                        <?php include '../models/payout/bdm/prev_modal_sub_card.php' ?>
                                        <a href="../controllers/payout/forms/slab_payout_bdm/download_exel_ca.php?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout &userType=<?php echo $userType;?>">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive table-desi" id="filterTablePrev">
                                        ...
                                        <table class="table table-hover" id="previous_payout_table">
                                            ...
                                            <tbody>
                                                <!-- data load from models file -->
                                                <?php include '../models/payout/bdm/prev_modal_table.php' ?>
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
                        ...
                        <div class="row d-flex justify-content-evenly">
                            <div class="col-lg-4 col-md-4 col-sm-7 card" style="border: 2px solid black; border-radius: 10px;">
                                <div class="mt-3">
                                    ...
                                    <div class="d-flex">
                                        <!-- data load from models file -->
                                        <?php include '../models/payout/bdm/next_modal_sub_card.php' ?>
                                        <a href="../controlllers/payout/forms/slab_payout_bdm/download_exel_ca.php?payoutYear=<?php echo $nextDateYear; ?>&payoutMonth=<?php echo $nextDateMonth; ?>&payoutmessage=NextPayout&userType=<?php echo $userType;?>&user_id=<?php echo $userId?>">
                                            <i class="bx bx-download download-icon status1 paystatus" style="font-size: 20px; color: black; margin-left: 20%;"></i>
                                        </a>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive table-desi" id="filterTableNext">
                                        ...
                                        <table class="table table-hover" id="next_payout_table">
                                            ...
                                            <tbody>
                                                <!-- data load from models file -->
                                                <?php include '../models/payout/bdm/next_modal_table.php' ?>
                                            </tbody>
                                        </table>
                                        <!-- pegination start -->
                        ...
                        <div class="row d-flex justify-content-evenly">
                            <div class="col-lg-4 col-md-4 col-sm-7 card" style="border: 2px solid black; border-radius: 10px;">
                                <div class="mt-3">
                                    ...
                                    <div class="d-flex">
                                        <!-- data load from models file -->
                                        <?php include '../models/payout/bdm/total_modal_sub_card.php' ?>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-7 col-md-7 col-sm-7">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive table-desi" id="filteredTotalTable">
                                        ...
                                        <table class="table table-hover" id="total_payout_table">
                                            ...
                                            <tbody>
                                                <!-- data load from models file -->
                                                <?php include '../models/payout/bdm/taotal_modal_table.php' ?>
                                            </tbody>
                                        </table>
                                        <!-- pegination start -->
                                        <div class="center text-center" id="pagination_row"></div>
        ...
        <!-- custom js  -->
        <script src="../resources/payout/slab_payout_bdm_bcm.js"></script>
        <!-- Chart JS -->
        ...
        <script src="../resources/payout/bdm/bdm_custom.js"> </script>
    </body>
