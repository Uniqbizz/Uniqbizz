...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    ...
    <body>
            ...
            <div class="main-content">
                ...
                <div class="page-content">
                    ...
                    <!-- end page title -->
                                                ...
                                                <div class="card-body">
                                                    <table id="example-dataTable" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php include '../models/customer/pending_customer_list.php' ?>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <table id="example-dataTable-2" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            <!-- data load from models file -->
                                                            <?php include '../models/customer/registered_customer_list.php' ?>
                                                        </tbody>
                                                    </table>
                                                </div>
                                            </div>
                        ...
                        <?php if($userType == "10" || $userType == "11" ||$userType == "33" ){ ?>
        ...
        <script src="../resources/customer/cu_custom.js"></script>
    </body>
</html>