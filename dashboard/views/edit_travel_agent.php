<?php
    ...
    include '../models/travel_agent/edit_tc.php'
?>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="input-block mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="reference_name" placeholder="Enter Reference Name" value="<?php echo $registrant; ?>" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="input-block mb-3">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="input-block mb-3">
                                                            ...
                                                            <input type="date" class="form-control" id="dob" placeholder="Enter Date Of Birth" value="<?php echo $date_of_birth;?>" max="<?= $ageLimit ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                                        ...
                                                        <div class="form-control d-flex justify-content-around">
                                                            <label class="radio-inline mb-0 ms-3" for="test3"><input type="radio" id="test3" class="form-check-input gender me-3" name="gender" value="male" <?php if($gender == "male") {echo 'checked';} ?> />Male</label>
                                                            <label class="radio-inline mb-0 ms-3" for="test4"><input type="radio" id="test4"  class="form-check-input gender me-3" name="gender" value="female" <?php if($gender == "female") {echo 'checked';} ?> />Female</label>
                                                            <label class="radio-inline mb-0 ms-3" for="test5"><input type="radio" id="test5"  class="form-check-input gender me-3" name="gender" value="others" <?php if($gender == "others") {echo 'checked';} ?> />Others</label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="input-block mb-3">
                                                            ...
                                                            <select class="form-select" id="mystate">
                                                    ...
                                                    <div class="pb-3" id="paymentFields">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 d-none" id="chequeOpt">
                                                        ...
                                                        <div class="col-lg-12 d-none" id="onlineOpt">
                                                            <div class="row d-flex justify-content-center">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="input-block mb-3">
                                                            <label class="col-form-label" for="file1">
                                                                <b>Profile Picture</b>
                                                                <?php
                                                                    if($profile_pic !=''){
                                                                ?>
                                                            ...
                                                            <input type="file" class="form-control" name="file1" id="upload_file1">
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="input-block mb-3">
                                                            <label class="col-form-label" for="file2">
                                                                <b>Aadhar Card</b>
                                                                <?php
                                                                    if($aadhar_card !=''){
                                                                ?>
                                                            ...
                                                            <input type="file" class="form-control" name="file2" id="upload_file2">
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="input-block mb-3">
                                                            <label class="col-form-label" for="file3">
                                                                <b>Pan Card</b>
                                                                <?php
                                                                    if($pan_card !=''){
                                                                ?>
                                                            ...
                                                            <input type="file" class="form-control" name="file3" id="upload_file3">
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="input-block mb-3">
                                                            <label class="col-form-label" for="file4">
                                                                <b>Bank Passbook</b>
                                                                <?php
                                                                    if($bank_passbook !=''){
                                                                ?>
                                                            ...
                                                            <input type="file" class="form-control" name="file4" id="upload_file4">
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="input-block mb-3">
                                                            <label class="col-form-label" for="file5">
                                                                <b>Voting Card</b>
                                                                <?php
                                                                    if($voting_card !=''){
                                                                ?>
                                                            ...
                                                            <input type="file" class="form-control" name="file5" id="upload_file5">
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="input-block mb-3">
                                                            <label class="col-form-label" for="file6">
                                                                <b>Payment Proof</b>
                                                                <?php
                                                                    if($payment_proof !=''){
                                                                ?>
                                                            ...
                                                            <input type="file" class="form-control" name="file6" id="upload_file6" disabled>
                                                        </div>
