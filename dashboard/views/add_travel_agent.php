...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    ...
    <body>
                                        ...
                                        <div class="h-100">
                                            <form>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="input-block mb-3">
                                                            <label class="col-form-label" for="file1"><b>Profile Picture</b></label><br/>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="input-block mb-3">
                                                            <label class="col-form-label" for="file2"><b>Aadhaar Card</b></label><br/>
                                                    ...
                                                    <input type="hidden" id="testValue" name="testValue" value="11"> <!-- Travel Agent -->
        ...
        <script src="../resources/travel_agent/add_tc_custom.js"></script>
    </body>
</html>