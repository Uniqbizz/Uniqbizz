<?php
    ...
    include '../models/corporate_agency/edit_te.php';
?>
...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Edit Techno Enterprise | Dashboard</title>
    ...
    <body>
                                        ...
                                        <div class="h-100">
                                            <form action="#">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                                        <div class="input-block mb-3">
                                                            ...
                                                            <input type="date" class="form-control" id="dob" placeholder="Enter Date" max="<?= $ageLimit ?>" value="<?php echo $date_of_birth;?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-6">
                                                        <div class="input-block mb-3">
                                                            <label class="col-form-label" for="mystate">Business Package/Amount<span class="text-danger">*</span></label>
                                                            <select class="form-select" id="business_package_amount" disabled>
                                                    ...
                                                    <div class="col-md-4 col-sm-6">
                                                        <div class="input-block mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="flex_amount" placeholder="Package Amount" value="<?php echo $amount; ?>" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 col-sm-6">
                                                        <div class="input-block mb-3">
                                                            <label class="col-form-label" for="gst_no">GST NO<span class="text-danger">*</span></label>
                                                            <input type="text" class="form-control" id="gst_no" placeholder="Enter GST NO" value="<?php echo $gst_no; ?>" >
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="d-flex justify-content-center mb-4">
                                                    <button type="submit" class="btn btn-primary px-5 py-2" id="edit-corporate-agency">Submit</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
        ...
        <script src="../resources/corporate_agency/edit_te_custom.js"></script>
    </body>
</html>