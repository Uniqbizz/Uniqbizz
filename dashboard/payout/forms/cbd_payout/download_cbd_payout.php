...
$bcNames = $conn -> prepare("SELECT * FROM channel_business_director WHERE channel_business_director_id = '".$bc."' AND status = 1");
$bcNames -> execute();
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="col-md-5 col-sm-5 pt-3">
                                            <!-- <h6 style="padding:2px 0; font-weight: 700;">Pay For : Channel Business Director </h6> -->
