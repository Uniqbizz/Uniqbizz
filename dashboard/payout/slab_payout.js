...
// **** slab_payout_forms Javascript Start ****
...
$('#user_id_name').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'forms/slab_payout_forms/slab_payout_forms_filter.php',
...
// remove slab_payout_forms_filter.php file --not sure-- 
...
$('#user_id_namePrevious').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'forms/slab_payout_forms/slab_payout_forms_filter_amt_user.php',
        data: dataString,
        cache: false,
        success: function(data){
            $('#prevDiv').html(data);
...
$('#month_year').on('change', function(){
    ...
    const userType=$('#userTypeHidden').val();
    // console.log(TotalYear+' '+TotalMonth);
    dataString={
        TotalYear, TotalMonth, totalAmountMessage, userID,userType
    }
    dataString2={
        TotalYear, TotalMonth, totalTableMessage, userID,userType
    }
    $.ajax({
        type: 'POST',
        url: 'payout/forms/slab_payout_forms/slab_payout_forms_month.php',
        data: dataString,
        cache: false,
        success: function(data){
            // console.log(data);
...
function paymentId(id, userID, message, amt, status, col_update){
    ...
    $('#submitPayment').click(function(e){
        ...
        dataString = {
            id, paymentMessage, amt, status, col_update
        }
        // console.log(dataString);
        ...
        if(paymentMessage.length>0){
            $.ajax({
                type: 'POST',
                url: 'payout/forms/slab_payout_forms/slab_payout_forms_paid.php',
                data: dataString,
                cache: false,
                success: function(data){
                    console.log(data);
...
function totalPayoutExel(){
    ...
    if(totalPayoutDate){
        ...
        //     }
        // });
        window.location.href='payout/forms/slab_payout_forms/download_exel_ca.php?payoutYear='+payoutYear+'&payoutMonth='+payoutMonth+'&payoutmessage='+payoutmessage+'&user_id='+userID;
    }else{
...
function allPayoutExel(){
    ...
    window.location.href='payout/forms/slab_payout_forms/download_exel_ca.php?payoutYear='+payoutYear+'&payoutMonth='+payoutMonth+'&payoutmessage='+payoutmessage+'&designation='+designation+'&user_id='+user_id;
}

// **** slab_payout_forms Javascript End ****