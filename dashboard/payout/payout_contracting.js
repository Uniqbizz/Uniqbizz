...
// remove contracting_payout_filter.php file --not sure-- 
...
$('#user_id_namePrevious').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'forms/contracting_payout/contracting_payout_filter_amt_user.php',
        data: dataString,
        cache: false,
        success: function(data){
            $('#prevDiv').html(data);
...
$('#month_year').on('change', function(){
    ...
    $.ajax({
        type: 'POST',
        url: 'payout/forms/contracting_payout/contracting_payout_month.php',
        data: dataString,
        cache: false,
        success: function(data){
            // console.log(data);
...
function paymentId(id, userID, message, amt, status, col_update){
    ...
    $('#submitPayment').click(function(e){
        ...
        if(paymentMessage.length>0){
            $.ajax({
                type: 'POST',
                url: 'payout/forms/contracting_payout/contracting_payout_paid.php',
                data: dataString,
                cache: false,
                success: function(data){
                    console.log(data);
...
function totalPayoutExel(){
    ...
    if(totalPayoutDate){
        ...
        //     }
        // });
        window.location.href='payout/forms/contracting_payout/download_exel_ca.php?payoutYear='+payoutYear+'&payoutMonth='+payoutMonth+'&payoutmessage='+payoutmessage+'&user_id='+userID;
    }else{
...
function allPayoutExel(){
    ...
    window.location.href='payout/forms/contracting_payout/download_exel_ca.php?payoutYear='+payoutYear+'&payoutMonth='+payoutMonth+'&payoutmessage='+payoutmessage+'&designation='+designation+'&user_id='+user_id;
}
