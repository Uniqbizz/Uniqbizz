...
?>
<!-- modal css -->
<link rel="stylesheet" href="<?= $base_url_asset ?>assets/css/neo_select/my_consultant_modal.css" />
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav" >
                ...
                <li class="nav-item <?= ($current_page == 'order_history.php') ? 'active' : ''; ?>">
                    <a class="nav-link menu-link" href="<?= $base_url_asset?>order_history.php" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                ...
                <!-- <li class="nav-item <php ($current_page == 'order_history.php') ? 'active' : ''; ?>">
                    <a class="nav-link menu-link" href="<php $base_url_asset?>order_history.php" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                ...
                <li class="nav-item <?= ($current_page == 'view_customer.php') ? 'active' : ''; ?>">
                    <a class="nav-link menu-link" href="<?= $base_url_asset?>view_customer.php" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                ...
                <li class="nav-item <?= ($current_page == 'profile.php') ? 'active' : ''; ?>">
                    <a class="nav-link menu-link" href="<?= $base_url_asset?>profile.php">
                ...
                <li class="nav-item <?= ($current_page == 'customer_benefit.php') ? 'active' : ''; ?>">
                    <a class="logoutBtn mylogout" href="<?= $base_url_asset?>logout.php">
