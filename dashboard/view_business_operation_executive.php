                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">View Business Operation Executive</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
                                        <li class="breadcrumb-item active">View Business Operation Executive</li>
                                    </ol>
                                </div>
                    ...
                    <!-- end page title -->
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <table id="example-dataTable" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                $sql3 = "SELECT * FROM `business_operation_executive` WHERE reference_no = '$userId' AND (status = '2' OR status = '0') ";
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <table id="example-dataTable-2" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                                        <thead>
                                                            <tr>
                                                                <th data-ordering="false">BOE ID & Name</th>
                                                                <th data-ordering="false">Reference ID & Name</th>
                                                                <th data-ordering="false">Phone</th>
                                                                <th data-ordering="false">Joining Date</th>
                                                                <th data-ordering="false">Status</th>
                                                        ...
                                                        <tbody>
                                                            <?php
                                                                $sql4 = "SELECT * FROM `business_operation_executive` WHERE reference_no = '$userId' AND (status = '1' OR status = '3') ";
                                                                ...
                                                                if($stmt4 -> rowCount()>0){
                                                                    foreach(($stmt4 -> fetchAll()) as $key => $row){
                                                                        ...
                                                                        echo'<tr>
                                                                            <td>
                                                                                <p>'.$row['business_operation_executive_id'].'</p>
                                                                            ...
                                                                            if($row['status'] == '1'){
                                                                                echo'<td>
                                                                                    <div class="dropdown d-inline-block">
                                                                                        ...
                                                                                        <ul class="dropdown-menu dropdown-menu-end">
                                                                                            <li><a class="dropdown-item edit-item-btn" onclick=\'editfunc("' .$row["business_operation_executive_id"]. '","' .$row["country"]. '","' .$row["state"]. '","' .$row["city"]. '","registered")\'><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li>
                                                                                            <li><a class="dropdown-item remove-item-btn" onclick=\'deletefunc("'.$row["id"].'","'.$row["business_operation_executive_id"].'","registered")\'><i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</a></li>
                                                                                        </ul>
                                                                                    </div>
                                                                                </td>';
                                                                            }else{
                                                                                ...
                                                                                <div class="dropdown d-inline-block">
                                                                                    ...
                                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                                        <li><a class="dropdown-item remove-item-btn" onclick=\'deletefunc("'.$row["id"].'","'.$row["business_operation_executive_id"].'","deactivate")\'><i class="ri-arrow-go-back-fill align-bottom me-2 text-muted"></i> Restore</a></li>
                                                                                    </ul>
                                                                                </div>
                                                                                </td>';
                                                                            } 
                        ...
                        <?php if($userType == "19" ){ ?>
                            <div class="btn" style="width: 25px; height: 25px; padding: 0px; position: fixed; bottom: 120px; right: 35px; border-radius: 50%;">
                                <a href="add_business_operation_executive.php" style="display: flex; justify-content: center; align-items: center; height: -webkit-fill-available;">
        ...
        <!-- <script src="assets/js/pages/chartjs.init.js"></script>// -->
         ...
         <script>
            ...
            function editfunc(id,cut,st,ct,editfor){
                window.location.href='edit_business_operation_executive.php?vkvbvjfgfikix='+id+'&ncy='+cut+'&mst='+st+'&hct='+ct+'&editfor='+editfor;
            };
            ...
            function deletefunc(id,fid,action){
                ...
                $.ajax({
                    type: "POST",
                    url: "business_operation_executive/delete_boe_data.php",
                    data: dataString,
                    cache: false,
