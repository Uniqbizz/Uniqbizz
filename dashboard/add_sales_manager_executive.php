    ...
    <body>
                            ...
                            <div class="col-lg-12">
                                <div class="col-12"> <!-- Page title -->
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">Add Sales Manager / Executive</h4>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-floating">
                                                            <?php
                                                                $stmt = $conn->prepare("SELECT * FROM training_manager  ");
                                                                $stmt->execute();                                         
                                                                ...
                                                                <?php 
                                                                    if($stmt->rowCount()>0){
                                                                        foreach (($stmt->fetchAll()) as $key => $row) {  
                                                                            echo '
                                                                            <option value="'.$row['training_manager_id'].'">'.$row['training_manager_id'].' ('.$row['firstname'].' '.$row['lastname'].')</option>';
                                                                        } 
                                                                    }else{ 
                                                    ...
                                                    <input type="hidden" id="testValue" name="testValue" value="22"> <!-- sales_manager_executive-->
                                                    
                                                    <div class="col-lg-12">
                                                        <div class="text-start">
                                                            <button type="submit" class="btn btn-primary" id="add-sales-manager-executive">Submit</button>
                                                        </div>
                                                    </div>
        ...
        <script>
            ...
            $('#user_id_name').on('change', function(){
                ...
                var designation = 'sales_executive';
                // console.log(designation);
