...
<?php if ($userType == "26") { ?>
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Admin Dashboard | Business Mentor</title>
    ...
    <body>
                            ...
                            <div class="col-lg-12">
                                <div class="col-12"> <!-- Page title -->
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <h4 class="mb-sm-0">T.E Recruitment Payout</h4>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6 col-sm-6 col-6  border-4 border-end border-end-dashed">
                                                                    <div class="m-0 mt-2 p-2 ms-n2">
                                                                        ...
                                                                        <?php
                                                                        $previousPayout = $conn->prepare("SELECT SUM(payout_amount) as previousPayout FROM bm_payout_history WHERE bm_user_id = '" . $userId . "' AND YEAR(payout_date) = '" . $prevDateYear . "' AND MONTH(payout_date) = '" . $prevDateMonth . "' ");
                                                                        ...
                                                                        if ($previousPayout->rowCount() > 0) {
                                                                            foreach (($previousPayout->fetchAll()) as $key => $row) {
                                                                                ...
                                                                                echo '<p class="fs-5 fw-bolder mt-n2">Rs. ' . number_format($truncatedPrevAmount,2) . '/- <span class="badge bg-warning font-size-10 fw-bold ms-4">Pending</span> </p>';
                                                                            }
                                                                        }
                                                                        ?>
                                                                        ...
                                                                        <a href="payout/forms/slab_payout_forms/download_exel_ca.php?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout&user_id=<?php echo $userId; ?>">
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-6 col-6 ">
                                                                    <div class="m-0 mt-2 p-2">
                                                                        ...
                                                                        <?php
                                                                        $nextPayout = $conn->prepare("SELECT SUM(payout_amount) as nextPayout FROM bm_payout_history WHERE  bm_user_id = '" . $userId . "' AND YEAR(payout_date) = '" . $nextDateYear . "' AND MONTH(payout_date) = '" . $nextDateMonth . "'  ");
                                                                        $nextPayout->execute();
                                                                        ...
                                                                        <a href="payout/forms/slab_payout_forms/download_exel_ca.php?payoutYear=<?php echo $nextDateYear; ?>&payoutMonth=<?php echo $nextDateMonth; ?>&payoutmessage=NextPayout&user_id=<?php echo $userId; ?>">
                                                                            <i class="bx bx-download download-icon1" style="font-size: 20px; color: black; margin-left: 20%;"></i>
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="table-responsive table-desi" id="filterTable">
                                                                    ...
                                                                    <table class="table table-hover" id="payoutDetailsTable">
                                                                        ...
                                                                        <tbody>
                                                                            <?php
                                                                            $sql = "SELECT * FROM `bm_payout_history` WHERE  bm_user_id = '" . $userId . "'  ";
                                                                                ...
                                                                                foreach (($stmt->fetchALL()) as $key => $row) {
                                                                                    ...
                                                                                    echo '<tr>
                                                                                                    ...
                                                                                                    <td class="text-end">' . $totalAmt . '
                                                                                                        <a href="payout/forms/slab_payout_forms/download_ca_payout.php?vkvbvjfgfikix=' . $row['id'] . '&bc=' . $row['bm_user_id'] . '&ca=' . $row['ca_user_id'] . '&date=' . $dt . '&message=' . $message1 . '&message_status=' . $row['payout_status'] . '&commission=' . $row['payout_amount'] . '">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-7 card" style="border: 2px solid black; border-radius: 10px;">
                                <div class="mt-3">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <a href="payout/forms/slab_payout_forms/download_exel_ca.php?payoutYear=<?php echo $prevDateYear; ?>&payoutMonth=<?php echo $prevDateMonth; ?>&payoutmessage=PreviousPayout">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive table-desi" id="filterTableNext">
                                        ...
                                        <table class="table table-hover" id="next_payout_table">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql3 = "SELECT * FROM bm_payout_history WHERE bm_user_id = '" . $userId . "' AND YEAR(payout_date) = '" . $nextDateYear . "' AND MONTH(payout_date) = '" . $nextDateMonth . "' ";
                                                ...
                                                if ($stmt->rowCount() > 0) {
                                                    foreach (($stmt->fetchALL()) as $key => $row) {
                                                        ...
                                                        if ($row['payout_status'] == '2') {
                                                            ...
                                                            echo '<td><span class="badge bg-warning font-size-10 fw-bold ms-4" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" onclick=\'paymentId("' . $row['id'] . '","' . $row['bm_user_id'] . '","' . $row['message_bm'] . '","' . $row['payout_amount'] . '","' . $row['payout_status'] . '","NextPayout")\'>Pending</span></td>';
                                                        }
                                                        echo '</tr>';
                                                    }
                                                }
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive table-desi" id="filteredTotalTable">
                                        ...
                                        <table class="table table-hover" id="total_payout_table">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql4 = "SELECT * FROM bm_payout_history WHERE bm_user_id = '" . $userId . "' AND payout_status = '2' OR payout_status='3' ";
                                                ...
                                                if ($stmt->rowCount() > 0) {
                                                    foreach (($stmt->fetchALL()) as $key => $row) {
                                                        ...
                                                        if ($row['payout_status'] == '2') {
                                                            ...
                                                            echo '<td><span class="badge bg-warning font-size-10 fw-bold ms-4" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center" onclick=\'paymentId("' . $row['id'] . '","' . $row['bm_user_id'] . '","' . $row['message_bm'] . '","' . $row['payout_amount'] . '","' . $row['payout_status'] . '","TotalPayout")\'>Pending</span></td>';
                                                        }
                                                        echo '</tr>';
                                                    }
                                                }
        ...
        <!-- custom js  -->
        <script src="payout/slab_payout.js"></script>
        <!-- Chart JS -->
        ...
        <script>
            ...
            function loadRejectionReason(Id) {
                ...
                fetch('payout/forms/slab_payout_forms/get_block_reason.php?id=' + Id)
