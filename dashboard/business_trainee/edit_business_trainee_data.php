...
// 	$identifier_id= $_POST["id"];
// 	$identifier_name = 'id=';
// 	$message="Updated business_trainee details from ".$editfor. " list";
// 	$message2="Updated business_trainee details from ".$editfor. " list";
