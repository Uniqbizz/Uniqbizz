<?php
    ...
    $message="Added new business_trainee by Client";
    $message2="Added new business_trainee by Client";
    $fromWhom="1";

    $sql= "INSERT INTO `business_trainee` (firstname, lastname, nominee_name, nominee_relation, email, country_code, contact_no , date_of_birth, age, gender, country, state, city, pincode, address,  user_type, registrant, reference_no, register_by) VALUES (:firstname ,:lastname, :nominee_name, :nominee_relation, :email, :country_code, :contact_no, :bdate, :age, :gender , :country, :state, :city, :pincode,:address, :user_type,:registrant,  :reference_no, :register_by)";
