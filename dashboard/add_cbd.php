                            ...
                            <div class="col-lg-12">
                                <div class="col-12"> <!-- Page title -->
                                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                        <p class="mb-sm-0 fw-bold text-uppercase head">Add Channel Business Director</p>
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="text-start">
                                                            <button type="submit" class="btn btn-primary sub-title" id="add_cbd">Submit</button>
                                                        </div>
                                                    </div>
