...
if($ca_cu_id ==''){
	...
	$message="Deleted Business Consultant(".$ca_cu_id.") from ".$action. " list";
	$message2="Deleted Business Consultant(".$ca_cu_id.") from ".$action. " list";
}
...
if(isset($_POST["fid"])){
	$business_consultant_id = $_POST["fid"];
